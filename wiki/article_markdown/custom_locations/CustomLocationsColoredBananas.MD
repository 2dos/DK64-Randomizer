...
| Leading up to and on BBlast pad | 10 | `(l.can_use_vines or l.CanMoonkick()) and l.climbing` | 
...
| Above stump | Balloon |  | 
| Above vines next to BBlast | Balloon | `l.can_use_vines and l.climbing` | 
...
| Bunch on trees between Snide's and Beetle Race tower (1 custom, 2 Lanky bunches) | 15 | `l.climbing` | 
...
| On trees around Beetle race tower (Diddy) | 15 | `l.climbing` | 
| Path to 5DT (Tiny) | 5 |  | 
| Trees around back of 5DT (Tiny) | 10 | `l.climbing` | 
| Trees around front of 5DT (Tiny) | 15 | `l.climbing` | 
| Trees between Llama Temple and 5DT (Lanky) | 15 | `l.climbing` | 
...
| On vines in Matching game room (Lanky) | 5 | `(l.grape or l.CanPhase()) and l.can_use_vines` | 
...
| Name | Amount | Logic |
| ---- | ------ | ----- |
| Ladder at the bottom | 5 | `l.climbing` | 
| Around first floor platforms | 10 | `l.climbing` | 
| Around the top of the lighthouse | 5 | `l.climbing` | 
| Around the bottom of the lighthouse | 15 | `l.climbing` | 
| Group 1 up the lighthouse (Donkey) | 10 | `l.climbing` | 
| Group 2 up the lighthouse (Donkey) | 10 | `l.climbing` | 
| Around top | Balloon | `l.climbing` | 
...
| Name | Amount | Logic |
| ---- | ------ | ----- |
| Mushroom near DK portal | 5 | `l.climbing` | 
| Mushroom by pink tunnel | 5 | `l.climbing` | 
| Mushroom with vines leading to other mushroom | 5 | `l.climbing` | 
| Other mushroom whose vines lead to | 5 | `l.climbing` | 
| Mushroom with vines leading to minecart | 5 | `l.climbing` | 
| On vines between two shrooms | 10 | `l.can_use_vines and l.climbing` | 
| Vines to minecart | 5 | `l.can_use_vines and l.climbing` | 
| Around the roof of minecart | 10 | `((l.can_use_vines or l.CanMoonkick()) and l.climbing) or (l.jetpack and l.isdiddy)` | 
| Mushroom by blue tunnel | 5 | `l.climbing` | 
...
| Top of Mill (8 custom, 7 Lanky) | 10 |  | 
| Top of Mill (8 custom, 7 Lanky) | 4 |  | 
...
| On mushroom near Cranky | 5 | `l.climbing` | 
| Mushroom near rocketbarrel | 5 | `l.climbing` | 
| Mushroom near yellow tunnel | 5 | `l.climbing` | 
...
| On boxes on upper level | 10 | `l.climbing` | 
| On ladder | 5 | `l.climbing` | 
...
| Gorilla Gone Tunnel (2 custom, 3 Chunky) | 5 | `(l.punch and l.chunky) or l.CanPhase() or l.CanPhaseswim() or l.checkBarrier(RemovedBarriersSelected.caves_ice_walls)` | 
| Around Gorilla Gone room | 10 | `(l.punch and l.chunky) or l.CanPhase() or l.CanPhaseswim() or l.checkBarrier(RemovedBarriersSelected.caves_ice_walls)` | 
...
| On trombone pad on Lanky cabin (Lanky) | 5 | `(l.jetpack and l.isdiddy) or (l.balloon and l.islanky) or l.CanPhase()` | 
...
| On Gorilla Gone pad (Chunky) | 5 | `(l.punch and l.chunky) or l.CanPhase() or l.CanPhaseswim() or l.checkBarrier(RemovedBarriersSelected.caves_ice_walls)` | 
...
| In gorilla gone room (Donkey) | Balloon | `(l.punch and l.chunky) or l.CanPhase() or l.CanPhaseswim() or l.checkBarrier(RemovedBarriersSelected.caves_ice_walls)` | 
...
| On tree by small pool outside big tree | 2 |  | 
| On tree by small pool outside big tree | 3 | `l.climbing` | 
| On steps to big tree | 5 |  | 
| On tree by big tree (Tiny coins) | 2 |  | 
| On tree by big tree (Tiny coins) | 3 | `l.climbing` | 
| On branch sticking out of big tree | 5 | `l.climbing` | 
...
| On tree by staircase to W1 | 2 |  | 
| On tree by staircase to W1 | 3 | `l.climbing` | 
| On tree by low T&S portal (by Lanky coins) | 2 |  | 
| On tree by low T&S portal (by Lanky coins) | 3 | `l.climbing` | 
| Path from crypt to low T&S portal | 10 |  | 
| On ladder from W1 stairs to crypt | 2 |  | 
| On ladder from W1 stairs to crypt | 3 |  | 
| Path from Crypt to Tiny BP | 20 |  | 
| On Tiny BP platform | 10 |  | 
| On ladder from past crypt to random platform below/past W1 | 2 |  | 
| On ladder from past crypt to random platform below/past W1 | 3 |  | 
...
| W4 | 10 |  | 
| W5 | 10 |  | 
| On tree on platform past/below W1 | 2 |  | 
| On tree on platform past/below W1 | 3 | `l.climbing` | 
| On ladder next to Tiny BP | 2 |  | 
| On ladder next to Tiny BP | 3 |  | 
...
| Crypt - Path to W1 | 15 |  | 
| Crypt - Path to W3 | 10 |  | 
| Back corners of DK's room | 10 | `l.coconut or l.CanPhase() or l.checkBarrier(RemovedBarriersSelected.castle_crypt_doors)` | 
| Bunch on coffin with pentagon of singles around it | 10 | `l.peanut or l.CanPhase() or l.checkBarrier(RemovedBarriersSelected.castle_crypt_doors)` | 
| In coffins (Chunky) | 10 | `(l.punch and (l.pineapple or l.checkBarrier(RemovedBarriersSelected.castle_crypt_doors))) or l.CanPhase() or l.generalclips` | 
| Above warps | Balloon |  | 
| Around coffin in Chunky's room | Balloon |  | 
| Around coffin in Diddy's room | Balloon |  | 
| In coffin in Diddy's room (Diddy) | Balloon | `(l.charge or l.generalclips or l.CanPhase()) and (l.peanut or l.checkBarrier(RemovedBarriersSelected.castle_crypt_doors))` | 
...
| Path to Chunky's cage | 10 | `l.punch or l.CanPhase()` | 
| On plank in water (Donkey) | 5 | `l.coconut` | 
| By punchable wall (Chunky) | 5 |  | 
| First room | Balloon |  | 
| Above hole (Donkey) | Balloon |  | 
| In Chunky's room (Chunky) | Balloon | `l.punch or l.CanPhase()` | 
...
| Around Cranky | 5 |  | 
| Next to Cranky | 10 |  | 
| Path to training area | 5 |  | 
| In the lake | 15 | `l.swim` | 
| Behind the waterfall | 5 |  | 
...
| Banana hoard room | Balloon |  | 
| Around the treehouse | Balloon |  | 
| Above rear ledge | Balloon |  | 
| Above exit ledge | Balloon |  | 
| Next to Cranky | Balloon |  | 
| Training Area | Balloon |  | 
| Rear tunnel | Balloon |  | 
| Exit tunnel | Balloon |  | 
## Isles
| Name | Amount | Logic |
...
| Fairy Isle W5 | 5 |  | 
| Japes entrance | 5 |  | 
| Tree between tag barrel and Japes | 5 |  | 
| Tree next to Japes | 5 | `l.climbing` | 
| Tree on beaver beach | 5 | `l.climbing` | 
| Tree near W3 | 5 | `l.climbing` | 
| Behind cannon to Forest | 5 |  | 
...
| Tree below Caves | 5 |  | 
| Path below Caves | 5 |  | 
| Stairs near Aztec | 10 |  | 
| Behind Aztec lobby | 5 |  | 
| Aztec lobby roof | 20 |  | 
| On trombone boulder | 5 |  | 
| On triangle boulder | 5 |  | 
| Between DK Isle's nostrils | 5 |  | 
| Caves lobby ledge | 5 |  | 
| Above Caves lobby | 15 |  | 
| Forest lobby roof | 10 |  | 
| Flower sniffing near Forest | 5 |  | 
| In the peanut cage | 10 | `l.peanut or l.CanPhase()` | 
| Waterfall upstream | 5 |  | 
| Flower next to peanut cage | 5 |  | 
| Waterfall freefall | 10 |  | 
| DK Isle peaks | 10 |  | 
| Above the Pound the X rock | 5 |  | 
| On DK Isle's ear above Aztec | 15 |  | 
| On DK Isle's right eyebrow | 5 |  | 
| On DK Isle's left eyebrow | 5 |  | 
| On Fairy Isle's banana peel hat right | 5 |  | 
| On Fairy Isle's banana peel hat left | 5 |  | 
| On top of Fairy Isle | 5 |  | 
| On Fairy Isle's wings | 10 |  | 
| On the fairy tree | 5 |  | 
| Around the fairy tree | 5 |  | 
| In the feather cage | 10 | `l.feather or l.CanSTS() or l.CanPhase()` | 
| Fairy Isle entrance | 5 |  | 
| In the Pound the X rock | 10 | `Events.IslesChunkyBarrelSpawn in l.Events and l.hunkyChunky and l.Slam and l.chunky` | 
| Tag barrel shore | 10 |  | 
| Around Fairy Isle | 10 |  | 
...
| On top of side pipes | 15 |  | 
| Lower Monkeyport pad | 5 |  | 
| Upper Monkeyport pad | 5 |  | 
| Saxophone pad | 5 |  | 
| On vines to Snide | 5 | `l.can_use_vines` | 
| On Krem Isle's right arm | 5 |  | 
| On Krem Isle's left arm | 5 |  | 
| Path to Factory | 15 |  | 
| Key 2 rising platform | 5 |  | 
| Underwater behind propellers | 10 | `l.swim` | 
| Under path to Factory | 10 |  | 
| Prison cable | 5 |  | 
| Back of Krem Isle | 10 |  | 
| Snide ledge | 5 |  | 
| In the coconut cage | 10 | `l.coconut` | 
| In the grape cage | 10 | `l.grape or l.CanPhaseswim() or l.CanPhase()` | 
| Waterfall lower | Balloon |  | 
| Waterfall upper | Balloon |  | 
| Above bananaports | Balloon |  | 
| Japes shore | Balloon |  | 
| Beaver beach | Balloon |  | 
| Between pineapple cage and the X platform | Balloon |  | 
| Around the tree below caves | Balloon |  | 
| Near Aztec | Balloon |  | 
| In front of DK Isle's eyes | Balloon |  | 
| Around the fairy tree | Balloon |  | 
| Front of Fairy Isle | Balloon |  | 
| Top of Fairy Isle | Balloon |  | 
| Behind Aztec | Balloon |  | 
| Near Forest | Balloon |  | 
| Around the Krem Krown | Balloon |  | 
| Upper Factory Path | Balloon |  | 
| Big pipe in Krem Isle middle back | Balloon |  | 
...
| Right ramp | 5 |  | 
| Left ramp | 5 |  | 
| Ridge between the posts | 5 |  | 
| Between the Columns | 5 |  | 
| Around the barrel hole | 10 |  | 
| Also around the barrel hole | 10 |  | 
...
| Tag barrel | 5 |  | 
| Vents | Balloon |  | 
| Between pipes | Balloon |  | 
| Upper path | Balloon |  | 
## Gloomy Galleon Lobby
| Name | Amount | Logic |
| ---- | ------ | ----- |
| Underwater entrance | 5 |  | 
| Under tag barrel | 5 |  | 
| Underwater along the wall | 10 |  | 
| Kasplat platform | 10 |  | 
| Donkey door | 5 |  | 
| Chunky door | 5 |  | 
| Tiny door | 5 |  | 
...
| Name | Amount | Logic |
| ---- | ------ | ----- |
| Tiny door (back wall) | 5 |  | 
| Chunky door (right wall) | 5 |  | 
| Lanky door (right corner) | 5 |  | 
| Where the lever used to be | 5 |  | 
| Entrance | 10 |  | 
| Center line | 5 |  | 
...
| Crazy fairy balloon | Balloon |  | 
| Wrinkly wheel (back wall) | Balloon |  | 
## Crystal Caves Lobby
| Name | Amount | Logic |
| ---- | ------ | ----- |
| Left path | 5 |  | 
...
| Left side crystals | 15 |  | 
| Right side crystals | 10 |  | 
| Entrance | 10 |  | 
...
| ---- | ------ | ----- |
| Around the fairy | 5 |  | 
| Front corner torches | 10 |  | 
| Back corner torches | 10 |  | 
| Front ramp | 5 |  | 
| Left ramp | 5 |  | 
| Right ramp | 5 |  | 
| Back ramp | 5 |  | 
| Throne | 5 |  | 
| Rareware GB room | 20 |  | 
| Rareware GB room | Balloon |  | 
| Around the fairy | Balloon |  | 
