...
| Tree next to Japes | 5 | `(l.climbing) or (Events.IslesDiddyBarrelSpawn in l.Events and l.isdiddy and l.jetpack and Events.GalleonKeyTurnedIn in l.Events)` | 
| Tree on beaver beach | 5 | `(l.climbing) or (Events.IslesDiddyBarrelSpawn in l.Events and l.isdiddy and l.jetpack and Events.GalleonKeyTurnedIn in l.Events)` | 
| Tree near W3 | 5 | `(l.climbing) or (Events.IslesDiddyBarrelSpawn in l.Events and l.isdiddy and l.jetpack and Events.GalleonKeyTurnedIn in l.Events)` | 
