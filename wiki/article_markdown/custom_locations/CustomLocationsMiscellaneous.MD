...
| Gloomy Galleon | Entrance tunnel - under tag barrel |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | Near Chest Cannon (1) |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | Near Chest Cannon (2) |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | Near Chest GB Tunnel |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | In Punch GB Chest Room |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | Behind Punch GB Chest |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | Behind the ship you shoot onto with the cannon |  | `self.logic = lambda _: True` | 
| Galleon2DShip | Galleon Lanky 2DS Inside Chest | CrownPad, DirtPatch, Bananaport | `self.logic = lambda _: True` | 
| Gloomy Galleon | Left of Cranky |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | In front of Cranky |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | Near Bridge Warp 3 |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | On Lighthouse Platform (Rocketbarrel) |  | `self.logic = lambda _: True` | 
| Gloomy Galleon | On Lighthouse Platform (Baboon Blast) |  | `self.logic = lambda _: True` | 
...
| Gloomy Galleon | Behind Snide's | CrownPad, Bananaport | `self.logic = lambda _: True` | 
...
| Gloomy Galleon | Vanilla Snide Warp 3 |  | `self.logic = lambda _: True` | 
...
| Crystal Caves | Near Primate Punch wall opposite cranky |  | `self.logic = lambda _: True` | 
...
| Creepy Castle | Near Cranky |  | `self.logic = lambda _: True` | 
