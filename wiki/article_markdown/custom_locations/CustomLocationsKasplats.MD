...
| Gloomy Galleon | Galleon Kasplat: On the Cavern Shop Wreck | `self.additional_logic = lambda _: True` | 
...
| Fungi Forest | Forest Kasplat: Behind Clock | `self.additional_logic = lambda _: True` | 
