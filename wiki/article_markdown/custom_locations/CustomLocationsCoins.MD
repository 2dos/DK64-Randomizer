...
| Banana hoard | 4 | `l.can_use_vines or l.CanMoonkick()` | 
| Rear Tunnel | 3 | `` | 
## Treehouse
| Name | Amount | Logic |
| ---- | ------ | ----- |
...
| Under Hollow Tree | 3 | `` | 
| On Well | 3 | `l.can_use_vines or l.CanMoonkick() or (l.jetpack and l.isdiddy)` | 
