...
class DK64MemoryMap:
    ...
    receive_damage = 0x066  # DamageLink: client writes quarter-melon units of incoming damage; game applies one per frame when safe
    health = 0x807FCC4B  # DamageLink: CollectableBase.Health (quarter-melons); polled by the client to detect outgoing damage
