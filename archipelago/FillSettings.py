...
def apply_starting_moves_settings(settings_dict: dict, options) -> None:
    ...
    for item in options.start_inventory:
        ...
        if item_obj.type not in [Types.Kong, Types.Key, Types.Shop, Types.Shockwave, Types.TrainingBarrel, Types.Climbing, Types.Cranky, Types.Funky, Types.Candy, Types.Snide]:
            ...
            raise ValueError(f"Invalid item type for starting inventory: {item}. Starting inventory can only contain kongs, keys, shopkeepers, or moves.")
