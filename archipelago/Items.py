...
def setup_items(world: World) -> typing.List[DK64Item]:
    ...
    all_shuffled_items = DK64RItemPoolUtility.GetItemsNeedingToBeAssumed(world.spoiler.settings, [DK64RTypes.Medal, DK64RTypes.Fairy, DK64RTypes.Banana, DK64RTypes.Bean, DK64RTypes.Pearl], [])
