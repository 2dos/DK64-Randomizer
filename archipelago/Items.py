...
def setup_items(world: World) -> typing.List[DK64Item]:
    ...
    trap_weights += [DK64RItems.IceTrapGetOutGB] * world.options.disable_c_trap_weight.value
    trap_weights += [DK64RItems.IceTrapDryGB] * world.options.disable_c_trap_weight.value
    trap_weights += [DK64RItems.IceTrapFlipGB] * world.options.disable_c_trap_weight.value
