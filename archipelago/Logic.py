        ...
        if ap_item.name.startswith("Collectible CBs"):
            ...
            match corresponding_item_id:
                ...
                case _:
                    ...
                    if (corresponding_item_id >= Items.PhotoBat and corresponding_item_id <= Items.PhotoBug) or (corresponding_item_id >= Items.PhotoBFI and corresponding_item_id <= Items.PhotoSeasickCannon):
