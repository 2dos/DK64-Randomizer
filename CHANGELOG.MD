...
- **Hint Region Pause Screen**: No longer will you be confused on what hint region you are in. When you pause the game, you can see what Hint Region you are in. Example: [Region Hint](RegionHint.png)
...
- **Random Menu Background**: The Background on the Main Menu now has Random Textures applied to it Example: [Region Hint](MenuBackground.png)
