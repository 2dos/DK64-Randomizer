...
extern void unkLightFunc_1(unsigned int unk0, unsigned short height_variance, float payerX, float PlayerY, float PlayerZ, unsigned short unk2, float unk3, unsigned int unk4); //8072a920
