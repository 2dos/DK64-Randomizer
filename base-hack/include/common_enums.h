...
typedef enum file_data_indexes {
    ...
    DATA_ARCADEHISCORE_CHAR2,
    DATA_ARCADEHISCORE_NUM,
    DATA_RAMBIHISCORE_CHAR0,
    DATA_RAMBIHISCORE_CHAR1,
    DATA_RAMBIHISCORE_CHAR2,
    DATA_RAMBIHISCORE_NUM,
    DATA_ENGUARDEHISCORE_CHAR0,
    DATA_ENGUARDEHISCORE_CHAR1,
    DATA_ENGUARDEHISCORE_CHAR2,
    DATA_ENGUARDEHISCORE_NUM,
    DATA_SOUNDTYPE,
    DATA_LANGUAGE,
    DATA_CAMERATYPE,
    DATA_LEVELIGT,
...
typedef enum ICE_TRAP_TYPES {
	...
	/* 0x00B */ ICETRAP_FLIP,
	/* 0x00C */ ICETRAP_SLIP,
	/* 0x00D */ ICETRAP_SLIP_INSTANT, // Instant Slip
} ICE_TRAP_TYPES;
...
typedef enum grabbables_internal_items {
	// Boulders
	/*  0 */ GRABBABLE_ISLES_NEARAZTEC,
	/*  1 */ GRABBABLE_ISLES_NEARCAVES,
	/*  2 */ GRABBABLE_AZTEC_BOULDER,
	/*  3 */ GRABBABLE_CAVES_SMALL,
	/*  4 */ GRABBABLE_CAVES_LARGE,
	/*  5 */ GRABBABLE_MUSEUM_BOULDER,
	/*  6 */ GRABBABLE_JAPES_LOBBY,
	/*  7 */ GRABBABLE_CASTLE_LOBBY,
	/*  8 */ GRABBABLE_CAVES_LOBBY,
	// Kegs
	/*  9 */ GRABBABLE_MILL_FRONT_NEAR,
	/* 10 */ GRABBABLE_MILL_FRONT_FAR,
	/* 11 */ GRABBABLE_MILL_REAR,
	// Vases
	/* 12 */ GRABBABLE_VASE_CIRCLE,
	/* 13 */ GRABBABLE_VASE_COLON,
