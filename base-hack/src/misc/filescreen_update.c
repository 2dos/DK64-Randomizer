/*
    This file is ignored through the .avoid file
    The code changes in this file currently randomly cause an emu crash
*/
...
static tracker_struct tracker_info[] = {
	...
	{.min_x = 133, .max_x = 138, .min_y = 32, .max_y = 42, .enabled = TRACKER_ENABLED_DEFAULT, .type = TRACKER_TYPE_SLAM}, // Slam
	...
	{.min_x = 146, .max_x = 151, .min_y = 32, .max_y = 41, .enabled = TRACKER_ENABLED_DEFAULT, .type = TRACKER_TYPE_SLAM}, // Slam
