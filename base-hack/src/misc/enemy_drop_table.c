...
void initItemDropTable(void) {
    ...
    *(short*)(0x806A5CD6) = getLo(&drops[0].source_object);
    ...
    writeFunction(0x806AD40C, &spawnEnemyDrops); // Beaver control case
    writeFunction(0x806AED14, &spawnEnemyDrops); // Kremling
    writeFunction(0x806AF5A4, &spawnEnemyDrops); // Klump
    writeFunction(0x806B0218, &spawnEnemyDrops); // Krossbones
    writeFunction(0x806B0704, &spawnEnemyDrops); // Mush Man
    writeFunction(0x806B0C8C, &spawnEnemyDrops); // Kosha
    writeFunction(0x806B1C88, &spawnEnemyDrops); // Kasplats
    writeFunction(0x806B4744, &spawnEnemyDrops); // Flying Enemies
    writeFunction(0x806B5B90, &spawnEnemyDrops); // Klobber/Kaboom
    writeFunction(0x806B61E0, &spawnEnemyDrops); // Klobber/Kaboom
    writeFunction(0x806B744C, &spawnEnemyDrops); // Klaptrap
    writeFunction(0x806B9AB4, &spawnEnemyDrops); // Robot
}