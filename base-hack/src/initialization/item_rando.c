...
key_packet key_item_table[8] = {
    // Boss Rewards
    { .spawn_packet = {.actor = 72, .item_level=0}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=1}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=2}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=3}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=4}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=5}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=6}, .model2_item=0x13C, .scale=34 },
    { .spawn_packet = {.actor = 72, .item_level=7}, .model2_item=0x13C, .scale=34 },
};
...
snide_packet snide_rewards[40] = {
    // Japes
    {.object_id = 0x74, .scale = 25, .item={ .item_type=REQITEM_GOLDENBANANA }},
    {.object_id = 0x74, .scale = 25, .item={ .item_type=REQITEM_GOLDENBANANA }},
    {.object_id = 0x74, .scale = 25, .item={ .item_type=REQITEM_GOLDENBANANA }},
    {.object_id = 0x74, .scale = 25, .item={ .item_type=REQITEM_GOLDENBANANA }},
    {.object_id = 0x74, .scale = 25, .item={ .item_type=REQITEM_GOLDENBANANA }},
