...
static const barrel_skin_tie bonus_skins[] = {
    ...
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_RAMBISOUL, .skin=SKIN_RAMBI},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_ENGUARDESOUL, .skin=SKIN_ENGUARDE},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_DILLOSOUL, .skin=SKIN_DILLO},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_DOGADONSOUL, .skin=SKIN_DOGADON},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_MADJACKSOUL, .skin=SKIN_JACK},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_PUFFTOSSSOUL, .skin=SKIN_PUFFTOSS},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_KUTOUTSOUL, .skin=SKIN_KKO},
    {.actor = CUSTOM_ACTORS_START + NEWACTOR_KROOLSOUL, .skin=SKIN_KROOL},
};
