...
int addCollisionInfo(int index, int type, int collectable, int kong, int actor_equivalent, int hitbox_y, int hitbox_scale, int is_custom) {
    /**
...
void initCollectableCollision(void) {
     ...
     */
    // Single
    int index = addCollisionInfo(0, 0x000D, COLLECTABLE_CB, KONG_DK, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x000A, COLLECTABLE_CB, KONG_DIDDY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x001F, COLLECTABLE_CB, KONG_CHUNKY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x001E, COLLECTABLE_CB, KONG_LANKY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x0016, COLLECTABLE_CB, KONG_TINY, 0, 0, 0, 0);
    // Coin
    index = addCollisionInfo(index, 0x0024, COLLECTABLE_COIN, KONG_DIDDY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x0023, COLLECTABLE_COIN, KONG_LANKY, 0x35, 0, 0, 0);
    index = addCollisionInfo(index, 0x0027, COLLECTABLE_COIN, KONG_CHUNKY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x001C, COLLECTABLE_COIN, KONG_TINY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x001D, COLLECTABLE_COIN, KONG_DK, 0, 0, 0, 0);
    // Bunch
    index = addCollisionInfo(index, 0x002B, COLLECTABLE_CB, KONG_DK, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x0208, COLLECTABLE_CB, KONG_DIDDY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x0206, COLLECTABLE_CB, KONG_CHUNKY, 0x6E, 0, 0, 0);
    index = addCollisionInfo(index, 0x0205, COLLECTABLE_CB, KONG_LANKY, 0, 0, 0, 0);
    index = addCollisionInfo(index, 0x0207, COLLECTABLE_CB, KONG_TINY, 0, 0, 0, 0);
    // Pellets
    index = addCollisionInfo(index, 0x0091, COLLECTABLE_AMMOPELLET, KONG_NONE, 0, 0, 0, 0); // Peanut
    index = addCollisionInfo(index, 0x015D, COLLECTABLE_AMMOPELLET, KONG_NONE, 0, 0, 0, 0); // Feather
    index = addCollisionInfo(index, 0x015E, COLLECTABLE_AMMOPELLET, KONG_NONE, 0, 0, 0, 0); // Grape
    index = addCollisionInfo(index, 0x015F, COLLECTABLE_AMMOPELLET, KONG_NONE, 0, 0, 0, 0); // Pineapple
    index = addCollisionInfo(index, 0x0160, COLLECTABLE_AMMOPELLET, KONG_NONE, 0, 0, 0, 0); // Coconut
    // Blueprint
    index = addCollisionInfo(index, 0x00DE, COLLECTABLE_BP, KONG_DK, 0x4E, 8, 4, 0);
    index = addCollisionInfo(index, 0x00E0, COLLECTABLE_BP, KONG_DIDDY, 0x4B, 8, 4, 0);
    index = addCollisionInfo(index, 0x00E1, COLLECTABLE_BP, KONG_LANKY, 0x4D, 8, 4, 0);
    index = addCollisionInfo(index, 0x00DD, COLLECTABLE_BP, KONG_TINY, 0x4F, 8, 4, 0);
    index = addCollisionInfo(index, 0x00DF, COLLECTABLE_BP, KONG_CHUNKY, 0x4C, 8, 4, 0);
    // Multiplayer
    index = addCollisionInfo(index, 0x00B7, COLLECTABLE_COIN, KONG_NONE, 0x8C, 8, 4, 0); // Rainbow Coin
    index = addCollisionInfo(index, 0x01CF, COLLECTABLE_NONE, KONG_NONE, 0x78, 0, 0, 0); // Yellow CB Powerup
    index = addCollisionInfo(index, 0x01D0, COLLECTABLE_NONE, KONG_NONE, 0x77, 0, 0, 0); // Blue CB Powerup
    index = addCollisionInfo(index, 0x01D1, COLLECTABLE_NONE, KONG_NONE, 0x76, 0, 0, 0); // Coin Powerup
    index = addCollisionInfo(index, 0x01D2, COLLECTABLE_COIN, KONG_NONE, 0x7A, 0, 0, 0); // Coin Multiplayer
    // Potions
    index = addCollisionInfo(index, 0x005B, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_POTIONDK, 8, 4, 1); // Potion DK
    index = addCollisionInfo(index, 0x01F2, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_POTIONDIDDY, 8, 4, 1); // Potion Diddy
    index = addCollisionInfo(index, 0x0059, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_POTIONLANKY, 8, 4, 1); // Potion Lanky
    index = addCollisionInfo(index, 0x01F3, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_POTIONTINY, 8, 4, 1); // Potion Tiny
    index = addCollisionInfo(index, 0x01F5, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_POTIONCHUNKY, 8, 4, 1); // Potion Chunky
    index = addCollisionInfo(index, 0x01F6, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_POTIONANY, 8, 4, 1); // Potion Any
    // Kongs
    index = addCollisionInfo(index, 0x0257, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_KONGDK, 8, 4, 1); // DK
    index = addCollisionInfo(index, 0x0258, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_KONGDIDDY, 8, 4, 1); // Diddy
    index = addCollisionInfo(index, 0x0259, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_KONGLANKY, 8, 4, 1); // Lanky
    index = addCollisionInfo(index, 0x025A, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_KONGTINY, 8, 4, 1); // Tiny
    index = addCollisionInfo(index, 0x025B, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_KONGCHUNKY, 8, 4, 1); // Chunky
    // Others
    index = addCollisionInfo(index, 0x0074, COLLECTABLE_GB, KONG_NONE, 0x2D, 8, 4, 0); // Golden Banana
    index = addCollisionInfo(index, 0x0056, COLLECTABLE_ORANGE, KONG_NONE, 0x34, 0, 0, 0); // Orange
    ...
    index = addCollisionInfo(index, 0x013C, COLLECTABLE_NONE, KONG_NONE, 0x48, 8, 4, 0); // Boss Key
    index = addCollisionInfo(index, 0x018D, COLLECTABLE_NONE, KONG_NONE, 0x56, 8, 4, 0); // Battle Crown
    index = addCollisionInfo(index, 0x0288, COLLECTABLE_GB, KONG_NONE, 0x2D, 8, 4, 0); // Rareware GB
    index = addCollisionInfo(index, 0x0048, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_NINTENDOCOIN, 8, 4, 1); // Nintendo Coin
    index = addCollisionInfo(index, 0x028F, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_RAREWARECOIN, 8, 4, 1); // Rareware Coin
    index = addCollisionInfo(index, 0x0198, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_BEAN, 8, 4, 1); // Bean
    index = addCollisionInfo(index, 0x01B4, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_PEARL, 8, 4, 1); // Pearl
    index = addCollisionInfo(index, 0x025C, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_FAIRY, 8, 4, 1); // Fairy
    index = addCollisionInfo(index, 0x025D, COLLECTABLE_NONE, KONG_NONE, NEWACTOR_FAKEITEM, 8, 4, 1); // Fake Item
