...
collision_info object_collisions[] = {
	...
	{.type=144, .collectable_type=10, .unk4=0.08f, .unk8=0.95f, .intended_actor=0, .actor_equivalent=20 + CUSTOM_ACTORS_START, .hitbox_y_center=8, .hitbox_radius=4, .hitbox_height=13},
