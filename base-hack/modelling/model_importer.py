        ...
        for line in file:
            ...
            if stripped.startswith("o ") or stripped.startswith("g "):
                ...
                if len(parts) >= 4:
                    ...
                    verts.append({"coords": (x, y, z), "rgb": (int(r * 255), int(g * 255), int(b * 255))})
...
with open(BIN_FILE, "wb") as bin:
    ...
    footer = [0xE7000000, 0x00000000, 0xE3000A01, 0x00000000, 0xE200001C, 0x00552078, 0xFC41FE83, 0xFFFFF9FC, 0xD7000002, 0xFFFFFFFF]
    for item in starter:
