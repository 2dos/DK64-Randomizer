KrushaConditionalScaleDown:
    LW      at, 0x58 (s2)
    ADDIU   t7, r0, 5
    BEQ     at, t7, KrushaConditionalScaleDown_Scale
    ADDIU   t7, r0, 3
    BNE     at, t7, KrushaConditionalScaleDown_Default
    NOP
    
    KrushaConditionalScaleDown_Scale:
        LUI     at, 0x3E05
        ADDIU   at, at, 0x1EB8
...
controlKrushaSpeedup_Y:
    ...
    LWC1    f0, 0x38 (v0)
    ADDIU   t8, r0, 5
    BEQ     at, t8, controlKrushaSpeedup_YScale
    ADDIU   t8, r0, 3
    BNE     at, t8, controlKrushaSpeedup_YFinish
    NOP

    controlKrushaSpeedup_YScale:
        LUI     at, 0x3F94
        ADDIU   at, at, 0xB13B
        MTC1    at, f8
        MUL.S   f0, f0, f8
