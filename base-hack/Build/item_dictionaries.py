...
db = [
    ...
    InGameItem(name="DK Blueprint", actor=78, model_two=0xDE, base=base_bp),
    InGameItem(name="Diddy Blueprint", actor=75, model_two=0xE0, base=base_bp),
    InGameItem(name="Lanky Blueprint", actor=77, model_two=0xE1, base=base_bp),
    InGameItem(name="Tiny Blueprint", actor=79, model_two=0xDD, base=base_bp),
    InGameItem(name="Chunky Blueprint", actor=76, model_two=0xDF, base=base_bp),
    InGameItem(name="Nintendo Coin", actor=151, model_two=0x48, base=base_coin),
    InGameItem(name="Rareware Coin", actor=152, model_two=0x28F, base=base_coin),
    ...
    InGameItem(name="DK Potion", actor=157, model_two=0x5B, base=base_potion),
    InGameItem(name="Diddy Potion", actor=158, model_two=0x1F2, base=base_potion),
    InGameItem(name="Lanky Potion", actor=159, model_two=0x59, base=base_potion),
    InGameItem(name="Tiny Potion", actor=160, model_two=0x1F3, base=base_potion),
    InGameItem(name="Chunky Potion", actor=161, model_two=0x1F5, base=base_potion),
    InGameItem(name="Any Potion", actor=162, model_two=0x1F6, base=base_potion),
    InGameItem(name="No Item", actor=153, model_two=0x0, scale=0.25, force_dance=False, boss_enabled=False, is_null=True),
    InGameItem(name="DK Item", actor=141, model_two=0x257, base=base_kong),
    InGameItem(name="Diddy Item", actor=142, model_two=0x258, base=base_kong),
    InGameItem(name="Lanky Item", actor=143, model_two=0x259, base=base_kong),
    InGameItem(name="Tiny Item", actor=144, model_two=0x25A, base=base_kong),
    InGameItem(name="Chunky Item", actor=155, model_two=0x25B, base=base_kong),
