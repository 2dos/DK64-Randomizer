...
krool_im = Image.open(f"{portal_dir}krool.png")
...
for x in range(2):
    ...
    # K Rool Portal
    portal_im_green.paste(krool_im, (placement_offset, placement_offset), krool_im)
    portal_im_green.save(f"{portal_dir}krool_portal_{x + 1}.png")
    if x == 0:
