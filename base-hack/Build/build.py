...
file_dict = [
    ...
    File(
        ...
        pointer_table_index=TableNames.TexturesGeometry,
        file_index=getBonusSkinOffset(ExtraTextures.MelonSliceSkin),
        source_file="assets/displays/melon_slice_3d.png",
        texture_format=TextureFormat.RGBA5551,
        do_not_delete_source=True,
    ),
    File(
        ...
        pointer_table_index=TableNames.TexturesGeometry,
        file_index=getBonusSkinOffset(ExtraTextures.StaticGoldPalette),
        source_file="assets/hash/key_om2_palette.png",
        texture_format=TextureFormat.RGBA5551,
        do_not_delete_source=True,
    ),
    File(
    ...
    File(name="Watermelon Slice", pointer_table_index=TableNames.ModelTwoGeometry, file_index=0x2A6, source_file="slice.bin", do_not_delete_source=True, do_not_extract=True),
]
...
shrinkModel(True, "slice_om1.bin", 0, 1 / 0.15, "shrink_slice.bin", False)
...
model_changes = [
    ...
    ModelChange(0x129, "shrink_slice.bin"),
    ModelChange(0x12A, "slice_om1.bin"),
]
