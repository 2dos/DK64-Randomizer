    ...
    for root, dirs, files in os.walk(r"src"):
        ...
        for file in files:
            ...
            if file.endswith(".c") and file[:-2] not in avoids:
                ...
                subprocess.run([f"{cwd}\\n64chain\\tools\\bin\\mips64-elf-gcc", "-w", "-Wall", o_level, "-mtune=vr4300", "-march=vr4300", "-mabi=32", "-fomit-frame-pointer", "-fno-toplevel-reorder", "-G0", "-c", "-nostdinc", "-I.", "-Iinclude2", "-Iinclude2/libc", "-DTARGET_N64", "-DF3DEX2_GBI", pth])
