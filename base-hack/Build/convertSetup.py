    ...
    with open(file_name, "r+b") as fh:
        ...
        for x in range(model2_count):
            ...
            if map_index == 0xCD:
                ...
                button_loc = (
                    (780, 419.629 + BUTTON_DIST_NORMAL), (1135.232 - BUTTON_DIST_NORMAL, 780), 
                    (780, 1116.334 - BUTTON_DIST_NORMAL), (438.904 + BUTTON_DIST_NORMAL, 780)
                )
                platform_loc = (
                    (778.365, 396.901 + BUTTON_DIST_NORMAL), (1158.427 - BUTTON_DIST_NORMAL, 778.632), 
                    (780.283, 1138.851 - BUTTON_DIST_NORMAL), (416.092 + BUTTON_DIST_NORMAL, 778.456)
                )
