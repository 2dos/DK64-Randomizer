...
class LogicVarHolder:
    ...
    def IsLevelEnterable(self, level):
        ...
        return self.HasEnoughKongs(level, forPreviousLevel=True) and ((self.GoldenBananas >= self.settings.EntryGBs[level]) or can_dk_skip or can_diddy_skip or can_lanky_skip or can_tiny_skip or can_chunky_skip)
