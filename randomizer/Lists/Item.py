...
ItemList = {
    ...
    Items.HelmDonkey1: Item("", False),
    Items.HelmDonkey2: Item("", False),
    Items.HelmDiddy1: Item("", False),
    Items.HelmDiddy2: Item("", False),
    Items.HelmLanky1: Item("", False),
    Items.HelmLanky2: Item("", False),
    Items.HelmTiny1: Item("", False),
    Items.HelmTiny2: Item("", False),
    Items.HelmChunky1: Item("", False),
    Items.HelmChunky2: Item("", False),
