...
ItemList = {
    ...
    Items.DKIslesDonkeyBlueprint: Item("DK Isles Donkey Blueprint", True, Types.Blueprint),
    Items.DKIslesDiddyBlueprint: Item("DK Isles Diddy Blueprint", True, Types.Blueprint),
    Items.DKIslesLankyBlueprint: Item("DK Isles Lanky Blueprint", True, Types.Blueprint),
    Items.DKIslesTinyBlueprint: Item("DK Isles Tiny Blueprint", True, Types.Blueprint),
    Items.DKIslesChunkyBlueprint: Item("DK Isles Chunky Blueprint", True, Types.Blueprint),
    Items.JungleJapesDonkeyBlueprint: Item("Jungle Japes Donkey Blueprint", True, Types.Blueprint),
    Items.JungleJapesDiddyBlueprint: Item("Jungle Japes Diddy Blueprint", True, Types.Blueprint),
    Items.JungleJapesLankyBlueprint: Item("Jungle Japes Lanky Blueprint", True, Types.Blueprint),
    Items.JungleJapesTinyBlueprint: Item("Jungle Japes Tiny Blueprint", True, Types.Blueprint),
    Items.JungleJapesChunkyBlueprint: Item("Jungle Japes Chunky Blueprint", True, Types.Blueprint),
    Items.AngryAztecDonkeyBlueprint: Item("Angry Aztec Donkey Blueprint", True, Types.Blueprint),
    Items.AngryAztecDiddyBlueprint: Item("Angry Aztec Diddy Blueprint", True, Types.Blueprint),
    Items.AngryAztecLankyBlueprint: Item("Angry Aztec Lanky Blueprint", True, Types.Blueprint),
    Items.AngryAztecTinyBlueprint: Item("Angry Aztec Tiny Blueprint", True, Types.Blueprint),
    Items.AngryAztecChunkyBlueprint: Item("Angry Aztec Chunky Blueprint", True, Types.Blueprint),
    Items.FranticFactoryDonkeyBlueprint: Item("Frantic Factory Donkey Blueprint", True, Types.Blueprint),
    Items.FranticFactoryDiddyBlueprint: Item("Frantic Factory Diddy Blueprint", True, Types.Blueprint),
    Items.FranticFactoryLankyBlueprint: Item("Frantic Factory Lanky Blueprint", True, Types.Blueprint),
    Items.FranticFactoryTinyBlueprint: Item("Frantic Factory Tiny Blueprint", True, Types.Blueprint),
    Items.FranticFactoryChunkyBlueprint: Item("Frantic Factory Chunky Blueprint", True, Types.Blueprint),
    Items.GloomyGalleonDonkeyBlueprint: Item("Gloomy Galleon Donkey Blueprint", True, Types.Blueprint),
    Items.GloomyGalleonDiddyBlueprint: Item("Gloomy Galleon Diddy Blueprint", True, Types.Blueprint),
    Items.GloomyGalleonLankyBlueprint: Item("Gloomy Galleon Lanky Blueprint", True, Types.Blueprint),
    Items.GloomyGalleonTinyBlueprint: Item("Gloomy Galleon Tiny Blueprint", True, Types.Blueprint),
    Items.GloomyGalleonChunkyBlueprint: Item("Gloomy Galleon Chunky Blueprint", True, Types.Blueprint),
    Items.FungiForestDonkeyBlueprint: Item("Fungi Forest Donkey Blueprint", True, Types.Blueprint),
    Items.FungiForestDiddyBlueprint: Item("Fungi Forest Diddy Blueprint", True, Types.Blueprint),
    Items.FungiForestLankyBlueprint: Item("Fungi Forest Lanky Blueprint", True, Types.Blueprint),
    Items.FungiForestTinyBlueprint: Item("Fungi Forest Tiny Blueprint", True, Types.Blueprint),
    Items.FungiForestChunkyBlueprint: Item("Fungi Forest Chunky Blueprint", True, Types.Blueprint),
    Items.CrystalCavesDonkeyBlueprint: Item("Crystal Caves Donkey Blueprint", True, Types.Blueprint),
    Items.CrystalCavesDiddyBlueprint: Item("Crystal Caves Diddy Blueprint", True, Types.Blueprint),
    Items.CrystalCavesLankyBlueprint: Item("Crystal Caves Lanky Blueprint", True, Types.Blueprint),
    Items.CrystalCavesTinyBlueprint: Item("Crystal Caves Tiny Blueprint", True, Types.Blueprint),
    Items.CrystalCavesChunkyBlueprint: Item("Crystal Caves Chunky Blueprint", True, Types.Blueprint),
    Items.CreepyCastleDonkeyBlueprint: Item("Creepy Castle Donkey Blueprint", True, Types.Blueprint),
    Items.CreepyCastleDiddyBlueprint: Item("Creepy Castle Diddy Blueprint", True, Types.Blueprint),
    Items.CreepyCastleLankyBlueprint: Item("Creepy Castle Lanky Blueprint", True, Types.Blueprint),
    Items.CreepyCastleTinyBlueprint: Item("Creepy Castle Tiny Blueprint", True, Types.Blueprint),
    Items.CreepyCastleChunkyBlueprint: Item("Creepy Castle Chunky Blueprint", True, Types.Blueprint),
