...
ItemList = {
    ...
    Items.RambiSoul: Item("Rambi", True, Types.BuddySoul, Kongs.any),
    Items.EnguardeSoul: Item("Enguarde", True, Types.BuddySoul, Kongs.any),
    Items.DilloSoul: Item("Army Dillo", True, Types.BossSoul, Kongs.any),
    Items.DogadonSoul: Item("Dogadon", True, Types.BossSoul, Kongs.any),
    Items.MadJackSoul: Item("Mad Jack", True, Types.BossSoul, Kongs.any),
    Items.PufftossSoul: Item("Pufftoss", True, Types.BossSoul, Kongs.any),
    Items.KutOutSoul: Item("King Kut Out", True, Types.BossSoul, Kongs.any),
    Items.KRoolSoul: Item("K. Rool", True, Types.BossSoul, Kongs.any),
