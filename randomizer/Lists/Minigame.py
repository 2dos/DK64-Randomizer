...
MinigameRequirements = {
    ...
    Minigames.BusyBarrelBarrage: Minigame("Busy Barrel Barrage", lambda l: (l.isdonkey and l.coconut) or (l.isdiddy and l.peanut)
                                          or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
    # Helm barrels
    ...
    Minigames.LankyShooting: Minigame("Lanky Shooting", lambda l: (l.isdonkey and l.coconut) or (l.isdiddy and l.peanut) or (l.islanky and l.grape)
                                      or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
    ...
    Minigames.ChunkyShooting: Minigame("Chunky Shooting", lambda l: (l.isdonkey and l.coconut) or (l.isdiddy and l.peanut) or (l.islanky and l.grape)
                                       or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
}
