...
MinigameRequirements = {
    ...
    Minigames.MadMazeMaulInsane: Minigame(
        name="Mad Maze Maul (125 seconds, 10 enemies)",
        group="Mad Maze Maul",
    ...
    Minigames.SplishSplashSalvageEasy: Minigame(
        ...
        logic=lambda l: l.swim and l.vines,
    ),
    ...
    Minigames.SpeedySwingSortieNormal: Minigame(
        ...
        difficulty_lvl=1,
        logic=lambda l: l.vines and l.twirl and l.istiny,
    ),
    ...
    Minigames.DiddyRocketbarrel: Minigame(
        ...
        can_repeat=True,
        logic=lambda l: l.Slam and l.jetpack and l.peanut and l.isdiddy,
    ),
