...
MinigameRequirements = {
    ...
    Minigames.BattyBarrelBanditNormal: Minigame(name="Batty Barrel Bandit (Medium)", map_id=Maps.BattyBarrelBanditNormal, difficulty_lvl=2),
    Minigames.BattyBarrelBanditHard: Minigame(name="Batty Barrel Bandit (Fast)", map_id=Maps.BattyBarrelBanditHard, difficulty_lvl=3),
    # Big Bug Bash
    Minigames.BigBugBashVEasy: Minigame(name="Big Bug Bash (4 Bugs)", map_id=Maps.BigBugBashVEasy),
    Minigames.BigBugBashEasy: Minigame(name="Big Bug Bash (6 Bugs)", map_id=Maps.BigBugBashEasy, difficulty_lvl=1),
    Minigames.BigBugBashNormal: Minigame(name="Big Bug Bash (8 Bugs)", map_id=Maps.BigBugBashNormal, difficulty_lvl=2),
    Minigames.BigBugBashHard: Minigame(name="Big Bug Bash (10 Bugs)", map_id=Maps.BigBugBashHard, difficulty_lvl=3),
    # Busy Barrel Barrage - Lanky excluded because gun is too long
    Minigames.BusyBarrelBarrageEasy: Minigame(name="Busy Barrel Barrage (45 seconds, Slow Respawn)", map_id=Maps.BusyBarrelBarrageEasy, logic=lambda l: (l.isdonkey and l.coconut) or (l.isdiddy and l.peanut) or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
    Minigames.BusyBarrelBarrageNormal: Minigame(name="Busy Barrel Barrage (45 seconds, Medium Respawn)", map_id=Maps.BusyBarrelBarrageNormal, difficulty_lvl=1, logic=lambda l: (l.isdonkey and l.coconut) or (l.isdiddy and l.peanut) or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
    Minigames.BusyBarrelBarrageHard: Minigame(name="Busy Barrel Barrage (60 seconds, Random Spawns)", map_id=Maps.BusyBarrelBarrageHard, difficulty_lvl=2, logic=lambda l: (l.isdonkey and l.coconut) or (l.isdiddy and l.peanut) or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
    # Mad Maze Maul - 120/11 requires shockwave to beat, as such, banned from Helm
    Minigames.MadMazeMaulEasy: Minigame(name="Mad Maze Maul (60 seconds, 5 enemies)", map_id=Maps.MadMazeMaulEasy),
    Minigames.MadMazeMaulNormal: Minigame(name="Mad Maze Maul (60 seconds, 7 enemies)", map_id=Maps.MadMazeMaulNormal, difficulty_lvl=1),
    ...
    Minigames.MadMazeMaulInsane: Minigame(name="Mad Maze Maul (125 seconds, 10 enemies)", map_id=Maps.MadMazeMaulInsane, difficulty_lvl=3),
    # Minecart Mayhem - Higher two difficulties are too hard for those who don't have a guide to do in Helm
    Minigames.MinecartMayhemEasy: Minigame(name="Minecart Mayhem (30 seconds, 1 TNT)", map_id=Maps.MinecartMayhemEasy),
    Minigames.MinecartMayhemNormal: Minigame(name="Minecart Mayhem (45 seconds, 2 TNT)", map_id=Maps.MinecartMayhemNormal, helm_enabled=False, difficulty_lvl=1),
    Minigames.MinecartMayhemHard: Minigame(name="Minecart Mayhem (60 seconds, 2 TNT)", map_id=Maps.MinecartMayhemHard, helm_enabled=False, difficulty_lvl=2),
    # Beaver Bother - Banned from Helm due to widespread difficulty
    Minigames.BeaverBotherEasy: Minigame(name="Beaver Bother (12 Beavers)", map_id=Maps.BeaverBotherEasy, helm_enabled=False),
    ...
    Minigames.StealthySnoopNormal: Minigame(name="Stealthy Snoop (70 seconds)", map_id=Maps.StealthySnoopNormal, difficulty_lvl=2),
    Minigames.StealthySnoopHard: Minigame(name="Stealthy Snoop (90 seconds)", map_id=Maps.StealthySnoopHard, difficulty_lvl=3),
    # Stash Snatch - SSnatch Hybrid determined too difficulty for Helm
    Minigames.StashSnatchEasy: Minigame(name="Stash Snatch (60 seconds, 6 coins)", map_id=Maps.StashSnatchEasy),
    Minigames.StashSnatchNormal: Minigame(name="Stash Snatch (60 seconds, 16 coins)", map_id=Maps.StashSnatchNormal, difficulty_lvl=1),
    Minigames.StashSnatchHard: Minigame(name="Stash Snatch (120 seconds, 4 coins, Stash Snatch Hybrid)", map_id=Maps.StashSnatchHard, helm_enabled=False, difficulty_lvl=2),
    Minigames.StashSnatchInsane: Minigame(name="Stash Snatch (120 seconds, 33 coins)", map_id=Maps.StashSnatchInsane, difficulty_lvl=3),
    ...
    Minigames.SpeedySwingSortieNormal: Minigame(name="Speedy Swing Sortie (45 seconds, 14 coins)", map_id=Maps.SpeedySwingSortieNormal, difficulty_lvl=1, logic=lambda l: l.vines and l.twirl and l.istiny),
    ...
    Minigames.KrazyKongKlamourEasy: Minigame(name="Krazy Kong Klamour (10 Bananas, Slow Flicker)", map_id=Maps.KrazyKongKlamourEasy),
    Minigames.KrazyKongKlamourNormal: Minigame(name="Krazy Kong Klamour (15 Bananas, Slow Flicker)", map_id=Maps.KrazyKongKlamourNormal, difficulty_lvl=1),
    Minigames.KrazyKongKlamourHard: Minigame(name="Krazy Kong Klamour (5 Bananas, Fast Flicker)", map_id=Maps.KrazyKongKlamourHard, helm_enabled=False, difficulty_lvl=2),
    Minigames.KrazyKongKlamourInsane: Minigame(name="Krazy Kong Klamour (10 Bananas, Fast Flicker)", map_id=Maps.KrazyKongKlamourInsane, helm_enabled=False, difficulty_lvl=3),
    # Searchlight Seek
    Minigames.SearchlightSeekVEasy: Minigame(name="Searchlight Seek (4 Klaptraps)", map_id=Maps.SearchlightSeekVEasy),
    Minigames.SearchlightSeekEasy: Minigame(name="Searchlight Seek (6 Klaptraps)", map_id=Maps.SearchlightSeekEasy, difficulty_lvl=1),
    Minigames.SearchlightSeekNormal: Minigame(name="Searchlight Seek (8 Klaptraps)", map_id=Maps.SearchlightSeekNormal, difficulty_lvl=2),
    Minigames.SearchlightSeekHard: Minigame(name="Searchlight Seek (10 Klaptraps)", map_id=Maps.SearchlightSeekHard, difficulty_lvl=3),
    # Kremling Kosh
    Minigames.KremlingKoshVEasy: Minigame(name="Kremling Kosh (18 points)", map_id=Maps.KremlingKoshVEasy),
    Minigames.KremlingKoshEasy: Minigame(name="Kremling Kosh (22 points)", map_id=Maps.KremlingKoshEasy, difficulty_lvl=1),
    Minigames.KremlingKoshNormal: Minigame(name="Kremling Kosh (25 points)", map_id=Maps.KremlingKoshNormal, difficulty_lvl=2),
    Minigames.KremlingKoshHard: Minigame(name="Kremling Kosh (28 points)", map_id=Maps.KremlingKoshHard, difficulty_lvl=3),
    # Peril Path Panic
    Minigames.PerilPathPanicVEasy: Minigame(name="Peril Path Panic (6 points)", map_id=Maps.PerilPathPanicVEasy),
    Minigames.PerilPathPanicEasy: Minigame(name="Peril Path Panic (8 points)", map_id=Maps.PerilPathPanicEasy, difficulty_lvl=1),
    Minigames.PerilPathPanicNormal: Minigame(name="Peril Path Panic (10 points)", map_id=Maps.PerilPathPanicNormal, difficulty_lvl=2),
    Minigames.PerilPathPanicHard: Minigame(name="Peril Path Panic (12 points)", map_id=Maps.PerilPathPanicHard, difficulty_lvl=3),
    # Helm barrels
    Minigames.DonkeyRambi: Minigame(name="Hideout Helm: DK Rambi", map_id=Maps.HelmBarrelDKRambi, can_repeat=False),
    ...
    Minigames.DiddyRocketbarrel: Minigame(name="Hideout Helm: Diddy Rocketbarrel", map_id=Maps.HelmBarrelDiddyRocketbarrel, can_repeat=False, logic=lambda l: l.Slam and l.jetpack and l.peanut and l.isdiddy),
    # Supposed to use sprint but can make it without), even with Chunky
    Minigames.LankyMaze: Minigame(name="Hideout Helm: Lanky Maze", map_id=Maps.HelmBarrelLankyMaze, can_repeat=False),
    ...
    Minigames.TinyMushroom: Minigame(name="Hideout Helm: Tiny Mushroom", map_id=Maps.HelmBarrelTinyMush, helm_enabled=True, can_repeat=False),
    ...
    Minigames.ChunkyHiddenKremling: Minigame(name="Hideout Helm: Chunky Hidden Kremling", map_id=Maps.HelmBarrelChunkyHidden, helm_enabled=True, can_repeat=False, logic=lambda l: l.hunkyChunky and l.punch and l.ischunky),
    Minigames.ChunkyShooting: Minigame(
        name="Hideout Helm: Chunky Shooting",
        map_id=Maps.HelmBarrelChunkyShooting,
        can_repeat=False,
        logic=lambda l: (l.scope or l.homing or l.settings.hard_shooting) and ((l.isdonkey and l.coconut) or (l.isdiddy and l.peanut) or (l.islanky and l.grape) or (l.istiny and l.feather) or (l.ischunky and l.pineapple)),
    ),
}
