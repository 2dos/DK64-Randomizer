...
BananaCoinGroupList = {
    Levels.DKIsles: [
        ...
        BananaCoinGroup(
            ...
            logic=lambda l: ((l.istiny and l.twirl) or l.settings.damage_amount != DamageAmount.ohko),
            locations=[
                [1.0, 3343, 712, 3376],
                [1.0, 3318, 710, 3427],
                [1.0, 3375, 711, 3450],
    ...
    Levels.JungleJapes: [
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.tiny],
            region=Regions.TinyHive,
            logic=lambda l: (l.CanSlamSwitch(Levels.JungleJapes, 1) and l.istiny) or l.phasewalk,
            locations=[
        ...
        BananaCoinGroup(
            ...
            region=Regions.JapesCatacomb,
            logic=lambda l: l.vines and l.pineapple and l.ischunky,
            locations=[
    ...
    Levels.AngryAztec: [
        ...
        BananaCoinGroup(
            ...
            logic=lambda l: (l.coconut and l.isdonkey) or l.phasewalk,
            locations=[
                [1.0, 365, 66, 978],
                [1.0, 370, 86, 1017],
                [1.0, 469, 86, 1015],
        ...
        BananaCoinGroup(
            ...
            logic=lambda l: (l.feather and l.istiny and l.mini) or l.phasewalk,
            locations=[
                [1.0, 1207, 47, 583],
                [1.0, 1206, 47, 727],
                [1.0, 1054, 47, 726],
        ...
        BananaCoinGroup(
            ...
            logic=lambda l: l.CanSlamSwitch(Levels.AngryAztec, 1) and l.istiny,
            locations=[
                [1.0, 945, 420, 3708],
                [1.0, 852, 420, 3659],
                [1.0, 795, 420, 3756],
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.diddy, Kongs.tiny],
            region=Regions.TempleUnderwater,
            logic = lambda l: Locations.TinyKong in l.SpecialLocationsReached, # Can't reach the top of the O without the platform
            locations=[
                [1.0, 758, 412, 1703],
                [1.0, 354, 412, 1822],
                [1.0, 92, 412, 1567],
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.diddy],
            region=Regions.TempleStart,
            logic=lambda l: l.CanSlamSwitch(Levels.AngryAztec, 1) and l.isdiddy and l.peanut,
            locations=[
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.tiny],
            region=Regions.TinyTemple,
            logic=lambda l: (l.feather and l.istiny) or l.phasewalk,
            locations=[
    ...
    Levels.FranticFactory: [
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.diddy, Kongs.tiny],
            region=Regions.BeyondHatch,
            logic=lambda l: (l.spring and l.isdiddy) or (l.istiny and l.twirl),
            locations=[
    ...
    Levels.FungiForest: [
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.tiny, Kongs.chunky],
            region=Regions.MillChunkyTinyArea,
            logic=lambda l: (l.ischunky and l.TimeAccess(Regions.MillChunkyTinyArea, Time.Day)) or l.istiny,
            locations=[
    ...
    Levels.CrystalCaves: [
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.diddy, Kongs.lanky, Kongs.tiny],
            region=Regions.CrystalCavesMain,
            logic=lambda l: (l.balloon and l.islanky) or l.isdiddy and l.istiny,
            locations=[
    ...
    Levels.CreepyCastle: [
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.lanky],
            region=Regions.Mausoleum,
            logic=lambda l: (l.sprint and l.islanky and l.grape) and (l.trombone and l.vines),
            locations=[
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.chunky],
            region=Regions.Crypt,
            logic=lambda l: (l.pineapple and l.ischunky and l.punch) or l.phasewalk,
            locations=[
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.diddy],
            region=Regions.Crypt,
            logic=lambda l: (l.peanut and l.isdiddy and l.charge) or l.phasewalk,
            locations=[
        ...
        BananaCoinGroup(
            ...
            konglist=[Kongs.lanky],
            region=Regions.Dungeon,
            logic=lambda l: (l.CanSlamSwitch(Levels.CreepyCastle, 3) or l.phasewalk) and l.islanky and l.trombone and l.balloon,
            locations=[
