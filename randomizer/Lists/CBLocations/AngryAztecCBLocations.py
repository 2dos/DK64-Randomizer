...
BalloonList = [
    ...
    Balloon(
        id=3,
        map_id=Maps.AngryAztec,
        name="Behind DK Stone Door",
        speed=6,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        item_rando_kong=[Kongs.donkey],
    ...
    Balloon(
        id=13,
        map_id=Maps.AngryAztec,
        name="In Front of Vulture Cage Shop",
        speed=5,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.AngryAztecMain,
    ...
    Balloon(
        id=15,
        map_id=Maps.AngryAztec,
        name="Right Side of 5-Door Temple",
        speed=4,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        # item_rando_kong=[Kongs.donkey],
        item_logic=lambda l: l.strong and l.donkey,
    ...
    Balloon(
        id=20,
        map_id=Maps.AztecTinyTemple,
        name="Tiny Temple: Mini Monkey Alcove",
        speed=5,
        konglist=[Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.TempleStart,
    ...
    Balloon(
        id=21,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Matching Game Room (0)",
        speed=4,
        konglist=[Kongs.lanky],
        region=Regions.LlamaTempleMatching,
    ...
    Balloon(
        id=22,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Above Lava Water",
        speed=5,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
        item_logic=lambda l: Events.AztecLlamaSpit in l.Events and l.swim,
    ...
    Balloon(
        id=28,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: In Lanky's room (0)",
        speed=4,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
        vanilla=True,
    ...
    Balloon(
        id=29,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: In Lanky's room (1)",
        speed=3,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
        vanilla=True,
    ...
    Balloon(
        id=47,
        map_id=Maps.AngryAztec,
        name="Front of Quicksand Tunnel",
        speed=10,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        item_rando_kong=[Kongs.donkey],
        item_logic=lambda l: l.strong and l.donkey,
    ...
    Balloon(
        id=51,
        map_id=Maps.AztecDonkey5DTemple,
        name="DK 5DT: Path to the Second Coconut Switch",
        speed=5,
        konglist=[Kongs.donkey],
        region=Regions.DonkeyTemple,
    ...
    Balloon(
        id=52,
        map_id=Maps.AztecDiddy5DTemple,
        name="Diddy 5DT: Second Peanut Switch",
        speed=5,
        konglist=[Kongs.diddy],
        region=Regions.DiddyTemple,
    ...
    Balloon(
        id=55,
        map_id=Maps.AztecChunky5DTemple,
        name="Chunky 5DT: End Pineapple Switch Hall",
        speed=6,
        konglist=[Kongs.chunky],
        region=Regions.ChunkyTemple,
    ...
    Balloon(
        id=56,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Entrance Stairs",
        speed=7,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
    ...
    Balloon(
        id=57,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Right of Llama",
        speed=5,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
    ...
    Balloon(
        id=58,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Left of Llama",
        speed=5,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
    ...
    Balloon(
        id=59,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Matching Game",
        speed=7,
        konglist=[Kongs.lanky],
        region=Regions.LlamaTempleMatching,
    ...
    Balloon(
        id=60,
        map_id=Maps.AztecLlamaTemple,
        name="Llama Temple: Arch to Lava Room",
        speed=5,
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.LlamaTemple,
    ...
    Balloon(
        id=62,
        map_id=Maps.AztecTinyTemple,
        name="Tiny Temple: Near the Chunky Klaptrap Room",
        speed=5,
        konglist=[Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.TempleStart,
    ...
    Balloon(
        id=65,
        map_id=Maps.AztecTinyTemple,
        name="Tiny Temple: KONG above the cage",
        speed=5,
        konglist=[Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.TempleKONGRoom,
