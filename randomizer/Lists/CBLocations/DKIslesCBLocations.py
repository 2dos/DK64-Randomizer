...
ColoredBananaGroupList = [
    ...
    ColoredBananaGroup(
        ...
        region=Regions.IslesMain,
        logic=lambda l: l.pineapple or l.CanSTS() or l.phasewalk,
        locations=[
            [5, 1.0, 2670, 505, 1182], 
            [5, 1.0, 2616, 505, 1196], 
        ],
    ...
    ColoredBananaGroup(
        group=65,
        map_id=Maps.Isles,
        name="On DK Isle's right eyebrow",
        konglist=[Kongs.diddy],
        region=Regions.IslesAirspace,
        locations=[
    ...
    ColoredBananaGroup(
        group=65,
        map_id=Maps.Isles,
        name="On DK Isle's left eyebrow",
        konglist=[Kongs.diddy],
        region=Regions.IslesAirspace,
        locations=[
    ...
    ColoredBananaGroup(
        ...
        konglist=[Kongs.tiny],
        region=Regions.OuterIsles,
        logic=lambda l: l.feather or l.CanSTS() or l.phasewalk,
        locations=[
            [5, 1.0, 877, 505, 2420], 
            [5, 1.0, 865, 505, 2444], 
        ],
    ...
    ColoredBananaGroup(
        ...
        logic=lambda l: (
                ...
                or (
                    ...
                    and (l.isdonkey and l.settings.krusha_kong != Kongs.donkey and (l.settings.damage_amount != DamageAmount.ohko))
    ...
    ColoredBananaGroup(
        ...
        region=Regions.KremIsleBeyondLift,
        locations=[
            [1, 1.0, 2214, 1053, 3986],
            [1, 1.0, 2273, 1062, 4003],
            [1, 1.0, 2343, 1074, 4026],
            [1, 1.0, 2396, 1085, 4028],
            [1, 1.0, 2416, 1089, 4036],
            [1, 1.0, 2473, 1102, 4029],
            [1, 1.0, 2521, 1112, 4013],
            [1, 1.0, 2558, 1120, 3982],
            [1, 1.0, 2612, 1134, 3947],
            [1, 1.0, 2646, 1144, 3919],
            [1, 1.0, 2664, 1153, 3885],
            [1, 1.0, 2678, 1162, 3858],
            [1, 1.0, 2693, 1169, 3830],
            [1, 1.0, 2714, 1183, 3759],
            [1, 1.0, 2739, 1196, 3703],
        ],
    ),
    ColoredBananaGroup(
        group=88,
    ...
    ColoredBananaGroup(
        ...
        konglist=[Kongs.lanky],
        region=Regions.KremIsle,
        logic=lambda l: l.grape or l.CanPhaseswim() or l.phasewalk,
        locations=[
            [5, 1.0, 3281, 505, 3536],
            [5, 1.0, 3307, 505, 3548],
        ],
    ...
    ColoredBananaGroup(
        ...
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.FungiForestLobby,
        logic=lambda l: ((l.coconut and l.donkey) and (l.peanut and l.diddy) and (l.grape and l.lanky) and (l.feather and l.tiny) and (l.pineapple and l.chunky) or l.phasewalk),
        locations=[
            [5, 1.0, 94, 14, 536],
        ],
    ),
    ...
    ColoredBananaGroup(
        ...
        konglist=[Kongs.donkey],
        region=Regions.CrystalCavesLobby,
        logic=lambda l: ((l.punch and l.chunky) or l.phasewalk or l.ledgeclip) and l.strongKong,
        locations=[
            [5, 1.0, 178, 10, 436],
            [5, 1.0, 135, 10, 306],
            [5, 1.0, 175, 10, 185],
    ...
    ColoredBananaGroup(
        ...
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.CreepyCastleLobby,
        logic=lambda l: (l.coconut and l.donkey) or l.phasewalk,
        locations=[
            [1, 1.0, 599, 71, 783],
            [1, 1.0, 590, 71, 755],
            [1, 1.0, 560, 71, 755],
...
BalloonList = [
    ...
    Balloon(
        ...
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.FungiForestLobby,
        points=[[418, 191, 680], [295, 160, 600], [196, 200, 698], [286, 190, 714], [370, 100, 657], [268, 120, 558], [359, 160, 339], [224, 200, 287], [153, 185, 456], [140, 165, 584], [269, 50, 604]],
    ),
    Balloon(
        id=41,
        map_id=Maps.FungiForestLobby,
