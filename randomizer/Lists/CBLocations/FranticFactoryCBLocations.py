...
ColoredBananaGroupList = {
    ...
    ColoredBananaGroup(
        group=6,
        map_id=Maps.FranticFactory,
        name="W3 group with bunch on other W3",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.FranticFactoryStart,  # Other bunch is in Testing
        locations=[
            [5, 1.0, 1436, 858, 2174],
        ],
    ),
    ...
    ColoredBananaGroup(
        group=18,
        map_id=Maps.FranticFactory,
        name="Block tower room by Mini Monkey barrel group with the tiny bunch on the accessible side of the tunnel to spinning wheel",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.Testing,
        locations=[
            [5, 1.0, 2258, 1132, 894],
    ...
    ColoredBananaGroup(
        group=21,
        map_id=Maps.FranticFactory,
        name="Tunnel to numbers game group with DK singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.Testing,
        locations=[
    ...
    ColoredBananaGroup(
        group=29,
        map_id=Maps.FranticFactory,
        name="Group with Lanky's 5 lower R&D singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.RandD,
        locations=[
    ...
    ColoredBananaGroup(
        group=51,
        map_id=Maps.FranticFactory,
        name="From Prod room to Chunky room group with DK singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.BeyondHatch,
        locations=[
            [1, 1.0, 1038, 8, 1310],
    ...
    ColoredBananaGroup(
        group=52,
        map_id=Maps.FranticFactory,
        name="Bottom of production room group with Diddy singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.BeyondHatch,
        locations=[
            [1, 1.0, 344, 0, 1434],
    ...
    ColoredBananaGroup(
        group=65,
        map_id=Maps.FranticFactory,
        name="From long pole to prod room group with DK singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.BeyondHatch,
        locations=[
            [1, 1.0, 236, 7, 1346],
    ...
    ColoredBananaGroup(
        group=75,
        map_id=Maps.FranticFactory,
        name="Tunnel to DK Arcade group with Diddy singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.BeyondHatch,
        locations=[
    ...
    ColoredBananaGroup(
        group=80,
        map_id=Maps.FranticFactory,
        name="Tunnel to Funky's room group with Diddy singles",
        konglist=[Kongs.donkey, Kongs.diddy, Kongs.lanky, Kongs.tiny, Kongs.chunky],
        region=Regions.Testing,
        locations=[
            [1, 1.0, 1809, 1114, 832],
