...
ColoredBananaGroupList = [
    ...
    # ColoredBananaGroup( #  Temporarily disabled, because the hands won't be there if this GB check is a noItem
    #     group=102,
...
BalloonList = [
    ...
    Balloon(
        id=28, map_id=Maps.CastleMausoleum, name="Above green goo room", speed=8, konglist=[Kongs.tiny], region=Regions.Mausoleum, logic=lambda l: l.twirl, points=[[1304, 240, 2150], [967, 230, 2140]]
    ),
    Balloon(
        id=29,
        map_id=Maps.CastleUpperCave,
