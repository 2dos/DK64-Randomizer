...
CrownLocations = {
    Levels.JungleJapes: [
        ...
        CrownLocation(
            map=Maps.JungleJapes,
            name="Jungle Japes: Lanky Alcove Hill",
            x=2209,
            y=339,
            z=3205,
            scale=0.4,
    ...
    Levels.AngryAztec: [
        ...
        CrownLocation(
            map=Maps.AztecDiddy5DTemple, name="Angry Aztec - Diddy 5DT: Dead End", x=1060, y=20, z=493, scale=0.4, region=Regions.DiddyTemple, logic=lambda l: (l.peanut and l.isdiddy) or l.phasewalk
        ),
        CrownLocation(
            map=Maps.AztecLanky5DTemple, name="Angry Aztec - Lanky 5DT: Dead End", x=767, y=122, z=916, scale=0.3, region=Regions.LankyTemple, logic=lambda l: (l.grape and l.islanky) or l.phasewalk
        ),
        CrownLocation(
            map=Maps.AztecLanky5DTemple,
            name="Angry Aztec - Lanky 5DT: Near Vanilla Balloon",
            x=180,
            y=47,
            z=658,
            scale=0.45,
        ...
        CrownLocation(
            ...
            name="Angry Aztec - Chunky 5DT: Path Split (1)",
            x=375,
            y=20,
            z=321,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.AztecChunky5DTemple,
            name="Angry Aztec - Chunky 5DT: Path Split (2)",
            x=779,
            y=47,
            z=678,
            scale=0.45,
    ...
    Levels.FranticFactory: [
        ...
        CrownLocation(map=Maps.FranticFactory, name="Frantic Factory: Hatch Pole Center", x=644, y=459, z=1778, scale=0.45, region=Regions.LowerCore),
        CrownLocation(map=Maps.FranticFactory, name="Frantic Factory: Hatch Pole Bottom", x=654, y=167, z=1988, scale=0.4, region=Regions.LowerCore),
        CrownLocation(map=Maps.FranticFactory, name="Frantic Factory: Production Room Lower Section", x=517, y=188, z=1331, scale=0.3, region=Regions.MiddleCore),
        ...
        CrownLocation(map=Maps.FranticFactory, name="Frantic Factory: Dark Room", x=1850, y=6, z=525, scale=0.45, region=Regions.BeyondHatch, logic=lambda l: (l.punch and l.chunky) or l.phasewalk),
        ...
        # ),
        CrownLocation(map=Maps.FranticFactory, name="Frantic Factory: Near Car Race", x=3553, y=1264, z=1383, scale=0.3, region=Regions.RandD, logic=lambda l: (l.mini and l.istiny) or l.phasewalk),
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Under R&D Grate (2)",
            x=4054,
            y=1313,
            z=776,
            scale=0.5,
    ...
    Levels.FungiForest: [
        ...
        CrownLocation(map=Maps.ForestMillFront, name="Fungi Forest - Mill Front: Near Conveyor", x=63, y=0, z=400, scale=0.3, region=Regions.GrinderRoom),
        CrownLocation(map=Maps.ForestMillFront, name="Fungi Forest - Mill Front: Near Mini Monkey", x=256, y=0, z=196, scale=0.5, region=Regions.GrinderRoom),
        ...
        CrownLocation(map=Maps.ForestMillBack, name="Fungi Forest - Mill Rear: Near Thatch", x=449, y=0, z=610, scale=0.5, region=Regions.MillChunkyTinyArea),
    ...
    Levels.CrystalCaves: [
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: In Chunky Ice Shield",
            x=755,
            y=48,
            z=818,
            scale=0.2,
        ...
        # CrownLocation(map=Maps.CavesDiddyIgloo, name="Crystal Caves - Diddy 5DI: Center", x=286, y=0, z=295, scale=0.4, region=Regions.DiddyIgloo), # removed due to potential crash
    ...
    Levels.CreepyCastle: [
        ...
        CrownLocation(
            ...
            name="Creepy Castle - Dungeon: DK Dungeon Room",
            x=1492,
            y=170,
            z=2000,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.CastleCrypt, name="Creepy Castle - Chunky Crypt: Near Coffin", x=1280, y=160, z=2867, scale=0.45, region=Regions.Crypt, logic=lambda l: (l.pineapple and l.ischunky) or l.phasewalk
        ),
        CrownLocation(
            map=Maps.CastleCrypt, name="Creepy Castle - Diddy Crypt: Near Coffin", x=2069, y=0, z=593, scale=0.45, region=Regions.Crypt, logic=lambda l: (l.peanut and l.isdiddy) or l.phasewalk
        ),
    ...
    Levels.DKIsles: [
        ...
        CrownLocation(map=Maps.Isles, name="DK Isles: Outside K. Lumsy", x=3107, y=520, z=3500, scale=0.3, region=Regions.KremIsle),
        ...
        CrownLocation(map=Maps.Isles, name="DK Isles: Behind Factory Lobby Entrance", x=2395, y=1200, z=3899, scale=0.4, region=Regions.KremIsleBeyondLift),
        CrownLocation(map=Maps.Isles, name="DK Isles: Right of Factory Lobby Entrance", x=2159, y=1200, z=3518, scale=0.4, region=Regions.KremIsleBeyondLift),
        CrownLocation(map=Maps.Isles, name="DK Isles: Behind Helm Lobby Entrance", x=2370, y=1720, z=3809, scale=0.25, region=Regions.KremIsleTopLevel),
        CrownLocation(map=Maps.Isles, name="DK Isles: Left Kroc Isle Arm", x=2218, y=1620, z=3488, scale=0.5, region=Regions.KremIsleTopLevel),
        CrownLocation(map=Maps.Isles, name="DK Isles: Right Kroc Isle Arm", x=2700, y=1620, z=3315, scale=0.5, region=Regions.KremIsleTopLevel),
        ...
        CrownLocation(
            ...
            name="DK Isles - Aztec Lobby: Behind Feather Door",
            x=930,
            y=0,
            z=637,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Factory Lobby: Above Portal",
            x=677,
            y=134,
            z=367,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Caves Lobby: High Platform",
            x=794,
            y=280.4,
            z=739,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.CrystalCavesLobby,
            name="DK Isles - Caves Lobby: Blueprint Room",
            x=1751,
            y=13.5,
            z=532,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Training Grounds: Far Mountain",
            x=1153,
            y=252,
            z=1822,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.TrainingGrounds,
            name="DK Isles - Training Grounds: Near Mountain",
            x=1187,
            y=225,
            z=734,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.TrainingGrounds, name="DK Isles - Training Grounds: Banana Hoard", x=2500, y=211, z=920, scale=0.35, region=Regions.TrainingGrounds, logic=lambda l: l.vines or l.CanMoonkick()
        ),
