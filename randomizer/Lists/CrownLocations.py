...
CrownLocations = {
    Levels.JungleJapes: [
        ...
        CrownLocation(
            map=Maps.JungleJapes,
            name="Jungle Japes: Diddy Cavern",
            x=2381,
            y=280,
            z=392,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.JungleJapes,
            name="Jungle Japes: Shellhive Island",
            x=2337,
            y=551,
            z=3156,
            scale=0.6,
        ...
        CrownLocation(
            map=Maps.JungleJapes,
            name="Jungle Japes: Behind Storm Area Shop",
            x=1705,
            y=280,
            z=4233,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.JungleJapes,
            name="Jungle Japes: Near High Shop",
            x=2045,
            y=680,
            z=2522,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.JungleJapes,
            name="Jungle Japes: Starting Area (Low)",
            x=742,
            y=286,
            z=825,
            scale=0.35,
        ...
        CrownLocation(
            ...
            name="Jungle Japes - Shell: Main Room",
            x=1385,
            y=212,
            z=1381,
            scale=0.7,
        ...
        CrownLocation(
            map=Maps.JapesTinyHive,
            name="Jungle Japes - Shell: 1st Room",
            x=610,
            y=130,
            z=1279,
            scale=0.6,
    ...
    Levels.AngryAztec: [
        ...
        CrownLocation(
            map=Maps.AngryAztec,
            name="Angry Aztec: Next to Chunky Cage (1)",
            x=4276.6,
            y=120,
            z=2266,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.AngryAztec,
            name="Angry Aztec: Next to Chunky Cage (2)",
            x=4283,
            y=120,
            z=2543.6,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.AngryAztec,
            name="Angry Aztec: Near Snoop Tunnel Shop",
            x=3000,
            y=120,
            z=4532,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.AngryAztec,
            name="Angry Aztec: Near Snoop Tunnel Exterior Warp",
            x=3422,
            y=120,
            z=4514,
            scale=0.35,
        ...
        CrownLocation(
            ...
            name="Angry Aztec - DK 5DT: Dead End",
            x=99,
            y=20,
            z=464,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.AztecLlamaTemple,
            name="Angry Aztec - Llama Temple: Snoop Switch",
            x=1695,
            y=433,
            z=1704,
            scale=0.3,
    ...
    Levels.FranticFactory: [
        CrownLocation(
            ...
            name="Frantic Factory: Under R&D Grate (1)",
            x=4119,
            y=1313,
            z=1165.81,
            scale=0.51,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Foyer Carpet",
            x=1265,
            y=830,
            z=2504,
            scale=0.6,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Foyer far left",
            x=1106,
            y=842,
            z=2106,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: On Production outside box",
            x=988,
            y=322,
            z=1175,
            scale=0.25,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Cranky/Candy Room",
            x=316,
            y=165,
            z=805,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Snide's Room",
            x=1702,
            y=810,
            z=2240,
            scale=0.3,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Block Tower Lower Bonus",
            x=2634,
            y=1026,
            z=1101,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.FranticFactory,
            name="Frantic Factory: Funky's Room",
            x=1595,
            y=1113,
            z=760,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Frantic Factory - Power Shed: Corner",
            x=62,
            y=0,
            z=64,
            scale=0.3,
    ...
    Levels.GloomyGalleon: [
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Near Chest Cannon (1)",
            x=3072,
            y=1790,
            z=3501,
            scale=0.3,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Near Chest Cannon (2)",
            x=3072,
            y=1790,
            z=3360,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Near Chest GB Tunnel",
            x=3048,
            y=1670,
            z=3832,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Near Chest GB",
            x=3506,
            y=1670,
            z=3802,
            scale=0.55,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Left of Cranky",
            x=3175,
            y=1670,
            z=2527,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: On Lighthouse Platform (Rocketbarrel)",
            x=1396,
            y=1610,
            z=4150,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: On Lighthouse Platform (Baboon Blast)",
            x=1618,
            y=1610,
            z=4175,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Blueprint Alcove",
            x=680,
            y=1564,
            z=3940,
            scale=0.55,
        ...
        CrownLocation(
            map=Maps.GloomyGalleon,
            name="Gloomy Galleon: Behind Snide's",
            x=2071,
            y=1610,
            z=4823,
            scale=0.3,
    ...
    Levels.FungiForest: [
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Near Snide's HQ",
            x=3154,
            y=268,
            z=3682,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Behind Diddy Barn",
            x=3139,
            y=272,
            z=4343,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Left of Diddy Barn",
            x=3400,
            y=272,
            z=4652,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Near Mill Tag",
            x=4706,
            y=139,
            z=4373,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: En route to DK Barn",
            x=4604,
            y=206,
            z=2844,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Right of DK Barn",
            x=4492,
            y=116,
            z=1959,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Far Right of DK Barn",
            x=4147,
            y=115,
            z=1496,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Far Left of DK Barn",
            x=3529,
            y=115,
            z=2035,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Near DK Barn",
            x=4151,
            y=115,
            z=1784,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Near Funky's",
            x=2890,
            y=174,
            z=189,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Highest Giant Mushroom Platform",
            x=1196,
            y=1250,
            z=1315,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Near Owl Rocketbarrel (1)",
            x=534,
            y=189,
            z=3948,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.FungiForest,
            name="Fungi Forest: Near Owl Rocketbarrel (2)",
            x=278,
            y=190,
            z=3707,
            scale=0.6,
        ...
        CrownLocation(
            ...
            name="Fungi Forest - DK Barn: Near Entrance",
            x=537,
            y=4,
            z=143,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.ForestThornvineBarn,
            name="Fungi Forest - DK Barn: Near Ladder",
            x=106,
            y=4,
            z=590,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.ForestGiantMushroom,
            name="Fungi Forest - Giant Mushroom: Near Night Door Vines",
            x=218,
            y=979,
            z=529,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Fungi Forest - Mushroom Leap: Opposite Entrance",
            x=414,
            y=0,
            z=282,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Fungi Forest - Mill Rear: Near Thatch",
            x=449,
            y=0,
            z=610,
            scale=0.5,
    ...
    Levels.CrystalCaves: [
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: In Hidden Bonus Room",
            x=453,
            y=180,
            z=2571,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Ice Castle Tag (1)",
            x=2066,
            y=151,
            z=1145,
            scale=0.25,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Ice Castle Tag (2)",
            x=1952,
            y=172,
            z=1181,
            scale=0.25,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Ice Castle Tag (3)",
            x=2164,
            y=280,
            z=1304,
            scale=0.3,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Snide's HQ",
            x=1220,
            y=64,
            z=587,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Funky's",
            x=2543,
            y=172,
            z=1173,
            scale=0.25,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Hidden Kasplat Room",
            x=3554,
            y=286,
            z=619,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near 1DC Headphones",
            x=2987,
            y=118,
            z=1615,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Rotating Room (1)",
            x=2903.5,
            y=281.8,
            z=2312,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Rotating Room (2)",
            x=2672,
            y=281,
            z=2500,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: High Cabin Kasplat Platform",
            x=2984,
            y=373,
            z=1848,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Rotating Room Rocketbarrel",
            x=2465,
            y=206.8,
            z=2530,
            scale=0.25,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Tiny 5DC",
            x=3551,
            y=260,
            z=1900,
            scale=0.3,
        ...
        CrownLocation(
            map=Maps.CrystalCaves,
            name="Crystal Caves: Near Diddy Upper 5DC",
            x=3684,
            y=343,
            z=1886,
            scale=0.25,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - Diddy 5DI: Center",
            x=286,
            y=0,
            z=295,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - DK 5DI: Behind Maze",
            x=469,
            y=0,
            z=177,
            scale=0.5,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - Lanky 5DI: High Platform",
            x=273,
            y=123.3,
            z=245,
            scale=0.25,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - Tiny 5DI: Opposite Entrance",
            x=385,
            y=0,
            z=200,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - Lanky 1DC: Carpet",
            x=448,
            y=0,
            z=332,
            scale=0.45,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - Chunky 5DC: Back Left Corner",
            x=493,
            y=0,
            z=536,
            scale=0.35,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - Diddy Upper 5DC: Right",
            x=106,
            y=0,
            z=353,
            scale=0.45,
        ...
        CrownLocation(
            ...
            name="Crystal Caves - DK 5DC: Opposite Entrance",
            x=165,
            y=0,
            z=463,
            scale=0.35,
    ...
    Levels.CreepyCastle: [
        ...
        CrownLocation(
            map=Maps.CastleGreenhouse,
            name="Creepy Castle - Greenhouse: Dead End (1)",
            x=224,
            y=0,
            z=494,
            scale=0.2,
        ...
        CrownLocation(
            map=Maps.CastleGreenhouse,
            name="Creepy Castle - Greenhouse: Dead End (2)",
            x=874,
            y=0,
            z=522,
            scale=0.2,
        ...
        CrownLocation(
            map=Maps.CastleGreenhouse,
            name="Creepy Castle - Greenhouse: GB Box",
            x=349,
            y=0,
            z=302,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.CastleGreenhouse,
            name="Creepy Castle - Greenhouse: Dead End (3)",
            x=779,
            y=0,
            z=125,
            scale=0.2,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Crypt Entrance (1)",
            x=1361,
            y=366,
            z=2108,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Crypt Entrance (2)",
            x=420,
            y=366,
            z=1934,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Crypt Entrance (3)",
            x=500,
            y=523,
            z=1660,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Kasplat Pole",
            x=204,
            y=628,
            z=1433,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Cranky",
            x=483,
            y=1135,
            z=1379,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Wind Tower (1)",
            x=1707,
            y=1731,
            z=1255,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CreepyCastle,
            name="Creepy Castle: Near Snide's HQ",
            x=713,
            y=1794,
            z=1243,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Creepy Castle - Dungeon: Near Diddy Room Entrance",
            x=442,
            y=115,
            z=2595,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Creepy Castle - Crypt Hub: Lower Portion",
            x=559,
            y=90,
            z=1153,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CastleLowerCave,
            name="Creepy Castle - Crypt Hub: Behind Lanky Crypt",
            x=1848,
            y=320,
            z=1186,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CastleLowerCave,
            name="Creepy Castle - Crypt Hub: Near Funky's",
            x=1359,
            y=200,
            z=433,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Creepy Castle - Chunky Crypt: Near Coffin",
            x=1280,
            y=160,
            z=2867,
            scale=0.45,
        ...
        CrownLocation(
            map=Maps.CastleCrypt,
            name="Creepy Castle - Diddy Crypt: Near Coffin",
            x=2069,
            y=0,
            z=593,
            scale=0.45,
        ...
        CrownLocation(
            ...
            name="Creepy Castle - Lanky Crypt: Lanky Tunnel",
            x=1186,
            y=160,
            z=130,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="Creepy Castle - Tunnel: Near Pit",
            x=704,
            y=200,
            z=852,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CastleUpperCave,
            name="Creepy Castle - Tunnel: Near Candy's",
            x=1104,
            y=300,
            z=2241,
            scale=0.4,
    ...
    Levels.DKIsles: [
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Near Caves Lobby Tree (1)",
            x=2497,
            y=507,
            z=1903,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Near Fungi Cannon",
            x=3440,
            y=495,
            z=1222,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Near Caves Lobby Tree (2)",
            x=2427,
            y=600,
            z=1822,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Front of Aztec Building",
            x=3225,
            y=1000,
            z=1613,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Near Monkeyport (1)",
            x=2519,
            y=550,
            z=4152,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Near Monkeyport (2)",
            x=1852,
            y=600,
            z=3920,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Under DK Caged GB",
            x=2000,
            y=550,
            z=3325,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Behind Factory Lobby Entrance",
            x=2395,
            y=1200,
            z=3899,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Right of Factory Lobby Entrance",
            x=2159,
            y=1200,
            z=3518,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Behind Helm Lobby Entrance",
            x=2370,
            y=1720,
            z=3809,
            scale=0.25,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Left Kroc Isle Arm",
            x=2218,
            y=1620,
            z=3488,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.Isles,
            name="DK Isles: Right Kroc Isle Arm",
            x=2700,
            y=1620,
            z=3315,
            scale=0.5,
        ...
        CrownLocation(
            ...
            name="DK Isles - Japes Lobby: Near Portal",
            x=711,
            y=0,
            z=632,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Aztec Lobby: In Front of Feather Door",
            x=680,
            y=0,
            z=439,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Factory Lobby: Near Lever",
            x=280,
            y=0,
            z=292,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Galleon Lobby: Right of Portal",
            x=429,
            y=139.6,
            z=942,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.GloomyGalleonLobby,
            name="DK Isles - Galleon Lobby: Left of Portal",
            x=855,
            y=119.6,
            z=886,
            scale=0.35,
        ...
        CrownLocation(
            ...
            name="DK Isles - Caves Lobby: Right of Portal",
            x=1091,
            y=118,
            z=541,
            scale=0.4,
        ...
        CrownLocation(
            ...
            name="DK Isles - Castle Lobby: Right of Entrance",
            x=355,
            y=60,
            z=269,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.CreepyCastleLobby,
            name="DK Isles - Castle Lobby: Left of Portal",
            x=803,
            y=60,
            z=1066,
            scale=0.4,
        ...
        CrownLocation(
            map=Maps.TrainingGrounds,
            name="DK Isles - Training Grounds: Rear Cave",
            x=1196,
            y=36.4,
            z=2119,
            scale=0.35,
        ...
        CrownLocation(
            map=Maps.TrainingGrounds,
            name="DK Isles - Training Grounds: Near Pool",
            x=1625,
            y=36,
            z=1585,
            scale=0.45,
        ...
        CrownLocation(
            ...
            name="DK Isles - Fairy Island: Right of Queen",
            x=648,
            y=37.5,
            z=133,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.BananaFairyRoom,
            name="DK Isles - Fairy Island: Behind Queen",
            x=1025,
            y=37.5,
            z=508,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.KLumsy,
            name="DK Isles - K. Lumsy: Back Right",
            x=1580,
            y=95,
            z=868,
            scale=0.5,
        ...
        CrownLocation(
            map=Maps.KLumsy,
            name="DK Isles - K. Lumsy: Near Left",
            x=560,
            y=95,
            z=1340,
            scale=0.5,
    ...
    Levels.HideoutHelm: [
        CrownLocation(
            ...
            logic=lambda l: l.lanky and l.handstand and l.chunky and l.pineapple and l.vines and 
        ...
        CrownLocation(
            ...
            scale=0.5,
            region=Regions.HideoutHelmStart,
            logic=lambda l: l.lanky and l.handstand and 
                l.settings.helm_setting == "skip_all"
                or (
                    Events.HelmDonkeyDone in l.Events
                    and Events.HelmChunkyDone in l.Events
        ...
        CrownLocation(
            ...
            scale=0.5,
            region=Regions.HideoutHelmStart,
            logic=lambda l: (l.settings.helm_setting == "skip_all"
                    or (
                        Events.HelmDonkeyDone in l.Events
                        and Events.HelmChunkyDone in l.Events
                        and Events.HelmTinyDone in l.Events
        ...
        CrownLocation(
            ...
            logic=lambda l: l.jetpack and l.isdiddy and 
                (l.settings.helm_setting == "skip_all"
                    or (
                        Events.HelmDonkeyDone in l.Events
                        and Events.HelmChunkyDone in l.Events
