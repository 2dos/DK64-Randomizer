...
class Song:
    ...
    def __init__(self, name, type=SongType.System, group=None, memory=None):
        """Init SONG objects.
...
song_data = [
    ...
    Song("Jungle Japes (Starting Area)", type=SongType.BGM, group=SongGroup.JungleJapes, memory=0x101),
    ...
    Song("Jungle Japes (Caves/Underground)", type=SongType.BGM, memory=0x100),  # 5
    ...
    Song("Hunky Chunky", type=SongType.BGM, group=SongGroup.Self, memory=0x19A),
    ...
    Song("Angry Aztec (Dogadon)", type=SongType.BGM, memory=0x100),  # 25
    Song("Angry Aztec (5DT)", type=SongType.BGM, memory=0x100),
    Song("Frantic Factory (Car Race)", type=SongType.BGM, memory=0x188),
    Song("Frantic Factory", type=SongType.BGM, group=SongGroup.FranticFactory, memory=0x100),
    Song("Snide's HQ", type=SongType.BGM, memory=0x100),
    Song("Jungle Japes (Tunnels)", type=SongType.BGM, group=SongGroup.Self, memory=0x18A),  # 30
    ...
    Song("Pause Menu", type=SongType.BGM, group=SongGroup.Self, memory=0x1D4),
    Song("Crystal Coconut Get", type=SongType.Fanfare, memory=0x63F),  # 35
    Song("Rambi", type=SongType.BGM, group=SongGroup.JungleJapes, memory=0x198),
    Song("Angry Aztec (Tunnels)", type=SongType.BGM, group=SongGroup.AngryAztec, memory=0x192),
    ...
    Song("Jungle Japes (Baboon Blast)", type=SongType.BGM, memory=0x100),  # 50
    Song("Frantic Factory (R&D)", type=SongType.BGM, group=SongGroup.FranticFactory, memory=0x18A),
    Song("Frantic Factory (Production Room)", type=SongType.BGM, group=SongGroup.FranticFactory, memory=0x18A),
    Song("Troff 'n' Scoff", type=SongType.BGM, memory=0x100),
    Song("Boss Defeat", type=SongType.Event, memory=0x89A),
    Song("Angry Aztec (Baboon Blast)", type=SongType.BGM, memory=0x100),  # 55
    Song("Gloomy Galleon (Outside)", type=SongType.BGM, group=SongGroup.GloomyGalleon, memory=0x101),
    ...
    Song("Gloomy Galleon (Pufftoss)", type=SongType.BGM, memory=0x108),  # 60
    Song("Gloomy Galleon (Seal Race)", type=SongType.BGM, memory=0x188),
    Song("Gloomy Galleon (Tunnels)", type=SongType.BGM, group=SongGroup.Self, memory=0x18B),
    ...
    Song("Fungi Forest (Day)", type=SongType.BGM, group=SongGroup.FungiForest, memory=0x101),
    Song("Blueprint Get", type=SongType.Fanfare, memory=0x4C5),
    Song("Fungi Forest (Night)", type=SongType.BGM, group=SongGroup.FungiForest, memory=0x188),  # 70
    Song("Strong Kong", type=SongType.BGM, group=SongGroup.Self, memory=0x19A),
    Song("Rocketbarrel Boost", type=SongType.BGM, group=SongGroup.Self, memory=0x192),
    Song("Orangstand Sprint", type=SongType.BGM, group=SongGroup.Self, memory=0x190),
    Song("Fungi Forest (Minecart)", type=SongType.BGM, memory=0x100),
    Song("DK Rap", type=SongType.BGM, memory=0x900),  # 75
    ...
    Song("Gloomy Galleon (Mermaid Palace)", type=SongType.BGM, memory=0x100),  # 80
    Song("Fungi Forest (Dogadon)", type=SongType.BGM, memory=0x188),
    Song("Mad Maze Maul", type=SongType.BGM, memory=0x188),
    Song("Crystal Caves", type=SongType.BGM, group=SongGroup.CrystalCaves, memory=0x101),
    Song("Crystal Caves (Giant Kosha Tantrum)", type=SongType.BGM, group=SongGroup.CrystalCaves, memory=0x193),
    ...
    Song("Fungi Forest (Mill)", type=SongType.BGM, memory=0x100),  # 95
    ...
    Song("Boss Introduction", type=SongType.BGM, memory=0x100),  # 100
    ...
    Song("Creepy Castle", type=SongType.BGM, memory=0x101),  # 105
    ...
    Song("DK Isles", type=SongType.BGM, group=SongGroup.Isles, memory=0x101),
    Song("DK Isles (K Rool's Ship)", type=SongType.BGM, group=SongGroup.Isles, memory=0x109),  # 110
    Song("DK Isles (Banana Fairy Island)", type=SongType.BGM, group=SongGroup.Isles, memory=0x101),
    Song("DK Isles (K-Lumsy's Prison)", type=SongType.BGM, group=SongGroup.Isles, memory=0x101),
    ...
    Song("Crystal Caves (Tile Flipping)", type=SongType.BGM, memory=0x100),  # 120
    ...
    Song("Enguarde", type=SongType.BGM, group=SongGroup.GloomyGalleon, memory=0x198),
    ...
    Song("Angry Aztec (Lobby)", type=SongType.BGM, memory=0x100),  # 130
    ...
    Song("Creepy Castle (Inner Crypts)", type=SongType.BGM, memory=0x100),  # 135
    ...
    Song("Creepy Castle (Wind Tower)", type=SongType.BGM, memory=0x100),  # 140
    ...
    Song("Creepy Castle (Dungeon w/out Chains)", type=SongType.BGM, memory=0x100),  # 150
    ...
    Song("Creepy Castle (Lobby)", type=SongType.BGM, memory=0x100),  # 155
    ...
    Song("Jungle Japes", type=SongType.BGM, group=SongGroup.JungleJapes, memory=0x101),  # 160
    Song("Jungle Japes (Cranky's Area)", type=SongType.BGM, group=SongGroup.JungleJapes, memory=0x100),
    Song("K Rool Takeoff", type=SongType.System, memory=0x100),
    ...
    Song("Creepy Castle (Baboon Blast)", type=SongType.BGM, memory=0x100),  # 165
    ...
    Song("Wrinkly Kong", type=SongType.BGM, group=SongGroup.Self, memory=0x18A),
