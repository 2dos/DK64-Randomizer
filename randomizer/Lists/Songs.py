...
song_data = [
    ...
    Song("GB/Key Get", type=SongType.Pickup, memory=0x8C4),
    Song("Angry Aztec (Beetle Slide)", type=SongType.BGM, memory=0x109),
    Song("Oh Banana", type=SongType.Event, memory=0xABD),  # 20
    Song("Angry Aztec (Temple)", type=SongType.BGM, memory=0x101),
    Song("Company Coin Get", type=SongType.Pickup, memory=0x637),
    Song("Banana Coin Get", type=SongType.Pickup, memory=0x637),
    Song("Going through Vulture Ring", type=SongType.Pickup, memory=0x647),
    ...
    Song("Jungle Japes (Tunnels)", type=SongType.BGM, memory=0x18A),  # 30
    Song("Candy's Music Shop", type=SongType.BGM, memory=0x100),
    Song("Minecart Coin Get", type=SongType.Pickup, memory=0x63F),
    Song("Melon Slice Get", type=SongType.Pickup, memory=0x63F),
    Song("Pause Menu", type=SongType.BGM, memory=0x1D4),
    Song("Crystal Coconut Get", type=SongType.Pickup, memory=0x63F),  # 35
    ...
    Song("Unused High-Pitched Japes", type=SongType.Protected, memory=0x444),  # 45
    Song("Fairy Tick", type=SongType.Pickup, memory=0x8C5),
    Song("Melon Slice Drop", type=SongType.Pickup, memory=0x635),
    ...
    Song("Drop Coins (Minecart)", type=SongType.Pickup, memory=0x445),  # 65
    Song("Fairy Nearby", type=SongType.Ambient, memory=0x925),
    Song("Checkpoint", type=SongType.Pickup, memory=0x447),
    Song("Fungi Forest (Day)", type=SongType.BGM, memory=0x101),
    Song("Blueprint Get", type=SongType.Pickup, memory=0x4C5),
    Song("Fungi Forest (Night)", type=SongType.BGM, memory=0x188),  # 70
    ...
    Song("Blueprint Drop", type=SongType.Pickup, memory=0x63D),
    ...
    Song("DK Isles (K Rool's Ship)", type=SongType.BGM, memory=0x109),  # 110
    ...
    Song("Move Get", type=SongType.Pickup, memory=0x892),
    Song("Gun Get", type=SongType.Pickup, memory=0x892),  # 115
    ...
    Song("K-Lumsy Celebration", type=SongType.BGM, memory=0x110),  # 125
    Song("Creepy Castle (Crypt)", type=SongType.BGM, memory=0x100),
    Song("Headphones Get", type=SongType.Pickup, memory=0x4BC),
    Song("Pearl Get", type=SongType.Pickup, memory=0x43E),
    ...
    Song("BBlast Final Star", type=SongType.Pickup, memory=0x445),
    Song("Drop Rainbow Coin", type=SongType.Pickup, memory=0x647),
    Song("Rainbow Coin Get", type=SongType.Pickup, memory=0x647),  # 145
    Song("Normal Star", type=SongType.Pickup, memory=0x645),
    Song("Bean Get", type=SongType.Pickup, memory=0x645),
    ...
    Song("Banana Medal Get", type=SongType.Pickup, memory=0x645),
    ...
    Song("Jungle Japes", type=SongType.BGM, memory=0x101),  # 160
