...
RemovedBarrierItems = [
    ...
    MultiselectorItem("Aztec 5DTemple Switches Spawned", 0, "The switches on the Five-Door Temple in Aztec will be pre-spawned."),
    MultiselectorItem("Aztec Llama Switches", -1, "The switches on the Llama Temple in Aztec will be pre-spawned."),
    ...
    MultiselectorItem("Galleon Shipwreck Gate Opened", -1, "The gate from the start of Galleon to the shipwreck portion will be opened."),
