...
QoLItems = [
    ...
    MultiselectorItem("Fast Picture Taking", -1, "The picture taking sequence is heavily sped up, with lag being significantly reduced on BizHawk."),
    ...
    MultiselectorItem("Small Bananas always visible", -1, "Small Bananas will always be visible regardless of whether you have the kong unlocked or not."),
    ...
    MultiselectorItem("Brighten Mad Maze Maul Enemies", -1, "Enemies in Mad Maze Maul will be at full brightness, making them easier to see in dark areas."),
