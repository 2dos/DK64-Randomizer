...
QoLItems = [
    ...
    MultiselectorItem("Fix Tag Rolling", 24, "Fixes a quirk of Tag Anywhere with momentum conservation."),
]
RemovedBarrierItems = [
...
FasterCheckItems = [
    ...
    MultiselectorItem("Factory Diddy RnD", 2, "Only one enemy wave will need to be completed in the pincode room."),
