...
fairy_locations = {
    ...
    Levels.FungiForest: [
        ...
        FairyData(
            name="Giant Mushroom Interior (Low)",
        ...
        FairyData(
            name="Giant Mushroom Interior (High)",
            map=Maps.ForestGiantMushroom,
    ...
    Levels.DKIsles: [
        ...
        FairyData(
            name="Above Banana Fairy Island",
            map=Maps.Isles,
