...
fairy_locations = {
    ...
    Levels.CrystalCaves: [
        ...
        FairyData(
            name="Crystal Caves: Gorilla Gone Room",
            map=Maps.CrystalCaves,
            region=Regions.CrystalCavesMain,
        ...
        FairyData(
            name="Crystal Caves: Ice Castle Roof",
            map=Maps.CrystalCaves,
            region=Regions.CrystalCavesMain,
        ...
        FairyData(
	        name="Crystal Caves: On 5-Door Igloo",
            map=Maps.CrystalCaves,
        ...
        FairyData(
            name="Crystal Caves: Blueprint Cave",
            map=Maps.CrystalCaves,
        ...
        FairyData(
            name="Crystal Caves: 5-Door Cabin Exterior",
            map=Maps.CrystalCaves,
        ...
        FairyData(
            name="Crystal Caves: Near 1-Door Cabin",
            map=Maps.CrystalCaves,
            region=Regions.CabinArea,
        ...
        FairyData(
            name="Crystal Caves: Inside Tile Flip Room",
        ...
        FairyData(
            name="Crystal Caves: Chunky 5-Door Igloo",
        ...
        FairyData(
            name="Crystal Caves: Diddy 5-Door Igloo",
        ...
        FairyData(
            name="Crystal Caves: Donkey 5-Door Igloo",
        ...
        FairyData(
            name="Crystal Caves: 1-Door Cabin",
        ...
        FairyData(
            name="Crystal Caves: Chunky 5-Door Cabin",
    ...
    Levels.CreepyCastle: [
        ...
        FairyData(
            name="Creepy Castle: On Castle Tree",
            map=Maps.CreepyCastle,
            region=Regions.CreepyCastleMain,
        ...
        FairyData(
            name="Creepy Castle: Opposite Library Entrance",
            map=Maps.CreepyCastle,
            region=Regions.CreepyCastleMain,
        ...
        FairyData(
            name="Creepy Castle: Above Snide's",
            map=Maps.CreepyCastle,
            region=Regions.CreepyCastleMain,
        ...
        FairyData(
            name="Creepy Castle: Above entrance to Mausoleum",
        ...
        FairyData(
            name="Creepy Castle: Above Donkey Diddy Chunky Crypt Entrance",
            map=Maps.CastleLowerCave,
            region=Regions.LowerCave,
    ...
    Levels.DKIsles: [
        ...
        FairyData(
            name="DK Isles: On Banana Fairy Island",
            map=Maps.Isles,
        ...
        FairyData(
            name="DK Isles: Lower Krem Isles",
            map=Maps.Isles,
        ...
        FairyData(
            name="DK Isles: In Front of Krem Isles",
            map=Maps.Isles,
        ...
        FairyData(
            name="DK Isles: Inside Fairy Island",
        ...
        FairyData(
            name="DK Isles: Angry Aztec Lobby",
        ...
        FairyData(
            name="DK Isles: Creepy Castle Lobby",
        ...
        FairyData(
            name="DK Isles: Crystal Caves Lobby",
        ...
        FairyData(
            name="DK Isles: Training Grounds Entrance",
        ...
        FairyData(
            name="DK Isles: Training Grounds Hidden Mountain",
            map=Maps.TrainingGrounds,
            region=Regions.TrainingGrounds,
        ...
        FairyData(
            name="DK Isles: Treehouse Windows",
            map=Maps.Treehouse,
    ...
    Levels.HideoutHelm: [
        ...
        FairyData(
            ...
            spawn_y=-150,
            logic=lambda l: l.camera and (l.orangstand and l.lanky)
        ),
        FairyData(
	        name="Hideout Helm: Under Grate",
            map=Maps.HideoutHelm,
            region=Regions.HideoutHelmAfterBoM,  # Not HideoutHelmStart because you could start in BoM room, requiring you to beat Helm in order to access this
            fence=Fence(1108, 2206, 1162, 2321),
            spawn_y=-164,
            logic=lambda l: l.camera and (l.orangstand and l.lanky) and (l.chunky and l.pineapple and l.vines),
        ),
        FairyData(
