...
CustomLocations = {
    ...
    Levels.AngryAztec: [
        ...
        CustomLocation(
            ...
            max_size=64,
            logic_region=Regions.LlamaTemple,
            logic=lambda l: l.HasGun(Kongs.any) and (l.istiny and l.settings.krusha_kong == Kongs.tiny) or (not l.istiny) and l.swim and l.scope and Events.AztecLlamaSpit in l.Events,
            group=4,
    ...
    Levels.CrystalCaves: [
        ...
        CustomLocation(
            ...
            logic=lambda l: l.isLanky and (l.balloon or l.advanced_platforming),
            group=3,
        ),
    ...
    Levels.DKIsles: [
        ...
        CustomLocation(
            ...
            max_size=64,
            logic_region=Regions.TrainingGrounds,
            logic=lambda l: l.HasGun(Kongs.any) and (l.istiny and l.settings.krusha_kong == Kongs.tiny) or (not l.istiny) and l.swim,
            group=3,
            banned_types=[LocationTypes.CrownPad, LocationTypes.DirtPatch],
        ),
        CustomLocation(
