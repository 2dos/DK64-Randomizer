...
LocationListOriginal = {
    ...
    Locations.JapesMountainEnemy_Conveyor0: Location(Levels.JungleJapes, "Japes Mountain Enemy: Conveyor0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.JapesMountain, -1, DROPSANITY_FLAG_START + 0x23)]),
    Locations.JapesMountainEnemy_Conveyor1: Location(Levels.JungleJapes, "Japes Mountain Enemy: Conveyor1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.JapesMountain, -1, DROPSANITY_FLAG_START + 0x24)]),
    ...
    Locations.AztecMainEnemy_Outside5DT: Location(Levels.AngryAztec, "Angry Aztec Enemy: Outside5DT", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3e)]),
    Locations.AztecMainEnemy_NearSnoopTunnel: Location(Levels.AngryAztec, "Angry Aztec Enemy: Near Snoop Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3f)]),
    # Locations.AztecLobbyEnemy_Pad0: Location(Levels.DKIsles, "Angry Aztec Lobby Enemy: Pad0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztecLobby, -1, DROPSANITY_FLAG_START + 0x40)]),
    # Locations.AztecLobbyEnemy_Pad1: Location(Levels.DKIsles, "Angry Aztec Lobby Enemy: Pad1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztecLobby, -1, DROPSANITY_FLAG_START + 0x41)]),
    Locations.AztecDK5DTEnemy_StartTrap0: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: Start Trap (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x42)]),
    Locations.AztecDK5DTEnemy_StartTrap1: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: Start Trap (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x43)]),
    Locations.AztecDK5DTEnemy_StartTrap2: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: Start Trap (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x44)]),
    Locations.AztecDK5DTEnemy_EndTrap0: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: End Trap (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x45)]),
    Locations.AztecDK5DTEnemy_EndTrap1: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: End Trap (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x46)]),
    Locations.AztecDK5DTEnemy_EndTrap2: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: End Trap (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x47)]),
    Locations.AztecDK5DTEnemy_EndPath0: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: End Path (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x48)]),
    Locations.AztecDK5DTEnemy_EndPath1: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: End Path (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x49)]),
    Locations.AztecDK5DTEnemy_StartPath: Location(Levels.AngryAztec, "Aztec Donkey5DTemple Enemy: Start Path", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDonkey5DTemple, -1, DROPSANITY_FLAG_START + 0x4a)]),
    Locations.AztecDiddy5DTEnemy_EndTrap0: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: End Trap (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x4b)]),
    Locations.AztecDiddy5DTEnemy_EndTrap1: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: End Trap (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x4c)]),
    Locations.AztecDiddy5DTEnemy_EndTrap2: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: End Trap (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x4d)]),
    Locations.AztecDiddy5DTEnemy_StartLeft0: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: Start Left (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x4e)]),
    Locations.AztecDiddy5DTEnemy_StartLeft1: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: Start Left (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x4f)]),
    Locations.AztecDiddy5DTEnemy_Reward: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: Reward", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x50)]),
    Locations.AztecDiddy5DTEnemy_SecondSwitch: Location(Levels.AngryAztec, "Aztec Diddy5DTemple Enemy: Second Switch", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, DROPSANITY_FLAG_START + 0x51)]),
    Locations.AztecLanky5DTEnemy_JoiningPaths: Location(Levels.AngryAztec, "Aztec Lanky5DTemple Enemy: Joining Paths", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLanky5DTemple, -1, DROPSANITY_FLAG_START + 0x52)]),
    Locations.AztecLanky5DTEnemy_EndTrap: Location(Levels.AngryAztec, "Aztec Lanky5DTemple Enemy: End Trap", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLanky5DTemple, -1, DROPSANITY_FLAG_START + 0x53)]),
    Locations.AztecLanky5DTEnemy_Reward: Location(Levels.AngryAztec, "Aztec Lanky5DTemple Enemy: Reward", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLanky5DTemple, -1, DROPSANITY_FLAG_START + 0x54)]),
    Locations.AztecTiny5DTEnemy_StartRightFront: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Start Right Front", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x55)]),
    Locations.AztecTiny5DTEnemy_StartLeftBack: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Start Left Back", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x56)]),
    Locations.AztecTiny5DTEnemy_StartRightBack: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Start Right Back", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x57)]),
    Locations.AztecTiny5DTEnemy_StartLeftFront: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Start Left Front", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x58)]),
    Locations.AztecTiny5DTEnemy_Reward0: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Reward (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x59)]),
    Locations.AztecTiny5DTEnemy_Reward1: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Reward (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x5a)]),
    Locations.AztecTiny5DTEnemy_DeadEnd0: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Dead End (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x5b)]),
    Locations.AztecTiny5DTEnemy_DeadEnd1: Location(Levels.AngryAztec, "Aztec Tiny5DTemple Enemy: Dead End (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTiny5DTemple, -1, DROPSANITY_FLAG_START + 0x5c)]),
    Locations.AztecChunky5DTEnemy_StartRight: Location(Levels.AngryAztec, "Aztec Chunky5DTemple Enemy: Start Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, DROPSANITY_FLAG_START + 0x5d)]),
    Locations.AztecChunky5DTEnemy_StartLeft: Location(Levels.AngryAztec, "Aztec Chunky5DTemple Enemy: Start Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, DROPSANITY_FLAG_START + 0x5e)]),
    Locations.AztecChunky5DTEnemy_SecondRight: Location(Levels.AngryAztec, "Aztec Chunky5DTemple Enemy: Second Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, DROPSANITY_FLAG_START + 0x5f)]),
    Locations.AztecChunky5DTEnemy_SecondLeft: Location(Levels.AngryAztec, "Aztec Chunky5DTemple Enemy: Second Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, DROPSANITY_FLAG_START + 0x60)]),
    Locations.AztecChunky5DTEnemy_Reward: Location(Levels.AngryAztec, "Aztec Chunky5DTemple Enemy: Reward", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, DROPSANITY_FLAG_START + 0x61)]),
    Locations.AztecLlamaEnemy_KongFreeInstrument: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Kong Free Instrument", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x62)]),
    Locations.AztecLlamaEnemy_DinoInstrument: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Dino Instrument", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x63)]),
    # Locations.AztecLlamaEnemy_Matching0: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Matching0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x64)]),
    # Locations.AztecLlamaEnemy_Matching1: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Matching1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x65)]),
    Locations.AztecLlamaEnemy_Right: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x66)]),
    Locations.AztecLlamaEnemy_Left: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x67)]),
    Locations.AztecLlamaEnemy_MelonCrate: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Melon Crate", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x68)]),
    Locations.AztecLlamaEnemy_SlamSwitch: Location(Levels.AngryAztec, "Aztec Llama Temple Enemy: Slam Switch", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, DROPSANITY_FLAG_START + 0x69)]),
    # Locations.AztecTempleEnemy_Rotating00: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x6a)]),
    # Locations.AztecTempleEnemy_Rotating01: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x6b)]),
    # Locations.AztecTempleEnemy_Rotating02: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x6c)]),
    # Locations.AztecTempleEnemy_Rotating03: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x6d)]),
    # Locations.AztecTempleEnemy_Rotating04: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating04", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x6e)]),
    # Locations.AztecTempleEnemy_Rotating05: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating05", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x6f)]),
    # Locations.AztecTempleEnemy_Rotating06: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating06", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x70)]),
    # Locations.AztecTempleEnemy_Rotating07: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating07", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x71)]),
    # Locations.AztecTempleEnemy_Rotating08: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating08", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x72)]),
    # Locations.AztecTempleEnemy_Rotating09: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating09", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x73)]),
    # Locations.AztecTempleEnemy_Rotating10: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating10", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x74)]),
    # Locations.AztecTempleEnemy_Rotating11: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating11", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x75)]),
    # Locations.AztecTempleEnemy_Rotating12: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating12", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x76)]),
    # Locations.AztecTempleEnemy_Rotating13: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating13", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x77)]),
    # Locations.AztecTempleEnemy_Rotating14: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating14", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x78)]),
    # Locations.AztecTempleEnemy_Rotating15: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Rotating15", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x79)]),
    # Locations.AztecTempleEnemy_MiniRoom00: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Mini Room00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x7a)]),
    # Locations.AztecTempleEnemy_MiniRoom01: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Mini Room01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x7b)]),
    # Locations.AztecTempleEnemy_MiniRoom02: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Mini Room02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x7c)]),
    # Locations.AztecTempleEnemy_MiniRoom03: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Mini Room03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x7d)]),
    Locations.AztecTempleEnemy_GuardRotating0: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Guard Rotating (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x7e)]),
    Locations.AztecTempleEnemy_GuardRotating1: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Guard Rotating (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x7f)]),
    Locations.AztecTempleEnemy_MainRoom0: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Main Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x80)]),
    Locations.AztecTempleEnemy_MainRoom1: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Main Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x81)]),
    Locations.AztecTempleEnemy_MainRoom2: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Main Room (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x82)]),
    Locations.AztecTempleEnemy_KongRoom0: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Kong Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x83)]),
    Locations.AztecTempleEnemy_KongRoom1: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Kong Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x84)]),
    Locations.AztecTempleEnemy_KongRoom2: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Kong Room (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x85)]),
    Locations.AztecTempleEnemy_KongRoom3: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Kong Room (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x86)]),
    Locations.AztecTempleEnemy_KongRoom4: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Kong Room (4)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x87)]),
    # Locations.AztecTempleEnemy_Underwater: Location(Levels.AngryAztec, "Aztec Tiny Temple Enemy: Underwater", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, DROPSANITY_FLAG_START + 0x88)]),

    Locations.FactoryMainEnemy_CandyCranky0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Candy Cranky (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x89)]),
    Locations.FactoryMainEnemy_CandyCranky1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Candy Cranky (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8a)]),
    Locations.FactoryMainEnemy_LobbyLeft: Location(Levels.FranticFactory, "Frantic Factory Enemy: Lobby Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8b)]),
    Locations.FactoryMainEnemy_LobbyRight: Location(Levels.FranticFactory, "Frantic Factory Enemy: Lobby Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8c)]),
    Locations.FactoryMainEnemy_StorageRoom: Location(Levels.FranticFactory, "Frantic Factory Enemy: Storage Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8d)]),
    Locations.FactoryMainEnemy_BlockTower0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Block Tower (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8e)]),
    Locations.FactoryMainEnemy_BlockTower1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Block Tower (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8f)]),
    Locations.FactoryMainEnemy_BlockTower2: Location(Levels.FranticFactory, "Frantic Factory Enemy: Block Tower (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x90)]),
    Locations.FactoryMainEnemy_TunnelToHatch: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Hatch", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x91)]),
    Locations.FactoryMainEnemy_TunnelToProd0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Prod (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x92)]),
    Locations.FactoryMainEnemy_TunnelToProd1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Prod (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x93)]),
    Locations.FactoryMainEnemy_TunnelToBlockTower: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Block Tower", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x94)]),
    Locations.FactoryMainEnemy_TunnelToRace0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Race (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x95)]),
    Locations.FactoryMainEnemy_TunnelToRace1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Race (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x96)]),
    Locations.FactoryMainEnemy_LowWarp4: Location(Levels.FranticFactory, "Frantic Factory Enemy: Low Warp 4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x97)]),
    Locations.FactoryMainEnemy_DiddySwitch: Location(Levels.FranticFactory, "Frantic Factory Enemy: Diddy Switch", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x98)]),
    Locations.FactoryMainEnemy_ToBlockTowerTunnel: Location(Levels.FranticFactory, "Frantic Factory Enemy: To Block Tower Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x99)]),
    Locations.FactoryMainEnemy_DarkRoom0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Dark Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9a)]),
    Locations.FactoryMainEnemy_DarkRoom1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Dark Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9b)]),
    # Locations.FactoryMainEnemy_BHDM0: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9c)]),
    # Locations.FactoryMainEnemy_BHDM1: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9d)]),
    # Locations.FactoryMainEnemy_BHDM2: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9e)]),
    # Locations.FactoryMainEnemy_BHDM3: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9f)]),
    # Locations.FactoryMainEnemy_BHDM4: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa0)]),
    # Locations.FactoryMainEnemy_BHDM5: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa1)]),
    # Locations.FactoryMainEnemy_BHDM6: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM6", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa2)]),
    # Locations.FactoryMainEnemy_BHDM7: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM7", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa3)]),
    # Locations.FactoryMainEnemy_BHDM8: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM8", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa4)]),
    # Locations.FactoryMainEnemy_BHDM9: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM9", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa5)]),
    # Locations.FactoryMainEnemy_1342Gauntlet0: Location(Levels.FranticFactory, "Frantic Factory Enemy: 1342Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa6)]),
    # Locations.FactoryMainEnemy_1342Gauntlet1: Location(Levels.FranticFactory, "Frantic Factory Enemy: 1342Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa7)]),
    # Locations.FactoryMainEnemy_1342Gauntlet2: Location(Levels.FranticFactory, "Frantic Factory Enemy: 1342Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa8)]),
    # Locations.FactoryMainEnemy_3124Gauntlet0: Location(Levels.FranticFactory, "Frantic Factory Enemy: 3124Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa9)]),
    # Locations.FactoryMainEnemy_3124Gauntlet1: Location(Levels.FranticFactory, "Frantic Factory Enemy: 3124Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xaa)]),
    # Locations.FactoryMainEnemy_3124Gauntlet2: Location(Levels.FranticFactory, "Frantic Factory Enemy: 3124Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xab)]),
    # Locations.FactoryMainEnemy_4231Gauntlet0: Location(Levels.FranticFactory, "Frantic Factory Enemy: 4231Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xac)]),
    # Locations.FactoryMainEnemy_4231Gauntlet1: Location(Levels.FranticFactory, "Frantic Factory Enemy: 4231Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xad)]),
    Locations.FactoryLobbyEnemy_Enemy0: Location(Levels.DKIsles, "Frantic Factory Lobby Enemy: Enemy (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactoryLobby, -1, DROPSANITY_FLAG_START + 0xae)]),
    Locations.GalleonMainEnemy_ChestRoom0: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Chest Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xaf)]),
    Locations.GalleonMainEnemy_ChestRoom1: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Chest Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb0)]),
    Locations.GalleonMainEnemy_NearVineCannon: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Near Vine Cannon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb1)]),
    Locations.GalleonMainEnemy_CrankyCannon: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Cranky Cannon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb2)]),
    # Locations.GalleonMainEnemy_Submarine: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Submarine", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb3)]),
    # Locations.GalleonMainEnemy_5DS0: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: 5DS0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb4)]),
    # Locations.GalleonMainEnemy_5DS1: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: 5DS1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb5)]),
    Locations.GalleonMainEnemy_PeanutTunnel: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Peanut Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb6)]),
    Locations.GalleonMainEnemy_CoconutTunnel: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Coconut Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb7)]),
    Locations.GalleonLighthouseEnemy_Enemy0: Location(Levels.GloomyGalleon, "Galleon Lighthouse Enemy: Enemy (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GalleonLighthouse, -1, DROPSANITY_FLAG_START + 0xb8)]),
    Locations.GalleonLighthouseEnemy_Enemy1: Location(Levels.GloomyGalleon, "Galleon Lighthouse Enemy: Enemy (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GalleonLighthouse, -1, DROPSANITY_FLAG_START + 0xb9)]),
    # Locations.Galleon5DSDLCEnemy_Diddy: Location(Levels.GloomyGalleon, "Galleon5DShip Diddy Lanky Chunky Enemy: Diddy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDiddyLankyChunky, -1, DROPSANITY_FLAG_START + 0xba)]),
    # Locations.Galleon5DSDLCEnemy_Chunky: Location(Levels.GloomyGalleon, "Galleon5DShip Diddy Lanky Chunky Enemy: Chunky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDiddyLankyChunky, -1, DROPSANITY_FLAG_START + 0xbb)]),
    # Locations.Galleon5DSDLCEnemy_Lanky: Location(Levels.GloomyGalleon, "Galleon5DShip Diddy Lanky Chunky Enemy: Lanky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDiddyLankyChunky, -1, DROPSANITY_FLAG_START + 0xbc)]),
    # Locations.Galleon5DSDTEnemy_DK0: Location(Levels.GloomyGalleon, "Galleon5DShip DKTiny Enemy: DK0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDKTiny, -1, DROPSANITY_FLAG_START + 0xbd)]),
    # Locations.Galleon5DSDTEnemy_DK1: Location(Levels.GloomyGalleon, "Galleon5DShip DKTiny Enemy: DK1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDKTiny, -1, DROPSANITY_FLAG_START + 0xbe)]),
    # Locations.Galleon5DSDTEnemy_DK2: Location(Levels.GloomyGalleon, "Galleon5DShip DKTiny Enemy: DK2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDKTiny, -1, DROPSANITY_FLAG_START + 0xbf)]),
    # Locations.Galleon5DSDTEnemy_TinyCage: Location(Levels.GloomyGalleon, "Galleon5DShip DKTiny Enemy: Tiny Cage", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDKTiny, -1, DROPSANITY_FLAG_START + 0xc0)]),
    # Locations.Galleon5DSDTEnemy_TinyBed: Location(Levels.GloomyGalleon, "Galleon5DShip DKTiny Enemy: Tiny Bed", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon5DShipDKTiny, -1, DROPSANITY_FLAG_START + 0xc1)]),
    # Locations.Galleon2DSEnemy_Tiny0: Location(Levels.GloomyGalleon, "Galleon2DShip Enemy: Tiny0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon2DShip, -1, DROPSANITY_FLAG_START + 0xc2)]),
    # Locations.Galleon2DSEnemy_Tiny1: Location(Levels.GloomyGalleon, "Galleon2DShip Enemy: Tiny1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Galleon2DShip, -1, DROPSANITY_FLAG_START + 0xc3)]),
    # Locations.GalleonSubEnemy_Enemy0: Location(Levels.GloomyGalleon, "Galleon Submarine Enemy: Enemy0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GalleonSubmarine, -1, DROPSANITY_FLAG_START + 0xc4)]),
    # Locations.GalleonSubEnemy_Enemy1: Location(Levels.GloomyGalleon, "Galleon Submarine Enemy: Enemy1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GalleonSubmarine, -1, DROPSANITY_FLAG_START + 0xc5)]),
    # Locations.GalleonSubEnemy_Enemy2: Location(Levels.GloomyGalleon, "Galleon Submarine Enemy: Enemy2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GalleonSubmarine, -1, DROPSANITY_FLAG_START + 0xc6)]),
    # Locations.GalleonSubEnemy_Enemy3: Location(Levels.GloomyGalleon, "Galleon Submarine Enemy: Enemy3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GalleonSubmarine, -1, DROPSANITY_FLAG_START + 0xc7)]),
    Locations.ForestMainEnemy_HollowTree0: Location(Levels.FungiForest, "Fungi Forest Enemy: Hollow Tree (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xc8)]),
    Locations.ForestMainEnemy_HollowTree1: Location(Levels.FungiForest, "Fungi Forest Enemy: Hollow Tree (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xc9)]),
    Locations.ForestMainEnemy_HollowTreeEntrance: Location(Levels.FungiForest, "Fungi Forest Enemy: Hollow Tree Entrance", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xca)]),
    Locations.ForestMainEnemy_TreeMelonCrate0: Location(Levels.FungiForest, "Fungi Forest Enemy: Tree Melon Crate (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcb)]),
    Locations.ForestMainEnemy_TreeMelonCrate1: Location(Levels.FungiForest, "Fungi Forest Enemy: Tree Melon Crate (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcc)]),
    Locations.ForestMainEnemy_TreeMelonCrate2: Location(Levels.FungiForest, "Fungi Forest Enemy: Tree Melon Crate (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcd)]),
    # Locations.ForestMainEnemy_AppleGauntlet0: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xce)]),
    # Locations.ForestMainEnemy_AppleGauntlet1: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcf)]),
    # Locations.ForestMainEnemy_AppleGauntlet2: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd0)]),
    # Locations.ForestMainEnemy_AppleGauntlet3: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd1)]),
    Locations.ForestMainEnemy_NearBeanstalk0: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Beanstalk (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd2)]),
    Locations.ForestMainEnemy_NearBeanstalk1: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Beanstalk (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd3)]),
    Locations.ForestMainEnemy_GreenTunnel: Location(Levels.FungiForest, "Fungi Forest Enemy: Green Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd4)]),
    Locations.ForestMainEnemy_NearLowWarp5: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Low Warp 5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd5)]),
    Locations.ForestMainEnemy_NearPinkTunnelBounceTag: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Pink Tunnel Bounce Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd6)]),
    Locations.ForestMainEnemy_NearGMRocketbarrel: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Giant Mushroom Rocketbarrel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd7)]),
    Locations.ForestMainEnemy_BetweenRBAndYellowTunnel: Location(Levels.FungiForest, "Fungi Forest Enemy: Between RBAnd Yellow Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd8)]),
    Locations.ForestMainEnemy_NearCranky: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Cranky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd9)]),
    Locations.ForestMainEnemy_NearPinkTunnelGM: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Pink Tunnel Giant Mushroom", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xda)]),
    Locations.ForestMainEnemy_GMRearTag: Location(Levels.FungiForest, "Fungi Forest Enemy: Giant Mushroom Rear Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdb)]),
    Locations.ForestMainEnemy_NearFacePuzzle: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Face Puzzle", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdc)]),
    Locations.ForestMainEnemy_NearCrown: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Crown", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdd)]),
    Locations.ForestMainEnemy_NearHighWarp5: Location(Levels.FungiForest, "Fungi Forest Enemy: Near High Warp5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xde)]),
    Locations.ForestMainEnemy_TopOfMushroom: Location(Levels.FungiForest, "Fungi Forest Enemy: Top Of Mushroom", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdf)]),
    Locations.ForestMainEnemy_NearAppleDropoff: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Apple Dropoff", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe0)]),
    Locations.ForestMainEnemy_NearDKPortal: Location(Levels.FungiForest, "Fungi Forest Enemy: Near DKPortal", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe1)]),
    Locations.ForestMainEnemy_NearWellTag: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Well Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe2)]),
    Locations.ForestMainEnemy_YellowTunnel0: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe3)]),
    Locations.ForestMainEnemy_YellowTunnel1: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe4)]),
    Locations.ForestMainEnemy_YellowTunnel2: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe5)]),
    Locations.ForestMainEnemy_YellowTunnel3: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe6)]),
    Locations.ForestMainEnemy_NearSnide: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Snide", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe7)]),
    Locations.ForestMainEnemy_NearIsoCoin: Location(Levels.FungiForest, "Fungi Forest Enemy: Near the hidden Rainbow Coin", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe8)]),
    Locations.ForestMainEnemy_NearBBlast: Location(Levels.FungiForest, "Fungi Forest Enemy: Near BBlast", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe9)]),
    Locations.ForestMainEnemy_NearDarkAttic: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Dark Attic", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xea)]),
    Locations.ForestMainEnemy_NearWellExit: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Well Exit", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xeb)]),
    Locations.ForestMainEnemy_NearBlueTunnel: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Blue Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xec)]),
    Locations.ForestMainEnemy_Thornvine0: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xed)]),
    Locations.ForestMainEnemy_Thornvine1: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xee)]),
    Locations.ForestMainEnemy_Thornvine2: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xef)]),
    Locations.ForestMainEnemy_ThornvineEntrance: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine Entrance", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xf0)]),
    Locations.ForestAnthillEnemy_Gauntlet0: Location(Levels.FungiForest, "Forest Anthill Enemy: Gauntlet (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestAnthill, -1, DROPSANITY_FLAG_START + 0xf1)]),
    Locations.ForestAnthillEnemy_Gauntlet1: Location(Levels.FungiForest, "Forest Anthill Enemy: Gauntlet (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestAnthill, -1, DROPSANITY_FLAG_START + 0xf2)]),
    Locations.ForestAnthillEnemy_Gauntlet2: Location(Levels.FungiForest, "Forest Anthill Enemy: Gauntlet (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestAnthill, -1, DROPSANITY_FLAG_START + 0xf3)]),
    Locations.ForestAnthillEnemy_Gauntlet3: Location(Levels.FungiForest, "Forest Anthill Enemy: Gauntlet (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestAnthill, -1, DROPSANITY_FLAG_START + 0xf4)]),
    Locations.ForestWinchEnemy_Enemy: Location(Levels.FungiForest, "Forest Winch Room Enemy: Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestWinchRoom, -1, DROPSANITY_FLAG_START + 0xf5)]),
    Locations.ForestThornBarnEnemy_Enemy: Location(Levels.FungiForest, "Forest Thornvine Barn Enemy: Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestThornvineBarn, -1, DROPSANITY_FLAG_START + 0xf6)]),
    Locations.ForestMillFrontEnemy_Enemy: Location(Levels.FungiForest, "Forest Mill Front Enemy: Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestMillFront, -1, DROPSANITY_FLAG_START + 0xf7)]),
    Locations.ForestMillRearEnemy_Enemy: Location(Levels.FungiForest, "Forest Mill Back Enemy: Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestMillBack, -1, DROPSANITY_FLAG_START + 0xf8)]),
    Locations.ForestGMEnemy_AboveNightDoor: Location(Levels.FungiForest, "Forest Giant Mushroom Enemy: Above Night Door", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestGiantMushroom, -1, DROPSANITY_FLAG_START + 0xf9)]),
    Locations.ForestGMEnemy_Path0: Location(Levels.FungiForest, "Forest Giant Mushroom Enemy: Path (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestGiantMushroom, -1, DROPSANITY_FLAG_START + 0xfa)]),
    Locations.ForestGMEnemy_Path1: Location(Levels.FungiForest, "Forest Giant Mushroom Enemy: Path (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestGiantMushroom, -1, DROPSANITY_FLAG_START + 0xfb)]),
    # Locations.ForestLankyAtticEnemy_Gauntlet0: Location(Levels.FungiForest, "Forest Mill Attic Enemy: Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestMillAttic, -1, DROPSANITY_FLAG_START + 0xfc)]),
    # Locations.ForestLankyAtticEnemy_Gauntlet1: Location(Levels.FungiForest, "Forest Mill Attic Enemy: Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestMillAttic, -1, DROPSANITY_FLAG_START + 0xfd)]),
    # Locations.ForestLankyAtticEnemy_Gauntlet2: Location(Levels.FungiForest, "Forest Mill Attic Enemy: Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestMillAttic, -1, DROPSANITY_FLAG_START + 0xfe)]),
    Locations.ForestLeapEnemy_Enemy0: Location(Levels.FungiForest, "Forest Lanky Zingers Room Enemy: Enemy (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestLankyZingersRoom, -1, DROPSANITY_FLAG_START + 0xff)]),
    Locations.ForestLeapEnemy_Enemy1: Location(Levels.FungiForest, "Forest Lanky Zingers Room Enemy: Enemy (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestLankyZingersRoom, -1, DROPSANITY_FLAG_START + 0x100)]),
    Locations.ForestFacePuzzleEnemy_Enemy: Location(Levels.FungiForest, "Forest Chunky Face Room Enemy: Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestChunkyFaceRoom, -1, DROPSANITY_FLAG_START + 0x101)]),
    # Locations.ForestSpiderEnemy_Gauntlet0: Location(Levels.FungiForest, "Forest Spider Enemy: Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestSpider, -1, DROPSANITY_FLAG_START + 0x102)]),
    # Locations.ForestSpiderEnemy_Gauntlet1: Location(Levels.FungiForest, "Forest Spider Enemy: Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestSpider, -1, DROPSANITY_FLAG_START + 0x103)]),
    # Locations.ForestSpiderEnemy_Gauntlet2: Location(Levels.FungiForest, "Forest Spider Enemy: Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.ForestSpider, -1, DROPSANITY_FLAG_START + 0x104)]),
    Locations.CavesMainEnemy_Start: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Start", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x105)]),
    Locations.CavesMainEnemy_NearIceCastle: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Ice Castle", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x106)]),
    Locations.CavesMainEnemy_Outside5DC: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Outside 5DC", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x107)]),
    Locations.CavesMainEnemy_1DCWaterfall: Location(Levels.CrystalCaves, "Crystal Caves Enemy: 1DC Waterfall", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x108)]),
    Locations.CavesMainEnemy_NearFunky: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Funky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x109)]),
    Locations.CavesMainEnemy_NearSnide: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Snide", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10a)]),
    Locations.CavesMainEnemy_NearBonusRoom: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Bonus Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10b)]),
    Locations.CavesMainEnemy_1DCHeadphones: Location(Levels.CrystalCaves, "Crystal Caves Enemy: 1DC Headphones", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10c)]),
    # Locations.CavesMainEnemy_GiantKosha: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Giant Kosha", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10d)]),
    Locations.Caves5DIDKEnemy_Right: Location(Levels.CrystalCaves, "Caves Donkey Igloo Enemy: Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyIgloo, -1, DROPSANITY_FLAG_START + 0x10e)]),
    Locations.Caves5DIDKEnemy_Left: Location(Levels.CrystalCaves, "Caves Donkey Igloo Enemy: Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyIgloo, -1, DROPSANITY_FLAG_START + 0x10f)]),
    # Locations.Caves5DILankyEnemy_First0: Location(Levels.CrystalCaves, "Caves Lanky Igloo Enemy: First (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyIgloo, -1, DROPSANITY_FLAG_START + 0x110)]),
    # Locations.Caves5DILankyEnemy_First1: Location(Levels.CrystalCaves, "Caves Lanky Igloo Enemy: First (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyIgloo, -1, DROPSANITY_FLAG_START + 0x111)]),
    # Locations.Caves5DILankyEnemy_Second0: Location(Levels.CrystalCaves, "Caves Lanky Igloo Enemy: Second (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyIgloo, -1, DROPSANITY_FLAG_START + 0x112)]),
    # Locations.Caves5DILankyEnemy_Second1: Location(Levels.CrystalCaves, "Caves Lanky Igloo Enemy: Second (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyIgloo, -1, DROPSANITY_FLAG_START + 0x113)]),
    # Locations.Caves5DILankyEnemy_Second2: Location(Levels.CrystalCaves, "Caves Lanky Igloo Enemy: Second (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyIgloo, -1, DROPSANITY_FLAG_START + 0x114)]),
    Locations.Caves5DITinyEnemy_BigEnemy: Location(Levels.CrystalCaves, "Caves Tiny Igloo Enemy: Big Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesTinyIgloo, -1, DROPSANITY_FLAG_START + 0x115)]),
    # Locations.Caves5DIChunkyEnemy_Gauntlet00: Location(Levels.CrystalCaves, "Caves Chunky Igloo Enemy: Gauntlet00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesChunkyIgloo, -1, DROPSANITY_FLAG_START + 0x116)]),
    # Locations.Caves5DIChunkyEnemy_Gauntlet01: Location(Levels.CrystalCaves, "Caves Chunky Igloo Enemy: Gauntlet01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesChunkyIgloo, -1, DROPSANITY_FLAG_START + 0x117)]),
    # Locations.Caves5DIChunkyEnemy_Gauntlet02: Location(Levels.CrystalCaves, "Caves Chunky Igloo Enemy: Gauntlet02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesChunkyIgloo, -1, DROPSANITY_FLAG_START + 0x118)]),
    # Locations.Caves5DIChunkyEnemy_Gauntlet03: Location(Levels.CrystalCaves, "Caves Chunky Igloo Enemy: Gauntlet03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesChunkyIgloo, -1, DROPSANITY_FLAG_START + 0x119)]),
    # Locations.Caves5DIChunkyEnemy_Gauntlet04: Location(Levels.CrystalCaves, "Caves Chunky Igloo Enemy: Gauntlet04", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesChunkyIgloo, -1, DROPSANITY_FLAG_START + 0x11a)]),
    Locations.Caves1DCEnemy_Near: Location(Levels.CrystalCaves, "Caves Lanky Cabin Enemy: Near", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyCabin, -1, DROPSANITY_FLAG_START + 0x11b)]),
    # Locations.Caves1DCEnemy_Far: Location(Levels.CrystalCaves, "Caves Lanky Cabin Enemy: Far", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesLankyCabin, -1, DROPSANITY_FLAG_START + 0x11c)]),
    # Locations.Caves5DCDKEnemy_Gauntlet0: Location(Levels.CrystalCaves, "Caves Donkey Cabin Enemy: Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyCabin, -1, DROPSANITY_FLAG_START + 0x11d)]),
    # Locations.Caves5DCDKEnemy_Gauntlet1: Location(Levels.CrystalCaves, "Caves Donkey Cabin Enemy: Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyCabin, -1, DROPSANITY_FLAG_START + 0x11e)]),
    # Locations.Caves5DCDKEnemy_Gauntlet2: Location(Levels.CrystalCaves, "Caves Donkey Cabin Enemy: Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyCabin, -1, DROPSANITY_FLAG_START + 0x11f)]),
    # Locations.Caves5DCDKEnemy_Gauntlet3: Location(Levels.CrystalCaves, "Caves Donkey Cabin Enemy: Gauntlet3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyCabin, -1, DROPSANITY_FLAG_START + 0x120)]),
    # Locations.Caves5DCDKEnemy_Gauntlet4: Location(Levels.CrystalCaves, "Caves Donkey Cabin Enemy: Gauntlet4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyCabin, -1, DROPSANITY_FLAG_START + 0x121)]),
    # Locations.Caves5DCDKEnemy_Gauntlet5: Location(Levels.CrystalCaves, "Caves Donkey Cabin Enemy: Gauntlet5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDonkeyCabin, -1, DROPSANITY_FLAG_START + 0x122)]),
    # Locations.Caves5DCDiddyLowEnemy_CloseRight: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Close Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x123)]),
    # Locations.Caves5DCDiddyLowEnemy_FarRight: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Far Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x124)]),
    # Locations.Caves5DCDiddyLowEnemy_CloseLeft: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Close Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x125)]),
    # Locations.Caves5DCDiddyLowEnemy_FarLeft: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Far Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x126)]),
    # Locations.Caves5DCDiddyLowEnemy_Center0: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Center0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x127)]),
    # Locations.Caves5DCDiddyLowEnemy_Center1: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Center1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x128)]),
    # Locations.Caves5DCDiddyLowEnemy_Center2: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Center2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x129)]),
    # Locations.Caves5DCDiddyLowEnemy_Center3: Location(Levels.CrystalCaves, "Caves Diddy Lower Cabin Enemy: Center3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyLowerCabin, -1, DROPSANITY_FLAG_START + 0x12a)]),
    # Locations.Caves5DCDiddyUpperEnemy_Enemy0: Location(Levels.CrystalCaves, "Caves Diddy Upper Cabin Enemy: Enemy (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyUpperCabin, -1, DROPSANITY_FLAG_START + 0x12b)]),
    # Locations.Caves5DCDiddyUpperEnemy_Enemy1: Location(Levels.CrystalCaves, "Caves Diddy Upper Cabin Enemy: Enemy (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesDiddyUpperCabin, -1, DROPSANITY_FLAG_START + 0x12c)]),
    # Locations.Caves5DCTinyEnemy_Gauntlet0: Location(Levels.CrystalCaves, "Caves Tiny Cabin Enemy: Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesTinyCabin, -1, DROPSANITY_FLAG_START + 0x12d)]),
    # Locations.Caves5DCTinyEnemy_Gauntlet1: Location(Levels.CrystalCaves, "Caves Tiny Cabin Enemy: Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesTinyCabin, -1, DROPSANITY_FLAG_START + 0x12e)]),
    # Locations.Caves5DCTinyEnemy_Gauntlet2: Location(Levels.CrystalCaves, "Caves Tiny Cabin Enemy: Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesTinyCabin, -1, DROPSANITY_FLAG_START + 0x12f)]),
    # Locations.Caves5DCTinyEnemy_Gauntlet3: Location(Levels.CrystalCaves, "Caves Tiny Cabin Enemy: Gauntlet3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesTinyCabin, -1, DROPSANITY_FLAG_START + 0x130)]),
    # Locations.Caves5DCTinyEnemy_Gauntlet4: Location(Levels.CrystalCaves, "Caves Tiny Cabin Enemy: Gauntlet4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CavesTinyCabin, -1, DROPSANITY_FLAG_START + 0x131)]),
    Locations.CastleMainEnemy_NearBridge0: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Bridge (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x132)]),
    Locations.CastleMainEnemy_NearBridge1: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Bridge (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x133)]),
    Locations.CastleMainEnemy_WoodenExtrusion0: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Wooden Extrusion (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x134)]),
    Locations.CastleMainEnemy_WoodenExtrusion1: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Wooden Extrusion (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x135)]),
    Locations.CastleMainEnemy_NearShed: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Shed", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x136)]),
    Locations.CastleMainEnemy_NearLibrary: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Library", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x137)]),
    Locations.CastleMainEnemy_NearTower: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Tower", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x138)]),
    Locations.CastleMainEnemy_MuseumSteps: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Museum Steps", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x139)]),
    Locations.CastleMainEnemy_NearLowCave: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Low Cave", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13a)]),
    Locations.CastleMainEnemy_PathToLowKasplat: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Path To Low Kasplat", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13b)]),
    Locations.CastleMainEnemy_LowTnS: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Low TnS", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13c)]),
    Locations.CastleMainEnemy_PathToDungeon: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Path To Dungeon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13d)]),
    Locations.CastleMainEnemy_NearHeadphones: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Headphones", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13e)]),
    Locations.CastleLobbyEnemy_Left: Location(Levels.DKIsles, "Creepy Castle Lobby Enemy: Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastleLobby, -1, DROPSANITY_FLAG_START + 0x13f)]),
    Locations.CastleLobbyEnemy_FarRight: Location(Levels.DKIsles, "Creepy Castle Lobby Enemy: Far Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastleLobby, -1, DROPSANITY_FLAG_START + 0x140)]),
    Locations.CastleLobbyEnemy_NearRight: Location(Levels.DKIsles, "Creepy Castle Lobby Enemy: Near Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastleLobby, -1, DROPSANITY_FLAG_START + 0x141)]),
    # Locations.CastleBallroomEnemy_Board00: Location(Levels.CreepyCastle, "Castle Ballroom Enemy: Board00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBallroom, -1, DROPSANITY_FLAG_START + 0x142)]),
    # Locations.CastleBallroomEnemy_Board01: Location(Levels.CreepyCastle, "Castle Ballroom Enemy: Board01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBallroom, -1, DROPSANITY_FLAG_START + 0x143)]),
    # Locations.CastleBallroomEnemy_Board02: Location(Levels.CreepyCastle, "Castle Ballroom Enemy: Board02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBallroom, -1, DROPSANITY_FLAG_START + 0x144)]),
    # Locations.CastleBallroomEnemy_Board03: Location(Levels.CreepyCastle, "Castle Ballroom Enemy: Board03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBallroom, -1, DROPSANITY_FLAG_START + 0x145)]),
    # Locations.CastleBallroomEnemy_Board04: Location(Levels.CreepyCastle, "Castle Ballroom Enemy: Board04", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBallroom, -1, DROPSANITY_FLAG_START + 0x146)]),
    Locations.CastleBallroomEnemy_Start: Location(Levels.CreepyCastle, "Castle Ballroom Enemy: Start", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBallroom, -1, DROPSANITY_FLAG_START + 0x147)]),
    Locations.CastleDungeonEnemy_FaceRoom: Location(Levels.CreepyCastle, "Castle Dungeon Enemy: Face Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, DROPSANITY_FLAG_START + 0x148)]),
    Locations.CastleDungeonEnemy_ChairRoom: Location(Levels.CreepyCastle, "Castle Dungeon Enemy: Chair Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, DROPSANITY_FLAG_START + 0x149)]),
    Locations.CastleDungeonEnemy_OutsideLankyRoom: Location(Levels.CreepyCastle, "Castle Dungeon Enemy: Outside Lanky Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, DROPSANITY_FLAG_START + 0x14a)]),
    # Locations.CastleShedEnemy_Gauntlet00: Location(Levels.CreepyCastle, "Castle Shed Enemy: Gauntlet00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleShed, -1, DROPSANITY_FLAG_START + 0x14b)]),
    # Locations.CastleShedEnemy_Gauntlet01: Location(Levels.CreepyCastle, "Castle Shed Enemy: Gauntlet01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleShed, -1, DROPSANITY_FLAG_START + 0x14c)]),
    # Locations.CastleShedEnemy_Gauntlet02: Location(Levels.CreepyCastle, "Castle Shed Enemy: Gauntlet02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleShed, -1, DROPSANITY_FLAG_START + 0x14d)]),
    # Locations.CastleShedEnemy_Gauntlet03: Location(Levels.CreepyCastle, "Castle Shed Enemy: Gauntlet03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleShed, -1, DROPSANITY_FLAG_START + 0x14e)]),
    # Locations.CastleShedEnemy_Gauntlet04: Location(Levels.CreepyCastle, "Castle Shed Enemy: Gauntlet04", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleShed, -1, DROPSANITY_FLAG_START + 0x14f)]),
    Locations.CastleLowCaveEnemy_NearCrypt: Location(Levels.CreepyCastle, "Castle Lower Cave Enemy: Near Crypt", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, DROPSANITY_FLAG_START + 0x150)]),
    Locations.CastleLowCaveEnemy_StairRight: Location(Levels.CreepyCastle, "Castle Lower Cave Enemy: Stair Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, DROPSANITY_FLAG_START + 0x151)]),
    Locations.CastleLowCaveEnemy_StairLeft: Location(Levels.CreepyCastle, "Castle Lower Cave Enemy: Stair Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, DROPSANITY_FLAG_START + 0x152)]),
    Locations.CastleLowCaveEnemy_NearMausoleum: Location(Levels.CreepyCastle, "Castle Lower Cave Enemy: Near Mausoleum", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, DROPSANITY_FLAG_START + 0x153)]),
    Locations.CastleLowCaveEnemy_NearFunky: Location(Levels.CreepyCastle, "Castle Lower Cave Enemy: Near Funky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, DROPSANITY_FLAG_START + 0x154)]),
    Locations.CastleLowCaveEnemy_NearTag: Location(Levels.CreepyCastle, "Castle Lower Cave Enemy: Near Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, DROPSANITY_FLAG_START + 0x155)]),
    Locations.CastleCryptEnemy_DiddyCoffin0: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Diddy Coffin (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x156)]),
    Locations.CastleCryptEnemy_DiddyCoffin1: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Diddy Coffin (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x157)]),
    Locations.CastleCryptEnemy_DiddyCoffin2: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Diddy Coffin (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x158)]),
    Locations.CastleCryptEnemy_DiddyCoffin3: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Diddy Coffin (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x159)]),
    Locations.CastleCryptEnemy_ChunkyCoffin0: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Chunky Coffin (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x15a)]),
    Locations.CastleCryptEnemy_ChunkyCoffin1: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Chunky Coffin (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x15b)]),
    Locations.CastleCryptEnemy_ChunkyCoffin2: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Chunky Coffin (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x15c)]),
    Locations.CastleCryptEnemy_ChunkyCoffin3: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Chunky Coffin (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x15d)]),
    Locations.CastleCryptEnemy_MinecartEntry: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Minecart Entry", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x15e)]),
    Locations.CastleCryptEnemy_Fork: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Fork", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x15f)]),
    Locations.CastleCryptEnemy_NearDiddy: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Near Diddy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x160)]),
    Locations.CastleCryptEnemy_NearChunky: Location(Levels.CreepyCastle, "Castle Crypt Enemy: Near Chunky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, DROPSANITY_FLAG_START + 0x161)]),
    Locations.CastleMausoleumEnemy_TinyPath: Location(Levels.CreepyCastle, "Castle Mausoleum Enemy: Tiny Path", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMausoleum, -1, DROPSANITY_FLAG_START + 0x162)]),
    Locations.CastleMausoleumEnemy_LankyPath0: Location(Levels.CreepyCastle, "Castle Mausoleum Enemy: Lanky Path (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMausoleum, -1, DROPSANITY_FLAG_START + 0x163)]),
    Locations.CastleMausoleumEnemy_LankyPath1: Location(Levels.CreepyCastle, "Castle Mausoleum Enemy: Lanky Path (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMausoleum, -1, DROPSANITY_FLAG_START + 0x164)]),
    Locations.CastleUpperCaveEnemy_NearDungeon: Location(Levels.CreepyCastle, "Castle Upper Cave Enemy: Near Dungeon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleUpperCave, -1, DROPSANITY_FLAG_START + 0x165)]),
    # Locations.CastleUpperCaveEnemy_Pit: Location(Levels.CreepyCastle, "Castle Upper Cave Enemy: Pit", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleUpperCave, -1, DROPSANITY_FLAG_START + 0x166)]),
    Locations.CastleUpperCaveEnemy_NearPit: Location(Levels.CreepyCastle, "Castle Upper Cave Enemy: Near Pit", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleUpperCave, -1, DROPSANITY_FLAG_START + 0x167)]),
    Locations.CastleUpperCaveEnemy_NearEntrance: Location(Levels.CreepyCastle, "Castle Upper Cave Enemy: Near Entrance", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleUpperCave, -1, DROPSANITY_FLAG_START + 0x168)]),
    # Locations.CastleKKOEnemy_CenterEnemy: Location(Levels.CreepyCastle, "Castle Boss Enemy: Center Enemy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBoss, -1, DROPSANITY_FLAG_START + 0x169)]),
    # Locations.CastleKKOEnemy_WaterEnemy00: Location(Levels.CreepyCastle, "Castle Boss Enemy: Water Enemy00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBoss, -1, DROPSANITY_FLAG_START + 0x16a)]),
    # Locations.CastleKKOEnemy_WaterEnemy01: Location(Levels.CreepyCastle, "Castle Boss Enemy: Water Enemy01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBoss, -1, DROPSANITY_FLAG_START + 0x16b)]),
    # Locations.CastleKKOEnemy_WaterEnemy02: Location(Levels.CreepyCastle, "Castle Boss Enemy: Water Enemy02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBoss, -1, DROPSANITY_FLAG_START + 0x16c)]),
    # Locations.CastleKKOEnemy_WaterEnemy03: Location(Levels.CreepyCastle, "Castle Boss Enemy: Water Enemy03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleBoss, -1, DROPSANITY_FLAG_START + 0x16d)]),
    # Locations.CastleLibraryEnemy_Gauntlet00: Location(Levels.CreepyCastle, "Castle Library Enemy: Gauntlet00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x16e)]),
    # Locations.CastleLibraryEnemy_Gauntlet01: Location(Levels.CreepyCastle, "Castle Library Enemy: Gauntlet01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x16f)]),
    # Locations.CastleLibraryEnemy_Gauntlet02: Location(Levels.CreepyCastle, "Castle Library Enemy: Gauntlet02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x170)]),
    # Locations.CastleLibraryEnemy_Gauntlet03: Location(Levels.CreepyCastle, "Castle Library Enemy: Gauntlet03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x171)]),
    # Locations.CastleLibraryEnemy_Corridor00: Location(Levels.CreepyCastle, "Castle Library Enemy: Corridor00", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x172)]),
    # Locations.CastleLibraryEnemy_Corridor01: Location(Levels.CreepyCastle, "Castle Library Enemy: Corridor01", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x173)]),
    # Locations.CastleLibraryEnemy_Corridor02: Location(Levels.CreepyCastle, "Castle Library Enemy: Corridor02", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x174)]),
    # Locations.CastleLibraryEnemy_Corridor03: Location(Levels.CreepyCastle, "Castle Library Enemy: Corridor03", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x175)]),
    # Locations.CastleLibraryEnemy_Corridor04: Location(Levels.CreepyCastle, "Castle Library Enemy: Corridor04", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x176)]),
    # Locations.CastleLibraryEnemy_Corridor05: Location(Levels.CreepyCastle, "Castle Library Enemy: Corridor05", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x177)]),
    Locations.CastleLibraryEnemy_ForkLeft0: Location(Levels.CreepyCastle, "Castle Library Enemy: Fork Left (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x178)]),
    Locations.CastleLibraryEnemy_ForkLeft1: Location(Levels.CreepyCastle, "Castle Library Enemy: Fork Left (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x179)]),
    Locations.CastleLibraryEnemy_ForkCenter: Location(Levels.CreepyCastle, "Castle Library Enemy: Fork Center", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x17a)]),
    Locations.CastleLibraryEnemy_ForkRight: Location(Levels.CreepyCastle, "Castle Library Enemy: Fork Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleLibrary, -1, DROPSANITY_FLAG_START + 0x17b)]),
    Locations.CastleMuseumEnemy_MainFloor0: Location(Levels.CreepyCastle, "Castle Museum Enemy: Main Floor (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, DROPSANITY_FLAG_START + 0x17c)]),
    Locations.CastleMuseumEnemy_MainFloor1: Location(Levels.CreepyCastle, "Castle Museum Enemy: Main Floor (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, DROPSANITY_FLAG_START + 0x17d)]),
    Locations.CastleMuseumEnemy_MainFloor2: Location(Levels.CreepyCastle, "Castle Museum Enemy: Main Floor (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, DROPSANITY_FLAG_START + 0x17e)]),
    Locations.CastleMuseumEnemy_MainFloor3: Location(Levels.CreepyCastle, "Castle Museum Enemy: Main Floor (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, DROPSANITY_FLAG_START + 0x17f)]),
    Locations.CastleMuseumEnemy_Start: Location(Levels.CreepyCastle, "Castle Museum Enemy: Start", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, DROPSANITY_FLAG_START + 0x180)]),
    # Locations.CastleTowerEnemy_Gauntlet0: Location(Levels.CreepyCastle, "Castle Tower Enemy: Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTower, -1, DROPSANITY_FLAG_START + 0x181)]),
    # Locations.CastleTowerEnemy_Gauntlet1: Location(Levels.CreepyCastle, "Castle Tower Enemy: Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTower, -1, DROPSANITY_FLAG_START + 0x182)]),
    # Locations.CastleTowerEnemy_Gauntlet2: Location(Levels.CreepyCastle, "Castle Tower Enemy: Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTower, -1, DROPSANITY_FLAG_START + 0x183)]),
    # Locations.CastleTowerEnemy_Gauntlet3: Location(Levels.CreepyCastle, "Castle Tower Enemy: Gauntlet3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTower, -1, DROPSANITY_FLAG_START + 0x184)]),
    # Locations.CastleTowerEnemy_Gauntlet4: Location(Levels.CreepyCastle, "Castle Tower Enemy: Gauntlet4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTower, -1, DROPSANITY_FLAG_START + 0x185)]),
    # Locations.CastleTrashEnemy_Gauntlet0: Location(Levels.CreepyCastle, "Castle Trash Can Enemy: Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTrashCan, -1, DROPSANITY_FLAG_START + 0x186)]),
    # Locations.CastleTrashEnemy_Gauntlet1: Location(Levels.CreepyCastle, "Castle Trash Can Enemy: Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTrashCan, -1, DROPSANITY_FLAG_START + 0x187)]),
    # Locations.CastleTrashEnemy_Gauntlet2: Location(Levels.CreepyCastle, "Castle Trash Can Enemy: Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTrashCan, -1, DROPSANITY_FLAG_START + 0x188)]),
    # Locations.CastleTrashEnemy_Gauntlet3: Location(Levels.CreepyCastle, "Castle Trash Can Enemy: Gauntlet3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTrashCan, -1, DROPSANITY_FLAG_START + 0x189)]),
    # Locations.CastleTrashEnemy_Gauntlet4: Location(Levels.CreepyCastle, "Castle Trash Can Enemy: Gauntlet4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTrashCan, -1, DROPSANITY_FLAG_START + 0x18a)]),
    Locations.CastleTreeEnemy_StartRoom0: Location(Levels.CreepyCastle, "Castle Tree Enemy: Start Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTree, -1, DROPSANITY_FLAG_START + 0x18b)]),
    Locations.CastleTreeEnemy_StartRoom1: Location(Levels.CreepyCastle, "Castle Tree Enemy: Start Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CastleTree, -1, DROPSANITY_FLAG_START + 0x18c)]),
    Locations.HelmMainEnemy_Start0: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Start (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x18d)]),
    Locations.HelmMainEnemy_Start1: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Start (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x18e)]),
    Locations.HelmMainEnemy_Hill: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Hill", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x18f)]),
    Locations.HelmMainEnemy_SwitchRoom0: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Switch Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x190)]),
    Locations.HelmMainEnemy_SwitchRoom1: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Switch Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x191)]),
    Locations.HelmMainEnemy_MiniRoom0: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Mini Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x192)]),
    Locations.HelmMainEnemy_MiniRoom1: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Mini Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x193)]),
    Locations.HelmMainEnemy_MiniRoom2: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Mini Room (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x194)]),
    Locations.HelmMainEnemy_MiniRoom3: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Mini Room (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x195)]),
    Locations.HelmMainEnemy_DKRoom: Location(Levels.HideoutHelm, "Hideout Helm Enemy: DKRoom", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x196)]),
    Locations.HelmMainEnemy_ChunkyRoom0: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Chunky Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x197)]),
    Locations.HelmMainEnemy_ChunkyRoom1: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Chunky Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x198)]),
    Locations.HelmMainEnemy_TinyRoom: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Tiny Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x199)]),
    Locations.HelmMainEnemy_LankyRoom0: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Lanky Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x19a)]),
    Locations.HelmMainEnemy_LankyRoom1: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Lanky Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x19b)]),
    Locations.HelmMainEnemy_DiddyRoom0: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Diddy Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x19c)]),
    Locations.HelmMainEnemy_DiddyRoom1: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Diddy Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x19d)]),
    Locations.HelmMainEnemy_NavRight: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Nav Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x19e)]),
    Locations.HelmMainEnemy_NavLeft: Location(Levels.HideoutHelm, "Hideout Helm Enemy: Nav Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.HideoutHelm, -1, DROPSANITY_FLAG_START + 0x19f)]),
    Locations.IslesMainEnemy_PineappleCage0: Location(Levels.DKIsles, "Isles Enemy: Pineapple Cage (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a0)]),
    Locations.IslesMainEnemy_FungiCannon0: Location(Levels.DKIsles, "Isles Enemy: Fungi Cannon (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a1)]),
    Locations.IslesMainEnemy_JapesEntrance: Location(Levels.DKIsles, "Isles Enemy: Japes Entrance", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a2)]),
    Locations.IslesMainEnemy_MonkeyportPad: Location(Levels.DKIsles, "Isles Enemy: Monkeyport Pad", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a3)]),
    Locations.IslesMainEnemy_UpperFactoryPath: Location(Levels.DKIsles, "Isles Enemy: Upper Factory Path", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a4)]),
    Locations.IslesMainEnemy_NearAztec: Location(Levels.DKIsles, "Isles Enemy: Near Aztec", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a5)]),
    Locations.IslesMainEnemy_FungiCannon1: Location(Levels.DKIsles, "Isles Enemy: Fungi Cannon (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a6)]),
    Locations.IslesMainEnemy_PineappleCage1: Location(Levels.DKIsles, "Isles Enemy: Pineapple Cage (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a7)]),
    Locations.IslesMainEnemy_LowerFactoryPath0: Location(Levels.DKIsles, "Isles Enemy: Lower Factory Path (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a8)]),
    Locations.IslesMainEnemy_LowerFactoryPath1: Location(Levels.DKIsles, "Isles Enemy: Lower Factory Path (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.Isles, -1, DROPSANITY_FLAG_START + 0x1a9)]),
}
