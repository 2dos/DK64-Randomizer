...
LocationListOriginal = {
    ...
    # Progressive Hints
    Locations.JapesDonkey_ProgressiveHint: Location(Levels.JungleJapes, "Japes Donkey Progressive Hint Slot", Items.JapesDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.JapesDiddy_ProgressiveHint: Location(Levels.JungleJapes, "Japes Diddy Progressive Hint Slot", Items.JapesDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.JapesLanky_ProgressiveHint: Location(Levels.JungleJapes, "Japes Lanky Progressive Hint Slot", Items.JapesLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.JapesTiny_ProgressiveHint: Location(Levels.JungleJapes, "Japes Tiny Progressive Hint Slot", Items.JapesTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.JapesChunky_ProgressiveHint: Location(Levels.JungleJapes, "Japes Chunky Progressive Hint Slot", Items.JapesChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    Locations.AztecDonkey_ProgressiveHint: Location(Levels.AngryAztec, "Aztec Donkey Progressive Hint Slot", Items.AztecDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.AztecDiddy_ProgressiveHint: Location(Levels.AngryAztec, "Aztec Diddy Progressive Hint Slot", Items.AztecDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.AztecLanky_ProgressiveHint: Location(Levels.AngryAztec, "Aztec Lanky Progressive Hint Slot", Items.AztecLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.AztecTiny_ProgressiveHint: Location(Levels.AngryAztec, "Aztec Tiny Progressive Hint Slot", Items.AztecTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.AztecChunky_ProgressiveHint: Location(Levels.AngryAztec, "Aztec Chunky Progressive Hint Slot", Items.AztecChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    Locations.FactoryDonkey_ProgressiveHint: Location(Levels.FranticFactory, "Factory Donkey Progressive Hint Slot", Items.FactoryDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.FactoryDiddy_ProgressiveHint: Location(Levels.FranticFactory, "Factory Diddy Progressive Hint Slot", Items.FactoryDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.FactoryLanky_ProgressiveHint: Location(Levels.FranticFactory, "Factory Lanky Progressive Hint Slot", Items.FactoryLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.FactoryTiny_ProgressiveHint: Location(Levels.FranticFactory, "Factory Tiny Progressive Hint Slot", Items.FactoryTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.FactoryChunky_ProgressiveHint: Location(Levels.FranticFactory, "Factory Chunky Progressive Hint Slot", Items.FactoryChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    Locations.GalleonDonkey_ProgressiveHint: Location(Levels.GloomyGalleon, "Galleon Donkey Progressive Hint Slot", Items.GalleonDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.GalleonDiddy_ProgressiveHint: Location(Levels.GloomyGalleon, "Galleon Diddy Progressive Hint Slot", Items.GalleonDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.GalleonLanky_ProgressiveHint: Location(Levels.GloomyGalleon, "Galleon Lanky Progressive Hint Slot", Items.GalleonLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.GalleonTiny_ProgressiveHint: Location(Levels.GloomyGalleon, "Galleon Tiny Progressive Hint Slot", Items.GalleonTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.GalleonChunky_ProgressiveHint: Location(Levels.GloomyGalleon, "Galleon Chunky Progressive Hint Slot", Items.GalleonChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    Locations.ForestDonkey_ProgressiveHint: Location(Levels.FungiForest, "Forest Donkey Progressive Hint Slot", Items.ForestDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.ForestDiddy_ProgressiveHint: Location(Levels.FungiForest, "Forest Diddy Progressive Hint Slot", Items.ForestDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.ForestLanky_ProgressiveHint: Location(Levels.FungiForest, "Forest Lanky Progressive Hint Slot", Items.ForestLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.ForestTiny_ProgressiveHint: Location(Levels.FungiForest, "Forest Tiny Progressive Hint Slot", Items.ForestTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.ForestChunky_ProgressiveHint: Location(Levels.FungiForest, "Forest Chunky Progressive Hint Slot", Items.ForestChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    Locations.CavesDonkey_ProgressiveHint: Location(Levels.CrystalCaves, "Caves Donkey Progressive Hint Slot", Items.CavesDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.CavesDiddy_ProgressiveHint: Location(Levels.CrystalCaves, "Caves Diddy Progressive Hint Slot", Items.CavesDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.CavesLanky_ProgressiveHint: Location(Levels.CrystalCaves, "Caves Lanky Progressive Hint Slot", Items.CavesLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.CavesTiny_ProgressiveHint: Location(Levels.CrystalCaves, "Caves Tiny Progressive Hint Slot", Items.CavesTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.CavesChunky_ProgressiveHint: Location(Levels.CrystalCaves, "Caves Chunky Progressive Hint Slot", Items.CavesChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    Locations.CastleDonkey_ProgressiveHint: Location(Levels.CreepyCastle, "Castle Donkey Progressive Hint Slot", Items.CastleDonkeyHint, Types.ProgressiveHint, Kongs.donkey),
    Locations.CastleDiddy_ProgressiveHint: Location(Levels.CreepyCastle, "Castle Diddy Progressive Hint Slot", Items.CastleDiddyHint, Types.ProgressiveHint, Kongs.diddy),
    Locations.CastleLanky_ProgressiveHint: Location(Levels.CreepyCastle, "Castle Lanky Progressive Hint Slot", Items.CastleLankyHint, Types.ProgressiveHint, Kongs.lanky),
    Locations.CastleTiny_ProgressiveHint: Location(Levels.CreepyCastle, "Castle Tiny Progressive Hint Slot", Items.CastleTinyHint, Types.ProgressiveHint, Kongs.tiny),
    Locations.CastleChunky_ProgressiveHint: Location(Levels.CreepyCastle, "Castle Chunky Progressive Hint Slot", Items.CastleChunkyHint, Types.ProgressiveHint, Kongs.chunky),
    ...
    Locations.ForestMainEnemy_BetweenRBAndYellowTunnel: Location(Levels.FungiForest, "Fungi Forest Enemy: Between RBAnd Yellow Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd9)]),
