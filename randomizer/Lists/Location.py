...
LocationList = {
    ...
    Locations.FactoryDonkeyDKArcade: Location("Factory Donkey DK Arcade", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x108, 130)]),  # Note: Fast GBs allows this to be in BBlast
