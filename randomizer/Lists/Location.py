...
LocationListOriginal = {
    ...
    # Balloons
    Locations.Balloon000: Location(Levels.JungleJapes, "Japes Diddy Balloon: Inside Mountain", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.JapesMountain, -1, BALLOON_FLAG_START + 0)]),
	Locations.Balloon001: Location(Levels.JungleJapes, "Japes Diddy Balloon: In Cave", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 1)]),
	Locations.Balloon002: Location(Levels.JungleJapes, "Japes Donkey Balloon: By Snide", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 2)]),
	Locations.Balloon003: Location(Levels.JungleJapes, "Japes Chunky Balloon: In Cave (1)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 3)]),
	Locations.Balloon004: Location(Levels.JungleJapes, "Japes Lanky Balloon: By Hut", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 4)]),
	Locations.Balloon005: Location(Levels.JungleJapes, "Japes Diddy Balloon: By W5", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 5)]),
	Locations.Balloon006: Location(Levels.JungleJapes, "Japes Donkey Balloon: By Underground", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 6)]),
	Locations.Balloon007: Location(Levels.JungleJapes, "Japes Donkey Balloon: By Cranky", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 7)]),
	Locations.Balloon008: Location(Levels.JungleJapes, "Japes Tiny Balloon: By Hut", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 8)]),
	Locations.Balloon009: Location(Levels.JungleJapes, "Japes Tiny Balloon: In Fairy Room", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 9)]),
	Locations.Balloon010: Location(Levels.JungleJapes, "Japes Chunky Balloon: In Cave (2)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 10)]),
	Locations.Balloon011: Location(Levels.JungleJapes, "Japes Chunky Balloon: In Cave (3)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 11)]),
	Locations.Balloon012: Location(Levels.JungleJapes, "Japes Lanky Balloon: By his BP", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 12)]),
	Locations.Balloon013: Location(Levels.JungleJapes, "Japes Tiny Balloon: In Shellhive", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.JapesTinyHive, -1, BALLOON_FLAG_START + 13)]),
	Locations.Balloon014: Location(Levels.JungleJapes, "Japes Lanky Balloon: In Painting Room", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.JapesLankyCave, -1, BALLOON_FLAG_START + 14)]),
	Locations.Balloon015: Location(Levels.AngryAztec, "Aztec Tiny Balloon: Tiny Temple Kong Room (2)", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.AztecTinyTemple, -1, BALLOON_FLAG_START + 15)]),
	Locations.Balloon016: Location(Levels.AngryAztec, "Aztec Tiny Balloon: Tiny Temple Kong Room (1)", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.AztecTinyTemple, -1, BALLOON_FLAG_START + 16)]),
	Locations.Balloon017: Location(Levels.AngryAztec, "Aztec Chunky Balloon: By Vulture", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.AztecTinyTemple, -1, BALLOON_FLAG_START + 17)]),
	Locations.Balloon018: Location(Levels.AngryAztec, "Aztec Tiny Balloon: Llama Temple above lava", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.AztecLlamaTemple, -1, BALLOON_FLAG_START + 18)]),
	Locations.Balloon019: Location(Levels.AngryAztec, "Aztec Lanky Balloon: Llama Temple Kong Room (1)", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.AztecLlamaTemple, -1, BALLOON_FLAG_START + 19)]),
	Locations.Balloon020: Location(Levels.AngryAztec, "Aztec Lanky Balloon: Llama Temple Kong Room (2)", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.AztecLlamaTemple, -1, BALLOON_FLAG_START + 20)]),
	Locations.Balloon021: Location(Levels.AngryAztec, "Aztec Diddy Balloon: 5DT", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, BALLOON_FLAG_START + 21)]),
	Locations.Balloon022: Location(Levels.AngryAztec, "Aztec Lanky Balloon: 5DT", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.AztecLanky5DTemple, -1, BALLOON_FLAG_START + 22)]),
	Locations.Balloon023: Location(Levels.AngryAztec, "Aztec Chunky Balloon: 5DT (1)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.AztecChunky5DTemple, -1, BALLOON_FLAG_START + 23)]),
	Locations.Balloon024: Location(Levels.AngryAztec, "Aztec Chunky Balloon: 5DT (2)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.AztecChunky5DTemple, -1, BALLOON_FLAG_START + 24)]),
	...
	Locations.Balloon026: Location(Levels.FranticFactory, "Factory Chunky Balloon: Above Snide", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 26)]),
	Locations.Balloon027: Location(Levels.FranticFactory, "Factory Lanky Balloon: By F Key", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 27)]),
	Locations.Balloon028: Location(Levels.FranticFactory, "Factory Tiny Balloon: By Snide", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 28)]),
	...
	Locations.Balloon031: Location(Levels.FranticFactory, "Factory Donkey Balloon: R&D", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 31)]),
	Locations.Balloon032: Location(Levels.FranticFactory, "Factory Donkey Balloon: By Storage Shops", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 32)]),
	Locations.Balloon033: Location(Levels.FranticFactory, "Factory Donkey Balloon: By Numbers Game", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 33)]),
	...
	Locations.Balloon036: Location(Levels.FranticFactory, "Factory Tiny Balloon: By Testing Shop", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 36)]),
	...
	Locations.Balloon039: Location(Levels.GloomyGalleon, "Galleon Diddy Balloon: Cactus", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 39)]),
	Locations.Balloon040: Location(Levels.GloomyGalleon, "Galleon Tiny Balloon: KEVIN", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 40)]),
	Locations.Balloon041: Location(Levels.GloomyGalleon, "Galleon Lanky Balloon: Underneath Crown (1)", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 41)]),
	Locations.Balloon042: Location(Levels.GloomyGalleon, "Galleon Lanky Balloon: Underneath Crown (2)", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 42)]),
	Locations.Balloon043: Location(Levels.GloomyGalleon, "Galleon Chunky Balloon: Cactus", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 43)]),
	Locations.Balloon044: Location(Levels.GloomyGalleon, "Galleon Diddy Balloon: Seal Cage", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 44)]),
	Locations.Balloon045: Location(Levels.GloomyGalleon, "Galleon Donkey Balloon: Outside lighthouse", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 45)]),
	Locations.Balloon046: Location(Levels.GloomyGalleon, "Galleon Donkey Balloon: Near the 3 Chests", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 46)]),
	Locations.Balloon047: Location(Levels.GloomyGalleon, "Galleon Diddy Balloon: Gold Tower", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 47)]),
	Locations.Balloon048: Location(Levels.GloomyGalleon, "Galleon Chunky Balloon: Cannon Game", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 48)]),
	Locations.Balloon049: Location(Levels.GloomyGalleon, "Galleon Chunky Balloon: Above 2DS", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 49)]),
	Locations.Balloon050: Location(Levels.GloomyGalleon, "Galleon Lanky Balloon: Above 5DS", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 50)]),
	Locations.Balloon051: Location(Levels.GloomyGalleon, "Galleon Tiny Balloon: By Snide's", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 51)]),
	Locations.Balloon052: Location(Levels.GloomyGalleon, "Galleon Tiny Balloon: Gold Tower", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 52)]),
	Locations.Balloon053: Location(Levels.FranticFactory, "Factory Lanky Balloon: Crusher Room", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.FactoryCrusher, -1, BALLOON_FLAG_START + 53)]),
	Locations.Balloon054: Location(Levels.AngryAztec, "Aztec Donkey Balloon: Snake Road (1)", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 54)]),
	Locations.Balloon055: Location(Levels.AngryAztec, "Aztec Diddy Balloon: By Tiny Temple", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 55)]),
	Locations.Balloon056: Location(Levels.AngryAztec, "Aztec Donkey Balloon: Llama Temple Exterior Rear", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 56)]),
	Locations.Balloon057: Location(Levels.AngryAztec, "Aztec Donkey Balloon: Snake Road (2)", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 57)]),
	Locations.Balloon058: Location(Levels.AngryAztec, "Aztec Diddy Balloon: Rear Tunnel", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 58)]),
	Locations.Balloon059: Location(Levels.FungiForest, "Forest Diddy Balloon: By Snide's", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 59)]),
	Locations.Balloon060: Location(Levels.FungiForest, "Forest Tiny Balloon: Lower Mushroom Exterior", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 60)]),
	Locations.Balloon061: Location(Levels.FungiForest, "Forest Donkey Balloon: Behind Dark Attic Barn", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 61)]),
	Locations.Balloon062: Location(Levels.FungiForest, "Forest Chunky Balloon: Upper Mushroom Exterior", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 62)]),
	Locations.Balloon063: Location(Levels.FungiForest, "Forest Tiny Balloon: Behind Thornvine Barn", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 63)]),
	Locations.Balloon064: Location(Levels.GloomyGalleon, "Galleon Donkey Balloon: Inside Lighthouse", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.GalleonLighthouse, -1, BALLOON_FLAG_START + 64)]),
	Locations.Balloon065: Location(Levels.FungiForest, "Forest Diddy Balloon: Winch Room", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.ForestWinchRoom, -1, BALLOON_FLAG_START + 65)]),
	Locations.Balloon066: Location(Levels.FungiForest, "Forest Donkey Balloon: In Mill", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.ForestMillFront, -1, BALLOON_FLAG_START + 66)]),
	Locations.Balloon067: Location(Levels.FungiForest, "Forest Lanky Balloon: Upper Mushroom Interior", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.ForestGiantMushroom, -1, BALLOON_FLAG_START + 67)]),
	Locations.Balloon068: Location(Levels.FungiForest, "Forest Lanky Balloon: Lower Mushroom Interior", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.ForestGiantMushroom, -1, BALLOON_FLAG_START + 68)]),
	Locations.Balloon069: Location(Levels.FungiForest, "Forest Chunky Balloon: Face Puzzle", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.ForestChunkyFaceRoom, -1, BALLOON_FLAG_START + 69)]),
	Locations.Balloon070: Location(Levels.CrystalCaves, "Caves Diddy Balloon: Around W4", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 70)]),
	Locations.Balloon071: Location(Levels.CrystalCaves, "Caves Chunky Balloon: By Snide", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 71)]),
	Locations.Balloon072: Location(Levels.CrystalCaves, "Caves Tiny Balloon: By Cabin Shop", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 72)]),
	Locations.Balloon073: Location(Levels.CrystalCaves, "Caves Lanky Balloon: Waterfall", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 73)]),
	Locations.Balloon074: Location(Levels.CrystalCaves, "Caves Donkey Balloon: Entrance Ice Wall", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 74)]),
	Locations.Balloon075: Location(Levels.CrystalCaves, "Caves Diddy Balloon: Outside 5DC", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 75)]),
	Locations.Balloon076: Location(Levels.CrystalCaves, "Caves Chunky Balloon: Bonus Room", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 76)]),
	Locations.Balloon077: Location(Levels.CrystalCaves, "Caves Tiny Balloon: By Hidden Kasplat", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 77)]),
	Locations.Balloon078: Location(Levels.CrystalCaves, "Caves Donkey Balloon: Giant Boulder", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 78)]),
	Locations.Balloon079: Location(Levels.CrystalCaves, "Caves Tiny Balloon: 5DI", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.CavesTinyIgloo, -1, BALLOON_FLAG_START + 79)]),
	Locations.Balloon080: Location(Levels.CrystalCaves, "Caves Lanky Balloon: 5DI", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CavesLankyIgloo, -1, BALLOON_FLAG_START + 80)]),
	Locations.Balloon081: Location(Levels.CrystalCaves, "Caves Donkey Balloon: 5DI", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.CavesDonkeyIgloo, -1, BALLOON_FLAG_START + 81)]),
	Locations.Balloon082: Location(Levels.CreepyCastle, "Castle Diddy Balloon: Beside W1", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CreepyCastle, -1, BALLOON_FLAG_START + 82)]),
	Locations.Balloon083: Location(Levels.CreepyCastle, "Castle Diddy Balloon: Inside Ballroom", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CastleBallroom, -1, BALLOON_FLAG_START + 83)]),
	Locations.Balloon084: Location(Levels.CrystalCaves, "Caves Tiny Balloon: 5DC", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.CavesTinyCabin, -1, BALLOON_FLAG_START + 84)]),
	Locations.Balloon085: Location(Levels.CrystalCaves, "Caves Chunky Balloon: 5DI", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CavesChunkyIgloo, -1, BALLOON_FLAG_START + 85)]),
	Locations.Balloon086: Location(Levels.CrystalCaves, "Caves Lanky Balloon: Inside Tile Flip Minigame", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CavesFrozenCastle, -1, BALLOON_FLAG_START + 86)]),
	Locations.Balloon087: Location(Levels.CrystalCaves, "Caves Diddy Balloon: 5DI", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CavesDiddyIgloo, -1, BALLOON_FLAG_START + 87)]),
	Locations.Balloon088: Location(Levels.CreepyCastle, "Castle Lanky Balloon: Wind Tower", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CastleTower, -1, BALLOON_FLAG_START + 88)]),
	Locations.Balloon089: Location(Levels.CreepyCastle, "Castle Lanky Balloon: Mausoleum", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CastleMausoleum, -1, BALLOON_FLAG_START + 89)]),
	Locations.Balloon090: Location(Levels.CreepyCastle, "Castle Diddy Balloon: Inside the Coffin", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CastleCrypt, -1, BALLOON_FLAG_START + 90)]),
	Locations.Balloon091: Location(Levels.CreepyCastle, "Castle Donkey Balloon: Beside Minecart Entrance", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.CastleCrypt, -1, BALLOON_FLAG_START + 91)]),
	Locations.Balloon092: Location(Levels.CreepyCastle, "Castle Tiny Balloon: Behind Museum Glass", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.CastleMuseum, -1, BALLOON_FLAG_START + 92)]),
	Locations.Balloon093: Location(Levels.CreepyCastle, "Castle Chunky Balloon: Museum", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CastleMuseum, -1, BALLOON_FLAG_START + 93)]),
	Locations.Balloon094: Location(Levels.CreepyCastle, "Castle Diddy Balloon: Dungeon Chain Room", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 94)]),
	Locations.Balloon095: Location(Levels.CreepyCastle, "Castle Lanky Balloon: Dungeon (1)", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 95)]),
	Locations.Balloon096: Location(Levels.CreepyCastle, "Castle Chunky Balloon: Dungeon (1)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 96)]),
	Locations.Balloon097: Location(Levels.CreepyCastle, "Castle Lanky Balloon: Dungeon (2)", Items.Balloon, Types.Balloon, Kongs.lanky, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 97)]),
	Locations.Balloon098: Location(Levels.CreepyCastle, "Castle Chunky Balloon: Dungeon (2)", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 98)]),
	Locations.Balloon099: Location(Levels.CreepyCastle, "Castle Donkey Balloon: Tree", Items.Balloon, Types.Balloon, Kongs.donkey, [MapIDCombo(Maps.CastleTree, -1, BALLOON_FLAG_START + 99)]),
	Locations.Balloon100: Location(Levels.CreepyCastle, "Castle Chunky Balloon: Tree", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CastleTree, -1, BALLOON_FLAG_START + 100)]),
	Locations.Balloon101: Location(Levels.CreepyCastle, "Castle Chunky Balloon: Shed", Items.Balloon, Types.Balloon, Kongs.chunky, [MapIDCombo(Maps.CastleShed, -1, BALLOON_FLAG_START + 101)]),
	Locations.Balloon102: Location(Levels.CreepyCastle, "Castle Diddy Balloon: Above Crypt Entrance", Items.Balloon, Types.Balloon, Kongs.diddy, [MapIDCombo(Maps.CastleLowerCave, -1, BALLOON_FLAG_START + 102)]),
	Locations.Balloon103: Location(Levels.CreepyCastle, "Castle Tiny Balloon: Near Funky", Items.Balloon, Types.Balloon, Kongs.tiny, [MapIDCombo(Maps.CastleLowerCave, -1, BALLOON_FLAG_START + 103)]),
