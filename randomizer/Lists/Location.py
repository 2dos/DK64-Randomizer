...
class Location:
    ...
    def __init__(self, level, name, default, location_type, kong=Kongs.any, data=None):
        ...
        elif self.type in (Types.Banana, Types.Key, Types.Coin, Types.Crown, Types.Medal, Types.Bean, Types.Pearl, Types.Kong):
            if data is None:
                self.map_id_list = []
            else:
...
LocationList = {
    ...
    Locations.IslesBananaFairyIsland: Location(Levels.DKIsles, "Isles Island Banana Fairy", Items.BananaFairy, Types.Fairy),
    Locations.IslesBananaFairyCrocodisleIsle: Location(Levels.DKIsles, "Isles Kroc Isle Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.RarewareBanana: Location(Levels.DKIsles, "The 20 Fairies Reward", Items.GoldenBanana, Types.Banana, Kongs.tiny, [MapIDCombo(Maps.BananaFairyRoom, 0x1E, 301, Kongs.tiny)]),
    ...
    Locations.IslesBananaFairyForestLobby: Location(Levels.DKIsles, "Isles Forest Lobby Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.DiddyKong: Location(Levels.JungleJapes, "Diddy Kong", Items.Diddy, Types.Kong, Kongs.any, [MapIDCombo(0, -1, 6)]),
    Locations.JapesDonkeyFrontofCage: Location(Levels.JungleJapes, "Japes in Front of Diddy Cage", Items.GoldenBanana, Types.Banana, Kongs.any, [MapIDCombo(Maps.JungleJapes, 0x69, 4, Kongs.donkey)]),  # Can be assigned to other kongs
    ...
    Locations.JapesDiddyMountain: Location(Levels.JungleJapes, "Japes Diddy Top of Mountain", Items.GoldenBanana, Types.Banana, Kongs.diddy, [MapIDCombo(Maps.JungleJapes, 0x52, 23, Kongs.diddy)]),
    ...
    Locations.JapesBananaFairyRambiCave: Location(Levels.JungleJapes, "Japes Rambi Cave Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.JapesBananaFairyLankyCave: Location(Levels.JungleJapes, "Japes Painting Room Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.TinyKong: Location(Levels.AngryAztec, "Tiny Kong", Items.Tiny, Types.Kong, Kongs.any, [MapIDCombo(0, -1, 66)]),
    ...
    Locations.AztecDonkeyQuicksandCave: Location(Levels.AngryAztec, "Aztec Donkey Quicksand Cave Barrel", Items.GoldenBanana, Types.Banana, Kongs.donkey, [MapIDCombo(0, -1, 62, Kongs.donkey)]),
    ...
    Locations.AztecBananaFairyTinyTemple: Location(Levels.AngryAztec, "Aztec Tiny Temple Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.LankyKong: Location(Levels.AngryAztec, "Lanky Kong", Items.Lanky, Types.Kong, Kongs.any, [MapIDCombo(0, -1, 70)]),
    ...
    Locations.AztecBananaFairyLlamaTemple: Location(Levels.AngryAztec, "Aztec Llama Temple Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.ChunkyKong: Location(Levels.FranticFactory, "Chunky Kong", Items.Chunky, Types.Kong, Kongs.any, [MapIDCombo(0, -1, 117)]),
    ...
    Locations.GalleonDiddyGoldTower: Location(Levels.GloomyGalleon, "Galleon Diddy Gold Tower Barrel", Items.GoldenBanana, Types.Banana, Kongs.diddy, [MapIDCombo(0, -1, 163, Kongs.diddy)]),
    ...
    Locations.GalleonBananaFairy5DoorShip: Location(Levels.GloomyGalleon, "Galleon 5 Door Ship Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.GalleonPearl0: Location(Levels.GloomyGalleon, "An item in the Treasure Chest", Items.Pearl, Types.Pearl, Kongs.tiny, [MapIDCombo(Maps.GalleonTreasureChest, 0, 186, Kongs.tiny)]),
    Locations.GalleonPearl1: Location(Levels.GloomyGalleon, "An item in the Treasure Chest", Items.Pearl, Types.Pearl, Kongs.tiny, [MapIDCombo(Maps.GalleonTreasureChest, 1, 187, Kongs.tiny)]),
    Locations.GalleonPearl2: Location(Levels.GloomyGalleon, "An item in the Treasure Chest", Items.Pearl, Types.Pearl, Kongs.tiny, [MapIDCombo(Maps.GalleonTreasureChest, 2, 188, Kongs.tiny)]),
    Locations.GalleonPearl3: Location(Levels.GloomyGalleon, "An item in the Treasure Chest", Items.Pearl, Types.Pearl, Kongs.tiny, [MapIDCombo(Maps.GalleonTreasureChest, 3, 189, Kongs.tiny)]),
    Locations.GalleonPearl4: Location(Levels.GloomyGalleon, "An item in the Treasure Chest", Items.Pearl, Types.Pearl, Kongs.tiny, [MapIDCombo(Maps.GalleonTreasureChest, 4, 190, Kongs.tiny)]),
    ...
    Locations.ForestBananaFairyRafters: Location(Levels.FungiForest, "Forest Dark Rafters Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.ForestBananaFairyThornvines: Location(Levels.FungiForest, "Forest Thornvine Barn Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.CavesTinyCaveBarrel: Location(Levels.CrystalCaves, "Caves Tiny Mini Cave Barrel", Items.GoldenBanana, Types.Banana, Kongs.tiny, [MapIDCombo(0, -1, 295, Kongs.tiny)]),
    ...
    Locations.CavesBananaFairyIgloo: Location(Levels.CrystalCaves, "Caves Igloo Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.CastleBananaFairyTree: Location(Levels.CreepyCastle, "Castle Tree Banana Fairy", Items.BananaFairy, Types.Fairy),
    ...
    Locations.CastleBananaFairyBallroom: Location(Levels.CreepyCastle, "Castle Ballroom Banana Fairy", Items.BananaFairy, Types.Fairy),
