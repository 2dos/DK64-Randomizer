...
LocationListOriginal = {
    ...
    Locations.AztecMainEnemy_VaseRoom2: Location(Levels.AngryAztec, "Angry Aztec Enemy: Vase Room (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x2f)]),
    Locations.AztecMainEnemy_TunnelPad0: Location(Levels.AngryAztec, "Angry Aztec Enemy: Tunnel Pad (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x30)]),
    Locations.AztecMainEnemy_TunnelCage0: Location(Levels.AngryAztec, "Angry Aztec Enemy: Tunnel Cage (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x31)]),
    Locations.AztecMainEnemy_TunnelCage1: Location(Levels.AngryAztec, "Angry Aztec Enemy: Tunnel Cage (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x32)]),
    Locations.AztecMainEnemy_TunnelCage2: Location(Levels.AngryAztec, "Angry Aztec Enemy: Tunnel Cage (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x33)]),
    Locations.AztecMainEnemy_StartingTunnel0: Location(Levels.AngryAztec, "Angry Aztec Enemy: Starting Tunnel (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x34)]),
    Locations.AztecMainEnemy_StartingTunnel1: Location(Levels.AngryAztec, "Angry Aztec Enemy: Starting Tunnel (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x35)]),
    Locations.AztecMainEnemy_OasisDoor: Location(Levels.AngryAztec, "Angry Aztec Enemy: Oasis Door", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x36)]),
    Locations.AztecMainEnemy_TunnelCage3: Location(Levels.AngryAztec, "Angry Aztec Enemy: Tunnel Cage (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x37)]),
    Locations.AztecMainEnemy_OutsideLlama: Location(Levels.AngryAztec, "Angry Aztec Enemy: Outside Llama", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x38)]),
    Locations.AztecMainEnemy_OutsideTower: Location(Levels.AngryAztec, "Angry Aztec Enemy: Outside Tower", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x39)]),
    Locations.AztecMainEnemy_TunnelPad1: Location(Levels.AngryAztec, "Angry Aztec Enemy: Tunnel Pad (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3a)]),
    Locations.AztecMainEnemy_NearCandy: Location(Levels.AngryAztec, "Angry Aztec Enemy: Near Candy", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3b)]),
    Locations.AztecMainEnemy_AroundTotem: Location(Levels.AngryAztec, "Angry Aztec Enemy: Around Totem", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3c)]),
    Locations.AztecMainEnemy_StartingTunnel2: Location(Levels.AngryAztec, "Angry Aztec Enemy: Starting Tunnel (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3d)]),
    Locations.AztecMainEnemy_StartingTunnel3: Location(Levels.AngryAztec, "Angry Aztec Enemy: Starting Tunnel (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3e)]),
    Locations.AztecMainEnemy_OutsideSnide: Location(Levels.AngryAztec, "Angry Aztec Enemy: Outside Snide", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x3f)]),
    Locations.AztecMainEnemy_Outside5DT: Location(Levels.AngryAztec, "Angry Aztec Enemy: Outside 5DT", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x40)]),
    Locations.AztecMainEnemy_NearSnoopTunnel: Location(Levels.AngryAztec, "Angry Aztec Enemy: Near Sealed Quicksand Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, DROPSANITY_FLAG_START + 0x41)]),
    # Locations.AztecLobbyEnemy_Pad0: Location(Levels.DKIsles, "Angry Aztec Lobby Enemy: Pad0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztecLobby, -1, DROPSANITY_FLAG_START + 0x42)]),
    # Locations.AztecLobbyEnemy_Pad1: Location(Levels.DKIsles, "Angry Aztec Lobby Enemy: Pad1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.AngryAztecLobby, -1, DROPSANITY_FLAG_START + 0x43)]),
    ...
    Locations.FactoryMainEnemy_CandyCranky0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Candy Cranky (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8b)]),
    Locations.FactoryMainEnemy_CandyCranky1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Candy Cranky (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8c)]),
    Locations.FactoryMainEnemy_LobbyLeft: Location(Levels.FranticFactory, "Frantic Factory Enemy: Lobby Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8d)]),
    Locations.FactoryMainEnemy_LobbyRight: Location(Levels.FranticFactory, "Frantic Factory Enemy: Lobby Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8e)]),
    Locations.FactoryMainEnemy_StorageRoom: Location(Levels.FranticFactory, "Frantic Factory Enemy: Storage Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x8f)]),
    Locations.FactoryMainEnemy_BlockTower0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Block Tower (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x90)]),
    Locations.FactoryMainEnemy_BlockTower1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Block Tower (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x91)]),
    Locations.FactoryMainEnemy_BlockTower2: Location(Levels.FranticFactory, "Frantic Factory Enemy: Block Tower (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x92)]),
    Locations.FactoryMainEnemy_TunnelToHatch: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Hatch", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x93)]),
    Locations.FactoryMainEnemy_TunnelToProd0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Prod (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x94)]),
    Locations.FactoryMainEnemy_TunnelToProd1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Prod (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x95)]),
    Locations.FactoryMainEnemy_TunnelToBlockTower: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Block Tower", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x96)]),
    Locations.FactoryMainEnemy_TunnelToRace0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Race (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x97)]),
    Locations.FactoryMainEnemy_TunnelToRace1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Tunnel To Race (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x98)]),
    Locations.FactoryMainEnemy_LowWarp4: Location(Levels.FranticFactory, "Frantic Factory Enemy: Low Warp 4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x99)]),
    Locations.FactoryMainEnemy_DiddySwitch: Location(Levels.FranticFactory, "Frantic Factory Enemy: Diddy Switch", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9a)]),
    Locations.FactoryMainEnemy_ToBlockTowerTunnel: Location(Levels.FranticFactory, "Frantic Factory Enemy: To Block Tower Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9b)]),
    Locations.FactoryMainEnemy_DarkRoom0: Location(Levels.FranticFactory, "Frantic Factory Enemy: Dark Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9c)]),
    Locations.FactoryMainEnemy_DarkRoom1: Location(Levels.FranticFactory, "Frantic Factory Enemy: Dark Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9d)]),
    # Locations.FactoryMainEnemy_BHDM0: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9e)]),
    # Locations.FactoryMainEnemy_BHDM1: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0x9f)]),
    # Locations.FactoryMainEnemy_BHDM2: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa0)]),
    # Locations.FactoryMainEnemy_BHDM3: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM3", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa1)]),
    # Locations.FactoryMainEnemy_BHDM4: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM4", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa2)]),
    # Locations.FactoryMainEnemy_BHDM5: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa3)]),
    # Locations.FactoryMainEnemy_BHDM6: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM6", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa4)]),
    # Locations.FactoryMainEnemy_BHDM7: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM7", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa5)]),
    # Locations.FactoryMainEnemy_BHDM8: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM8", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa6)]),
    # Locations.FactoryMainEnemy_BHDM9: Location(Levels.FranticFactory, "Frantic Factory Enemy: BHDM9", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa7)]),
    # Locations.FactoryMainEnemy_1342Gauntlet0: Location(Levels.FranticFactory, "Frantic Factory Enemy: 1342Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa8)]),
    # Locations.FactoryMainEnemy_1342Gauntlet1: Location(Levels.FranticFactory, "Frantic Factory Enemy: 1342Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xa9)]),
    # Locations.FactoryMainEnemy_1342Gauntlet2: Location(Levels.FranticFactory, "Frantic Factory Enemy: 1342Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xaa)]),
    # Locations.FactoryMainEnemy_3124Gauntlet0: Location(Levels.FranticFactory, "Frantic Factory Enemy: 3124Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xab)]),
    # Locations.FactoryMainEnemy_3124Gauntlet1: Location(Levels.FranticFactory, "Frantic Factory Enemy: 3124Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xac)]),
    # Locations.FactoryMainEnemy_3124Gauntlet2: Location(Levels.FranticFactory, "Frantic Factory Enemy: 3124Gauntlet2", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xad)]),
    # Locations.FactoryMainEnemy_4231Gauntlet0: Location(Levels.FranticFactory, "Frantic Factory Enemy: 4231Gauntlet0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xae)]),
    # Locations.FactoryMainEnemy_4231Gauntlet1: Location(Levels.FranticFactory, "Frantic Factory Enemy: 4231Gauntlet1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, DROPSANITY_FLAG_START + 0xaf)]),
    Locations.FactoryLobbyEnemy_Enemy0: Location(Levels.DKIsles, "Frantic Factory Lobby Enemy: Enemy (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FranticFactoryLobby, -1, DROPSANITY_FLAG_START + 0xb0)]),
    Locations.GalleonMainEnemy_ChestRoom0: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Chest Room (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb1)]),
    Locations.GalleonMainEnemy_ChestRoom1: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Chest Room (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb2)]),
    Locations.GalleonMainEnemy_NearVineCannon: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Near Vine Cannon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb3)]),
    Locations.GalleonMainEnemy_CrankyCannon: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Cranky Cannon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb4)]),
    # Locations.GalleonMainEnemy_Submarine: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Submarine", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb5)]),
    # Locations.GalleonMainEnemy_5DS0: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: 5DS0", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb6)]),
    # Locations.GalleonMainEnemy_5DS1: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: 5DS1", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb7)]),
    Locations.GalleonMainEnemy_PeanutTunnel: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Peanut Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb8)]),
    Locations.GalleonMainEnemy_CoconutTunnel: Location(Levels.GloomyGalleon, "Gloomy Galleon Enemy: Coconut Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, DROPSANITY_FLAG_START + 0xb9)]),
    ...
    Locations.ForestMainEnemy_HollowTree0: Location(Levels.FungiForest, "Fungi Forest Enemy: Hollow Tree (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xca)]),
    Locations.ForestMainEnemy_HollowTree1: Location(Levels.FungiForest, "Fungi Forest Enemy: Hollow Tree (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcb)]),
    Locations.ForestMainEnemy_HollowTreeEntrance: Location(Levels.FungiForest, "Fungi Forest Enemy: Hollow Tree Entrance", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcc)]),
    Locations.ForestMainEnemy_TreeMelonCrate0: Location(Levels.FungiForest, "Fungi Forest Enemy: Tree Melon Crate (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcd)]),
    Locations.ForestMainEnemy_TreeMelonCrate1: Location(Levels.FungiForest, "Fungi Forest Enemy: Tree Melon Crate (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xce)]),
    Locations.ForestMainEnemy_TreeMelonCrate2: Location(Levels.FungiForest, "Fungi Forest Enemy: Tree Melon Crate (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcf)]),
    Locations.ForestMainEnemy_AppleGauntlet0: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd0)]),
    Locations.ForestMainEnemy_AppleGauntlet1: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd1)]),
    Locations.ForestMainEnemy_AppleGauntlet2: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd2)]),
    Locations.ForestMainEnemy_AppleGauntlet3: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd3)]),
    Locations.ForestMainEnemy_NearBeanstalk0: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Beanstalk (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd4)]),
    Locations.ForestMainEnemy_NearBeanstalk1: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Beanstalk (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd5)]),
    Locations.ForestMainEnemy_GreenTunnel: Location(Levels.FungiForest, "Fungi Forest Enemy: Green Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd6)]),
    Locations.ForestMainEnemy_NearLowWarp5: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Low Warp 5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd7)]),
    Locations.ForestMainEnemy_NearPinkTunnelBounceTag: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Pink Tunnel Bounce Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd8)]),
    Locations.ForestMainEnemy_NearGMRocketbarrel: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Giant Mushroom Rocketbarrel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd9)]),
    Locations.ForestMainEnemy_BetweenYellowTunnelAndRB: Location(Levels.FungiForest, "Fungi Forest Enemy: Between Yellow Tunnel And RB", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xda)]),
    Locations.ForestMainEnemy_NearCranky: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Cranky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdb)]),
    Locations.ForestMainEnemy_NearPinkTunnelGM: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Pink Tunnel Giant Mushroom", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdc)]),
    Locations.ForestMainEnemy_GMRearTag: Location(Levels.FungiForest, "Fungi Forest Enemy: Giant Mushroom Rear Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdd)]),
    Locations.ForestMainEnemy_NearFacePuzzle: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Face Puzzle", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xde)]),
    Locations.ForestMainEnemy_NearCrown: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Crown", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xdf)]),
    Locations.ForestMainEnemy_NearHighWarp5: Location(Levels.FungiForest, "Fungi Forest Enemy: Near High Warp 5", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe0)]),
    Locations.ForestMainEnemy_TopOfMushroom: Location(Levels.FungiForest, "Fungi Forest Enemy: Top Of Mushroom", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe1)]),
    Locations.ForestMainEnemy_NearAppleDropoff: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Apple Dropoff", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe2)]),
    Locations.ForestMainEnemy_NearDKPortal: Location(Levels.FungiForest, "Fungi Forest Enemy: Near DKPortal", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe3)]),
    Locations.ForestMainEnemy_NearWellTag: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Well Tag", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe4)]),
    Locations.ForestMainEnemy_YellowTunnel0: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe5)]),
    Locations.ForestMainEnemy_YellowTunnel1: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe6)]),
    Locations.ForestMainEnemy_YellowTunnel2: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe7)]),
    Locations.ForestMainEnemy_YellowTunnel3: Location(Levels.FungiForest, "Fungi Forest Enemy: Yellow Tunnel (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe8)]),
    Locations.ForestMainEnemy_NearSnide: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Snide", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xe9)]),
    Locations.ForestMainEnemy_NearIsoCoin: Location(Levels.FungiForest, "Fungi Forest Enemy: Near the hidden Rainbow Coin", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xea)]),
    Locations.ForestMainEnemy_NearBBlast: Location(Levels.FungiForest, "Fungi Forest Enemy: Near BBlast", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xeb)]),
    Locations.ForestMainEnemy_NearDarkAttic: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Dark Attic", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xec)]),
    Locations.ForestMainEnemy_NearWellExit: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Well Exit", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xed)]),
    Locations.ForestMainEnemy_NearBlueTunnel: Location(Levels.FungiForest, "Fungi Forest Enemy: Near Blue Tunnel", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xee)]),
    Locations.ForestMainEnemy_Thornvine0: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xef)]),
    Locations.ForestMainEnemy_Thornvine1: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xf0)]),
    Locations.ForestMainEnemy_Thornvine2: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xf1)]),
    Locations.ForestMainEnemy_ThornvineEntrance: Location(Levels.FungiForest, "Fungi Forest Enemy: Thornvine Entrance", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xf2)]),
    ...
    Locations.CavesMainEnemy_Start: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Start", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x107)]),
    Locations.CavesMainEnemy_NearIceCastle: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Ice Castle", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x108)]),
    Locations.CavesMainEnemy_Outside5DC: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Outside 5DC", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x109)]),
    Locations.CavesMainEnemy_1DCWaterfall: Location(Levels.CrystalCaves, "Crystal Caves Enemy: 1DC Waterfall", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10a)]),
    Locations.CavesMainEnemy_NearFunky: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Funky", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10b)]),
    Locations.CavesMainEnemy_NearSnide: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Snide", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10c)]),
    Locations.CavesMainEnemy_NearBonusRoom: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Near Bonus Room", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10d)]),
    Locations.CavesMainEnemy_1DCHeadphones: Location(Levels.CrystalCaves, "Crystal Caves Enemy: 1DC Headphones", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10e)]),
    # Locations.CavesMainEnemy_GiantKosha: Location(Levels.CrystalCaves, "Crystal Caves Enemy: Giant Kosha", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, DROPSANITY_FLAG_START + 0x10f)]),
    ...
    Locations.CastleMainEnemy_NearBridge0: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Bridge (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x134)]),
    Locations.CastleMainEnemy_NearBridge1: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Bridge (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x135)]),
    Locations.CastleMainEnemy_WoodenExtrusion0: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Wooden Extrusion (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x136)]),
    Locations.CastleMainEnemy_WoodenExtrusion1: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Wooden Extrusion (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x137)]),
    Locations.CastleMainEnemy_NearShed: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Shed", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x138)]),
    Locations.CastleMainEnemy_NearLibrary: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Library", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x139)]),
    Locations.CastleMainEnemy_NearTower: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Tower", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13a)]),
    Locations.CastleMainEnemy_MuseumSteps: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Museum Steps", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13b)]),
    Locations.CastleMainEnemy_NearLowCave: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Low Cave", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13c)]),
    Locations.CastleMainEnemy_PathToLowKasplat: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Path To Low Kasplat", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13d)]),
    Locations.CastleMainEnemy_LowTnS: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Low TnS", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13e)]),
    Locations.CastleMainEnemy_PathToDungeon: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Path To Dungeon", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x13f)]),
    Locations.CastleMainEnemy_NearHeadphones: Location(Levels.CreepyCastle, "Creepy Castle Enemy: Near Headphones", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, DROPSANITY_FLAG_START + 0x140)]),
    Locations.CastleLobbyEnemy_Left: Location(Levels.DKIsles, "Creepy Castle Lobby Enemy: Left", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastleLobby, -1, DROPSANITY_FLAG_START + 0x141)]),
    Locations.CastleLobbyEnemy_FarRight: Location(Levels.DKIsles, "Creepy Castle Lobby Enemy: Far Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastleLobby, -1, DROPSANITY_FLAG_START + 0x142)]),
    Locations.CastleLobbyEnemy_NearRight: Location(Levels.DKIsles, "Creepy Castle Lobby Enemy: Near Right", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.CreepyCastleLobby, -1, DROPSANITY_FLAG_START + 0x143)]),
    ...
    # Krem Kap
    Locations.KremKap_JapesMainEnemy_Start: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Start", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_DiddyCavern: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Diddy Cavern", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Tunnel0: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Tunnel (0)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Tunnel1: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Tunnel (1)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Storm0: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Storm (0)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Storm1: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Storm (1)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Storm2: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Storm (2)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Hive0: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Hive (0)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Hive1: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Hive (1)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Hive2: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Hive (2)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Hive3: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Hive (3)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Hive4: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Hive (4)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_KilledInDemo: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Killed In Demo", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_NearUnderground: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Near Underground", Items.PhotoZingerCharger, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_NearPainting0: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Near Painting (0)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_NearPainting1: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Near Painting (1)", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_NearPainting2: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Near Painting (2)", Items.PhotoZingerCharger, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_Mountain: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Mountain", Items.PhotoZingerCharger, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_FeatherTunnel: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Feather Tunnel", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_JapesMainEnemy_MiddleTunnel: Location(Levels.JungleJapes, "Photo of Jungle Japes Enemy: Middle Tunnel", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    ...
    Locations.KremKap_AztecMainEnemy_VaseRoom0: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Vase Room (0)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_VaseRoom1: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Vase Room (1)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_VaseRoom2: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Vase Room (2)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_TunnelPad0: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Tunnel Pad (0)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_TunnelCage0: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Tunnel Cage (0)", Items.PhotoKlaptrapGreen, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_TunnelCage1: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Tunnel Cage (1)", Items.PhotoKlaptrapGreen, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_TunnelCage2: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Tunnel Cage (2)", Items.PhotoKlaptrapGreen, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_StartingTunnel0: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Starting Tunnel (0)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_StartingTunnel1: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Starting Tunnel (1)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_OasisDoor: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Oasis Door", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_TunnelCage3: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Tunnel Cage (3)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_OutsideLlama: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Outside Llama", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_OutsideTower: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Outside Tower", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_TunnelPad1: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Tunnel Pad (1)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_NearCandy: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Near Candy", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_AroundTotem: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Around Totem", Items.PhotoKlaptrapGreen, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_StartingTunnel2: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Starting Tunnel (2)", Items.PhotoZingerCharger, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_StartingTunnel3: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Starting Tunnel (3)", Items.PhotoZingerCharger, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_OutsideSnide: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Outside Snide", Items.PhotoKlaptrapGreen, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_Outside5DT: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Outside 5DT", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_AztecMainEnemy_NearSnoopTunnel: Location(Levels.AngryAztec, "Photo of Angry Aztec Enemy: Near Sealed Quicksand Tunnel", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    ...
    Locations.KremKap_FactoryMainEnemy_CandyCranky0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Candy Cranky (0)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_CandyCranky1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Candy Cranky (1)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_LobbyLeft: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Lobby Left", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_LobbyRight: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Lobby Right", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_StorageRoom: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Storage Room", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_BlockTower0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Block Tower (0)", Items.PhotoMrDice1, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_BlockTower1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Block Tower (1)", Items.PhotoSirDomino, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_BlockTower2: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Block Tower (2)", Items.PhotoMrDice1, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_TunnelToHatch: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Tunnel To Hatch", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_TunnelToProd0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Tunnel To Prod (0)", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_TunnelToProd1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Tunnel To Prod (1)", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_TunnelToBlockTower: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Tunnel To Block Tower", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_TunnelToRace0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Tunnel To Race (0)", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_TunnelToRace1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Tunnel To Race (1)", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_LowWarp4: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Low Warp 4", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_DiddySwitch: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Diddy Switch", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_ToBlockTowerTunnel: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: To Block Tower Tunnel", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_DarkRoom0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Dark Room (0)", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_FactoryMainEnemy_DarkRoom1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: Dark Room (1)", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM0", Items.PhotoMrDice0, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM1", Items.PhotoSirDomino, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM2: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM2", Items.PhotoSirDomino, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM3: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM3", Items.PhotoMrDice0, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM4: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM4", Items.PhotoMrDice0, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM5: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM5", Items.PhotoRuler, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM6: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM6", Items.PhotoRuler, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM7: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM7", Items.PhotoMrDice1, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM8: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM8", Items.PhotoSirDomino, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_BHDM9: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: BHDM9", Items.PhotoSirDomino, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_1342Gauntlet0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 1342Gauntlet0", Items.PhotoZingerRobo, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_1342Gauntlet1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 1342Gauntlet1", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_1342Gauntlet2: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 1342Gauntlet2", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_3124Gauntlet0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 3124Gauntlet0", Items.PhotoMrDice1, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_3124Gauntlet1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 3124Gauntlet1", Items.PhotoSirDomino, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_3124Gauntlet2: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 3124Gauntlet2", Items.PhotoMrDice1, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_4231Gauntlet0: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 4231Gauntlet0", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_FactoryMainEnemy_4231Gauntlet1: Location(Levels.FranticFactory, "Photo of Frantic Factory Enemy: 4231Gauntlet1", Items.PhotoRoboKremling, Types.EnemyPhoto, Kongs.any, []),
    ...
    Locations.KremKap_GalleonMainEnemy_ChestRoom0: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Chest Room (0)", Items.PhotoKlobber, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_ChestRoom1: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Chest Room (1)", Items.PhotoKaboom, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_NearVineCannon: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Near Vine Cannon", Items.PhotoKaboom, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_CrankyCannon: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Cranky Cannon", Items.PhotoKaboom, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_Submarine: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Submarine", Items.PhotoPufftup, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_5DS0: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: 5DS0", Items.PhotoShuri, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_5DS1: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: 5DS1", Items.PhotoShuri, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_PeanutTunnel: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Peanut Tunnel", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_GalleonMainEnemy_CoconutTunnel: Location(Levels.GloomyGalleon, "Photo of Gloomy Galleon Enemy: Coconut Tunnel", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    ...
    Locations.KremKap_ForestMainEnemy_HollowTree0: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Hollow Tree (0)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_HollowTree1: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Hollow Tree (1)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_HollowTreeEntrance: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Hollow Tree Entrance", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_TreeMelonCrate0: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Tree Melon Crate (0)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_TreeMelonCrate1: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Tree Melon Crate (1)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_TreeMelonCrate2: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Tree Melon Crate (2)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_AppleGauntlet0: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Apple Gauntlet (0)", Items.PhotoTomato, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_AppleGauntlet1: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Apple Gauntlet (1)", Items.PhotoTomato, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_AppleGauntlet2: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Apple Gauntlet (2)", Items.PhotoTomato, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_AppleGauntlet3: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Apple Gauntlet (3)", Items.PhotoTomato, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearBeanstalk0: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Beanstalk (0)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearBeanstalk1: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Beanstalk (1)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_GreenTunnel: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Green Tunnel", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearLowWarp5: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Low Warp 5", Items.PhotoMushroomMan, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearPinkTunnelBounceTag: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Pink Tunnel Bounce Tag", Items.PhotoMushroomMan, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearGMRocketbarrel: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Giant Mushroom Rocketbarrel", Items.PhotoMushroomMan, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_BetweenYellowTunnelAndRB: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Between Yellow Tunnel And RB", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearCranky: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Cranky", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearPinkTunnelGM: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Pink Tunnel Giant Mushroom", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_GMRearTag: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Giant Mushroom Rear Tag", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearFacePuzzle: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Face Puzzle", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearCrown: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Crown", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearHighWarp5: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near High Warp 5", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_TopOfMushroom: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Top Of Mushroom", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearAppleDropoff: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Apple Dropoff", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearDKPortal: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near DKPortal", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearWellTag: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Well Tag", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_YellowTunnel0: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Yellow Tunnel (0)", Items.PhotoMushroomMan, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_YellowTunnel1: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Yellow Tunnel (1)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_YellowTunnel2: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Yellow Tunnel (2)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_YellowTunnel3: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Yellow Tunnel (3)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearSnide: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Snide", Items.PhotoMushroomMan, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearIsoCoin: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near the hidden Rainbow Coin", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearBBlast: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near BBlast", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearDarkAttic: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Dark Attic", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearWellExit: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Well Exit", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_NearBlueTunnel: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Near Blue Tunnel", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_Thornvine0: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Thornvine (0)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_Thornvine1: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Thornvine (1)", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_Thornvine2: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Thornvine (2)", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_ForestMainEnemy_ThornvineEntrance: Location(Levels.FungiForest, "Photo of Fungi Forest Enemy: Thornvine Entrance", Items.PhotoKlump, Types.EnemyPhoto, Kongs.any, []),
    ...
    Locations.KremKap_CavesMainEnemy_Start: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Start", Items.PhotoKremling, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_NearIceCastle: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Near Ice Castle", Items.PhotoBeaverBlue, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_Outside5DC: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Outside 5DC", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_1DCWaterfall: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: 1DC Waterfall", Items.PhotoZingerLime, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_NearFunky: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Near Funky", Items.PhotoZingerCharger, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_NearSnide: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Near Snide", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_NearBonusRoom: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Near Bonus Room", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CavesMainEnemy_1DCHeadphones: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: 1DC Headphones", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    # Locations.KremKap_CavesMainEnemy_GiantKosha: Location(Levels.CrystalCaves, "Photo of Crystal Caves Enemy: Giant Kosha", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    ...
    Locations.KremKap_CastleMainEnemy_NearBridge0: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Bridge (0)", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_NearBridge1: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Bridge (1)", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_WoodenExtrusion0: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Wooden Extrusion (0)", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_WoodenExtrusion1: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Wooden Extrusion (1)", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_NearShed: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Shed", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_NearLibrary: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Library", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_NearTower: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Tower", Items.PhotoKosha, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_MuseumSteps: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Museum Steps", Items.PhotoGhost, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_NearLowCave: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Low Cave", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_PathToLowKasplat: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Path To Low Kasplat", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_LowTnS: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Low TnS", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_PathToDungeon: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Path To Dungeon", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
    Locations.KremKap_CastleMainEnemy_NearHeadphones: Location(Levels.CreepyCastle, "Photo of Creepy Castle Enemy: Near Headphones", Items.PhotoKrossbones, Types.EnemyPhoto, Kongs.any, []),
