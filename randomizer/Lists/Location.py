...
LocationListOriginal = {
    ...
    Locations.ForestMainEnemy_AppleGauntlet0: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (0)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xcf)]),
    Locations.ForestMainEnemy_AppleGauntlet1: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (1)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd0)]),
    Locations.ForestMainEnemy_AppleGauntlet2: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (2)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd1)]),
    Locations.ForestMainEnemy_AppleGauntlet3: Location(Levels.FungiForest, "Fungi Forest Enemy: Apple Gauntlet (3)", Items.EnemyItem, Types.Enemies, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, DROPSANITY_FLAG_START + 0xd2)]),
