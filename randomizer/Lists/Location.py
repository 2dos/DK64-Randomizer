...
LocationList = {
    ...
    Locations.IslesTinyKasplat: Location("Isles Tiny Kasplat", Items.DKIslesTinyBlueprint, Types.Blueprint, [Maps.FranticFactoryLobby, Kongs.tiny]),
    ...
    Locations.IslesChunkyKasplat: Location("Isles Chunky Kasplat", Items.DKIslesChunkyBlueprint, Types.Blueprint, [Maps.GloomyGalleonLobby, Kongs.chunky]),
    ...
    Locations.IslesLankyKasplat: Location("Isles Lanky Kasplat", Items.DKIslesLankyBlueprint, Types.Blueprint, [Maps.CrystalCavesLobby, Kongs.lanky]),
    Locations.IslesLankyCastleLobby: Location("Isles Lanky Castle Lobby", Items.GoldenBanana, Types.Banana),
    Locations.IslesDiddyKasplat: Location("Isles Diddy Kasplat", Items.DKIslesDiddyBlueprint, Types.Blueprint, [Maps.CreepyCastleLobby, Kongs.diddy]),
    Locations.IslesChunkyHelmLobby: Location("Isles Chunky Helm Lobby", Items.GoldenBanana, Types.Banana),
    Locations.IslesDonkeyKasplat: Location("Isles Donkey Kasplat", Items.DKIslesDonkeyBlueprint, Types.Blueprint, [Maps.HideoutHelmLobby, Kongs.donkey]),
    ...
    Locations.JapesDonkeyKasplat: Location("Japes Donkey Kasplat", Items.JungleJapesDonkeyBlueprint, Types.Blueprint, [Maps.JungleJapes, Kongs.donkey]),
    Locations.JapesTinyKasplat: Location("Japes Tiny Kasplat", Items.JungleJapesTinyBlueprint, Types.Blueprint, [Maps.JungleJapes, Kongs.tiny]),
    ...
    Locations.JapesDiddyKasplat: Location("Japes Diddy Kasplat", Items.JungleJapesDiddyBlueprint, Types.Blueprint, [Maps.JungleJapes, Kongs.diddy]),
    Locations.JapesLankyKasplat: Location("Japes Lanky Kasplat", Items.JungleJapesLankyBlueprint, Types.Blueprint, [Maps.JungleJapes, Kongs.lanky]),
    ...
    Locations.JapesChunkyKasplat: Location("Japes Chunky Kasplat", Items.JungleJapesChunkyBlueprint, Types.Blueprint, [Maps.JapesUnderGround, Kongs.chunky]),
    ...
    Locations.AztecDonkeyKasplat: Location("Aztec Donkey Kasplat", Items.AngryAztecDonkeyBlueprint, Types.Blueprint, [Maps.AngryAztec, Kongs.donkey]),
    Locations.AztecDiddyKasplat: Location("Aztec Diddy Kasplat", Items.AngryAztecDiddyBlueprint, Types.Blueprint, [Maps.AngryAztec, Kongs.diddy]),
    ...
    Locations.AztecTinyKasplat: Location("Aztec Tiny Kasplat", Items.AngryAztecTinyBlueprint, Types.Blueprint, [Maps.AngryAztec, Kongs.tiny]),
    ...
    Locations.AztecChunkyKasplat: Location("Aztec Chunky Kasplat", Items.AngryAztecChunkyBlueprint, Types.Blueprint, [Maps.AztecChunky5DTemple, Kongs.chunky]),
    ...
    Locations.AztecLankyKasplat: Location("Aztec Lanky Kasplat", Items.AngryAztecLankyBlueprint, Types.Blueprint, [Maps.AztecLlamaTemple, Kongs.lanky]),
    ...
    Locations.FactoryChunkyKasplat: Location("Factory Chunky Kasplat", Items.FranticFactoryChunkyBlueprint, Types.Blueprint, [Maps.FranticFactory, Kongs.chunky]),
    ...
    Locations.FactoryLankyKasplat: Location("Factory Lanky Kasplat", Items.FranticFactoryLankyBlueprint, Types.Blueprint, [Maps.FranticFactory, Kongs.lanky]),
    ...
    Locations.FactoryDiddyKasplat: Location("Factory Diddy Kasplat", Items.FranticFactoryDiddyBlueprint, Types.Blueprint, [Maps.FranticFactory, Kongs.diddy]),
    Locations.FactoryTinyKasplat: Location("Factory Tiny Kasplat", Items.FranticFactoryTinyBlueprint, Types.Blueprint, [Maps.FranticFactory, Kongs.tiny]),
    ...
    Locations.FactoryDonkeyKasplat: Location("Factory Donkey Kasplat", Items.FranticFactoryDonkeyBlueprint, Types.Blueprint, [Maps.FranticFactory, Kongs.donkey]),
    ...
    Locations.GalleonTinyKasplat: Location("Galleon Tiny Kasplat", Items.GloomyGalleonTinyBlueprint, Types.Blueprint, [Maps.GloomyGalleon, Kongs.tiny]),
    ...
    Locations.GalleonLankyKasplat: Location("Galleon Lanky Kasplat", Items.GloomyGalleonLankyBlueprint, Types.Blueprint, [Maps.GloomyGalleon, Kongs.lanky]),
    ...
    Locations.GalleonDiddyKasplat: Location("Galleon Diddy Kasplat", Items.GloomyGalleonDiddyBlueprint, Types.Blueprint, [Maps.GloomyGalleon, Kongs.diddy]),
    ...
    Locations.GalleonChunkyKasplat: Location("Galleon Chunky Kasplat", Items.GloomyGalleonChunkyBlueprint, Types.Blueprint, [Maps.GloomyGalleon, Kongs.chunky]),
    ...
    Locations.GalleonDonkeyKasplat: Location("Galleon Donkey Kasplat", Items.GloomyGalleonDonkeyBlueprint, Types.Blueprint, [Maps.GloomyGalleon, Kongs.donkey]),
    ...
    Locations.ForestTinyKasplat: Location("Forest Tiny Kasplat", Items.FungiForestTinyBlueprint, Types.Blueprint, [Maps.FungiForest, Kongs.tiny]),
    Locations.ForestDonkeyMushroomCannons: Location("Forest Donkey Mushroom Cannons", Items.GoldenBanana, Types.Banana),
    Locations.ForestDiddyKasplat: Location("Forest Diddy Kasplat", Items.FungiForestDiddyBlueprint, Types.Blueprint, [Maps.ForestGiantMushroom, Kongs.diddy]),
    Locations.ForestChunkyKasplat: Location("Forest Chunky Kasplat", Items.FungiForestChunkyBlueprint, Types.Blueprint, [Maps.FungiForest, Kongs.chunky]),
    ...
    Locations.ForestLankyKasplat: Location("Forest Lanky Kasplat", Items.FungiForestLankyBlueprint, Types.Blueprint, [Maps.FungiForest, Kongs.lanky]),
    ...
    Locations.ForestDonkeyKasplat: Location("Forest Donkey Kasplat", Items.FungiForestDonkeyBlueprint, Types.Blueprint, [Maps.FungiForest, Kongs.donkey]),
    ...
    Locations.CavesDonkeyKasplat: Location("Caves Donkey Kasplat", Items.CrystalCavesDonkeyBlueprint, Types.Blueprint, [Maps.CrystalCaves, Kongs.donkey]),
    Locations.CavesDiddyKasplat: Location("Caves Diddy Kasplat", Items.CrystalCavesDiddyBlueprint, Types.Blueprint, [Maps.CrystalCaves, Kongs.diddy]),
    Locations.CavesLankyKasplat: Location("Caves Lanky Kasplat", Items.CrystalCavesLankyBlueprint, Types.Blueprint, [Maps.CrystalCaves, Kongs.lanky]),
    Locations.CavesTinyKasplat: Location("Caves Tiny Kasplat", Items.CrystalCavesTinyBlueprint, Types.Blueprint, [Maps.CrystalCaves, Kongs.tiny]),
    ...
    Locations.CavesChunkyKasplat: Location("Caves Chunky Kasplat", Items.CrystalCavesChunkyBlueprint, Types.Blueprint, [Maps.CrystalCaves, Kongs.chunky]),
    ...
    Locations.CastleLankyKasplat: Location("Castle Lanky Kasplat", Items.CreepyCastleLankyBlueprint, Types.Blueprint, [Maps.CreepyCastle, Kongs.lanky]),
    Locations.CastleTinyKasplat: Location("Castle Tiny Kasplat", Items.CreepyCastleTinyBlueprint, Types.Blueprint, [Maps.CreepyCastle, Kongs.tiny]),
    ...
    Locations.CastleDonkeyKasplat: Location("Castle Donkey Kasplat", Items.CreepyCastleDonkeyBlueprint, Types.Blueprint, [Maps.CastleTree, Kongs.donkey]),
    ...
    Locations.CastleDiddyKasplat: Location("Castle Diddy Kasplat", Items.CreepyCastleDiddyBlueprint, Types.Blueprint, [Maps.CastleLowerCave, Kongs.diddy]),
    ...
    Locations.CastleChunkyKasplat: Location("Castle Chunky Kasplat", Items.CreepyCastleChunkyBlueprint, Types.Blueprint, [Maps.CastleUpperCave, Kongs.chunky]),
