...
LocationList = {
    ...
    Locations.IslesDonkeyJapesRock: Location("Isles Donkey Japes Rock", Items.GoldenBanana, Types.Banana, Kongs.any),  # Can be assigned to other kongs
    Locations.IslesTinyCagedBanana: Location("Isles Tiny Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.IslesTinyInstrumentPad: Location("Isles Tiny Instrument Pad", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.IslesLankyCagedBanana: Location("Isles Lanky Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.IslesChunkyCagedBanana: Location("Isles Chunky Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.IslesChunkyInstrumentPad: Location("Isles Chunky Instrument Pad", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.IslesChunkyPoundtheX: Location("Isles Chunky Pound the X", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.RarewareBanana: Location("Rareware Banana", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.IslesLankyInstrumentPad: Location("Isles Lanky Instrument Pad", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.IslesTinyAztecLobby: Location("Isles Tiny Aztec Lobby", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.IslesDonkeyCagedBanana: Location("Isles Donkey Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.IslesDiddySnidesLobby: Location("Isles Diddy Snides Lobby", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.IslesBattleArena1: Location("Isles Battle Arena 1", Items.BattleCrown, Types.Crown, Kongs.any),
    Locations.IslesDonkeyInstrumentPad: Location("Isles Donkey Instrument Pad", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    ...
    Locations.IslesTinyGalleonLobby: Location("Isles Tiny Galleon Lobby", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    ...
    Locations.IslesDiddyCagedBanana: Location("Isles Diddy Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.IslesDiddySummit: Location("Isles Diddy Summit", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.IslesBattleArena2: Location("Isles Battle Arena 2", Items.BattleCrown, Types.Crown, Kongs.chunky),
    Locations.IslesBananaFairyForestLobby: Location("Isles Banana Fairy Forest Lobby", Items.BananaFairy, Types.Fairy),
    Locations.IslesDonkeyLavaBanana: Location("Isles Donkey Lava Banana", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.IslesDiddyInstrumentPad: Location("Isles Diddy Instrument Pad", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    ...
    Locations.IslesLankyCastleLobby: Location("Isles Lanky Castle Lobby", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    ...
    Locations.IslesChunkyHelmLobby: Location("Isles Chunky Helm Lobby", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.JapesDonkeyMedal: Location("Japes Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.JapesDiddyMedal: Location("Japes Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.JapesLankyMedal: Location("Japes Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.JapesTinyMedal: Location("Japes Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.JapesChunkyMedal: Location("Japes Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.DiddyKong: Location("Diddy Kong", Items.Diddy, Types.Kong),
    Locations.JapesDonkeyFrontofCage: Location("Japes Donkey Front of Cage", Items.GoldenBanana, Types.Banana, Kongs.any),  # Can be assigned to other kongs
    Locations.JapesDonkeyFreeDiddy: Location("Japes Donkey Free Diddy", Items.GoldenBanana, Types.Banana, Kongs.any),  # Can be assigned to other kongs
    Locations.JapesDonkeyCagedBanana: Location("Japes Donkey Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.JapesDonkeyBaboonBlast: Location("Japes Donkey Baboon Blast", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.JapesDiddyCagedBanana: Location("Japes Diddy Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.JapesDiddyMountain: Location("Japes Diddy Mountain", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.JapesLankyCagedBanana: Location("Japes Lanky Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.JapesTinyCagedBanana: Location("Japes Tiny Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.JapesChunkyBoulder: Location("Japes Chunky Boulder", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.JapesChunkyCagedBanana: Location("Japes Chunky Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.JapesBattleArena: Location("Japes Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any),
    Locations.JapesDiddyTunnel: Location("Japes Diddy Tunnel", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.JapesLankyGrapeGate: Location("Japes Lanky Grape Gate", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.JapesTinyFeatherGateBarrel: Location("Japes Tiny Feather Gate Barrel", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    ...
    Locations.JapesTinyStump: Location("Japes Tiny Stump", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.JapesChunkyGiantBonusBarrel: Location("Japes Chunky Giant Bonus Barrel", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.JapesTinyBeehive: Location("Japes Tiny Beehive", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.JapesLankySlope: Location("Japes Lanky Slope", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    ...
    Locations.JapesLankyFairyCave: Location("Japes Lanky Fairy Cave", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.JapesBananaFairyLankyCave: Location("Japes Banana Fairy Lanky Cave", Items.BananaFairy, Types.Fairy),
    Locations.JapesDiddyMinecarts: Location("Japes Diddy Minecarts", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.JapesChunkyUnderground: Location("Japes Chunky Underground", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.JapesKey: Location("Japes Boss Defeated", Items.JungleJapesKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    # Angry Aztec
    Locations.AztecDonkeyMedal: Location("Aztec Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.AztecDiddyMedal: Location("Aztec Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.AztecLankyMedal: Location("Aztec Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.AztecTinyMedal: Location("Aztec Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.AztecChunkyMedal: Location("Aztec Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.AztecDonkeyFreeLlama: Location("Aztec Donkey Free Llama", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.AztecChunkyVases: Location("Aztec Chunky Vases", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.AztecTinyKlaptrapRoom: Location("Aztec Tiny Klaptrap Room", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.AztecChunkyKlaptrapRoom: Location("Aztec Chunky Klaptrap Room", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TinyKong: Location("Tiny Kong", Items.Tiny, Types.Kong),
    Locations.AztecDiddyFreeTiny: Location("Aztec Diddy Free Tiny", Items.GoldenBanana, Types.Banana, Kongs.any),  # Can be assigned to other kongs
    Locations.AztecLankyVulture: Location("Aztec Lanky Vulture", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.AztecBattleArena: Location("Aztec Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any),
    Locations.AztecDonkeyQuicksandCave: Location("Aztec Donkey Quicksand Cave", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.AztecDiddyRamGongs: Location("Aztec Diddy Ram Gongs", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.AztecDiddyVultureRace: Location("Aztec Diddy Vulture Race", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.AztecChunkyCagedBarrel: Location("Aztec Chunky Caged Barrel", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.AztecDonkey5DoorTemple: Location("Aztec Donkey 5 Door Temple", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.AztecDiddy5DoorTemple: Location("Aztec Diddy 5 Door Temple", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.AztecLanky5DoorTemple: Location("Aztec Lanky 5 Door Temple", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.AztecTiny5DoorTemple: Location("Aztec Tiny 5 Door Temple", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.AztecBananaFairyTinyTemple: Location("Aztec Banana Fairy Tiny Temple", Items.BananaFairy, Types.Fairy),
    Locations.AztecChunky5DoorTemple: Location("Aztec Chunky 5 Door Temple", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.AztecTinyBeetleRace: Location("Aztec Tiny Beetle Race", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.LankyKong: Location("Lanky Kong", Items.Lanky, Types.Kong),
    Locations.AztecDonkeyFreeLanky: Location("Aztec Donkey Free Lanky", Items.GoldenBanana, Types.Banana, Kongs.any),  # Can be assigned to other kongs
    Locations.AztecLankyLlamaTempleBarrel: Location("Aztec Lanky Llama Temple Barrel", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.AztecLankyMatchingGame: Location("Aztec Lanky Matching Game", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.AztecBananaFairyLlamaTemple: Location("Aztec Banana Fairy Llama Temple", Items.BananaFairy, Types.Fairy),
    Locations.AztecTinyLlamaTemple: Location("Aztec Tiny Llama Temple", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    ...
    Locations.AztecKey: Location("Aztec Boss Defeated", Items.AngryAztecKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    # Frantic Factory locations
    Locations.FactoryDonkeyMedal: Location("Factory Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.FactoryDiddyMedal: Location("Factory Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.FactoryLankyMedal: Location("Factory Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.FactoryTinyMedal: Location("Factory Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.FactoryChunkyMedal: Location("Factory Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.FactoryDonkeyNumberGame: Location("Factory Donkey Number Game", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.FactoryDiddyBlockTower: Location("Factory Diddy Block Tower", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.FactoryLankyTestingRoomBarrel: Location("Factory Lanky Testing Room Barrel", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.FactoryTinyDartboard: Location("Factory Tiny Dartboard", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    ...
    Locations.FactoryDiddyRandD: Location("Factory Diddy R&D", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.FactoryLankyRandD: Location("Factory Lanky R&D", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.FactoryChunkyRandD: Location("Factory Chunky R&D", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.FactoryBattleArena: Location("Factory Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any),
    Locations.FactoryTinyCarRace: Location("Factory Tiny Car Race", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.FactoryDiddyChunkyRoomBarrel: Location("Factory Diddy Chunky Room Barrel", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.FactoryDonkeyPowerHut: Location("Factory Donkey Power Hut", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.ChunkyKong: Location("Chunky Kong", Items.Chunky, Types.Kong),
    Locations.NintendoCoin: Location("Nintendo Coin", Items.NintendoCoin, Types.Coin, Kongs.donkey),
    Locations.FactoryDonkeyDKArcade: Location("Factory Donkey DK Arcade", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.FactoryLankyFreeChunky: Location("Factory Lanky Free Chunky", Items.GoldenBanana, Types.Banana, Kongs.any),  # Can be assigned to other kongs
    Locations.FactoryTinybyArcade: Location("Factory Tiny by Arcade", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.FactoryChunkyDarkRoom: Location("Factory Chunky Dark Room", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.FactoryChunkybyArcade: Location("Factory Chunky by Arcade", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.FactoryDonkeyCrusherRoom: Location("Factory Donkey Crusher Room", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.FactoryDiddyProductionRoom: Location("Factory Diddy Production Room", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.FactoryLankyProductionRoom: Location("Factory Lanky Production Room", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.FactoryTinyProductionRoom: Location("Factory Tiny Production Room", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.FactoryChunkyProductionRoom: Location("Factory Chunky Production Room", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.FactoryKey: Location("Factory Boss Defeated", Items.FranticFactoryKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    # Gloomy Galleon locations
    Locations.GalleonDonkeyMedal: Location("Galleon Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.GalleonDiddyMedal: Location("Galleon Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.GalleonLankyMedal: Location("Galleon Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.GalleonTinyMedal: Location("Galleon Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.GalleonChunkyMedal: Location("Galleon Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.GalleonChunkyChest: Location("Galleon Chunky Chest", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.GalleonBattleArena: Location("Galleon Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any),
    Locations.GalleonBananaFairybyCranky: Location("Galleon Banana Fairy by Cranky", Items.BananaFairy, Types.Fairy),
    Locations.GalleonChunkyCannonGame: Location("Galleon Chunky Cannon Game", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.GalleonDiddyShipSwitch: Location("Galleon Diddy Ship Switch", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.GalleonLankyEnguardeChest: Location("Galleon Lanky Enguarde Chest", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    ...
    Locations.GalleonDonkeyLighthouse: Location("Galleon Donkey Lighthouse", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.GalleonTinyPearls: Location("Galleon Tiny Pearls", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.GalleonChunkySeasick: Location("Galleon Chunky Seasick", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.GalleonDonkeyFreetheSeal: Location("Galleon Donkey Free the Seal", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    ...
    Locations.GalleonDonkeySealRace: Location("Galleon Donkey Seal Race", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.GalleonDiddyGoldTower: Location("Galleon Diddy Gold Tower", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.GalleonLankyGoldTower: Location("Galleon Lanky Gold Tower", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    ...
    Locations.GalleonTinySubmarine: Location("Galleon Tiny Submarine", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.GalleonDiddyMechafish: Location("Galleon Diddy Mechafish", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.GalleonLanky2DoorShip: Location("Galleon Lanky 2 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.GalleonTiny2DoorShip: Location("Galleon Tiny 2 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.GalleonDonkey5DoorShip: Location("Galleon Donkey 5 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.GalleonDiddy5DoorShip: Location("Galleon Diddy 5 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.GalleonLanky5DoorShip: Location("Galleon Lanky 5 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.GalleonTiny5DoorShip: Location("Galleon Tiny 5 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.GalleonBananaFairy5DoorShip: Location("Galleon Banana Fairy 5 Door Ship", Items.BananaFairy, Types.Fairy),
    Locations.GalleonChunky5DoorShip: Location("Galleon Chunky 5 Door Ship", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.GalleonKey: Location("Galleon Boss Defeated", Items.GloomyGalleonKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    # Fungi Forest locations
    Locations.ForestDonkeyMedal: Location("Forest Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.ForestDiddyMedal: Location("Forest Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.ForestLankyMedal: Location("Forest Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.ForestTinyMedal: Location("Forest Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.ForestChunkyMedal: Location("Forest Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.ForestChunkyMinecarts: Location("Forest Chunky Minecarts", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.ForestDiddyTopofMushroom: Location("Forest Diddy Top of Mushroom", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.ForestTinyMushroomBarrel: Location("Forest Tiny Mushroom Barrel", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.ForestDonkeyBaboonBlast: Location("Forest Donkey Baboon Blast", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    ...
    Locations.ForestDonkeyMushroomCannons: Location("Forest Donkey Mushroom Cannons", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    ...
    Locations.ForestBattleArena: Location("Forest Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any),
    Locations.ForestChunkyFacePuzzle: Location("Forest Chunky Face Puzzle", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.ForestLankyZingers: Location("Forest Lanky Zingers", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.ForestLankyColoredMushrooms: Location("Forest Lanky Colored Mushrooms", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.ForestDiddyOwlRace: Location("Forest Diddy Owl Race", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.ForestLankyRabbitRace: Location("Forest Lanky Rabbit Race", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    ...
    Locations.ForestTinyAnthill: Location("Forest Tiny Anthill", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.ForestDonkeyMill: Location("Forest Donkey Mill", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.ForestDiddyCagedBanana: Location("Forest Diddy Caged Banana", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.ForestTinySpiderBoss: Location("Forest Tiny Spider Boss", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.ForestChunkyKegs: Location("Forest Chunky Kegs", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.ForestDiddyRafters: Location("Forest Diddy Rafters", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.ForestBananaFairyRafters: Location("Forest Banana Fairy Rafters", Items.BananaFairy, Types.Fairy),
    Locations.ForestLankyAttic: Location("Forest Lanky Attic", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    ...
    Locations.ForestDonkeyBarn: Location("Forest Donkey Barn", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.ForestBananaFairyThornvines: Location("Forest Banana Fairy Thornvines", Items.BananaFairy, Types.Fairy),
    Locations.ForestTinyBeanstalk: Location("Forest Tiny Beanstalk", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.ForestChunkyApple: Location("Forest Chunky Apple", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.ForestKey: Location("Forest Boss Defeated", Items.FungiForestKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    # Crystal Caves locations
    Locations.CavesDonkeyMedal: Location("Caves Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.CavesDiddyMedal: Location("Caves Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.CavesLankyMedal: Location("Caves Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.CavesTinyMedal: Location("Caves Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.CavesChunkyMedal: Location("Caves Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.CavesDonkeyBaboonBlast: Location("Caves Donkey Baboon Blast", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CavesDiddyJetpackBarrel: Location("Caves Diddy Jetpack Barrel", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CavesTinyCaveBarrel: Location("Caves Tiny Cave Barrel", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CavesTinyMonkeyportIgloo: Location("Caves Tiny Monkeyport Igloo", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CavesChunkyGorillaGone: Location("Caves Chunky Gorilla Gone", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.CavesLankyBeetleRace: Location("Caves Lanky Beetle Race", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CavesLankyCastle: Location("Caves Lanky Castle", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CavesChunkyTransparentIgloo: Location("Caves Chunky Transparent Igloo", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.CavesDonkey5DoorIgloo: Location("Caves Donkey 5 Door Igloo", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CavesDiddy5DoorIgloo: Location("Caves Diddy 5 Door Igloo", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CavesLanky5DoorIgloo: Location("Caves Lanky 5 Door Igloo", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CavesTiny5DoorIgloo: Location("Caves Tiny 5 Door Igloo", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CavesBananaFairyIgloo: Location("Caves Banana Fairy Igloo", Items.BananaFairy, Types.Fairy),
    Locations.CavesChunky5DoorIgloo: Location("Caves Chunky 5 Door Igloo", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.CavesDonkeyRotatingCabin: Location("Caves Donkey Rotating Cabin", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CavesBattleArena: Location("Caves Battle Arena", Items.BattleCrown, Types.Crown, Kongs.donkey),
    Locations.CavesDonkey5DoorCabin: Location("Caves Donkey 5 Door Cabin", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CavesDiddy5DoorCabinLower: Location("Caves Diddy 5 Door Cabin Lower", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CavesDiddy5DoorCabinUpper: Location("Caves Diddy 5 Door Cabin Upper", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CavesBananaFairyCabin: Location("Caves Banana Fairy Cabin", Items.BananaFairy, Types.Fairy),
    Locations.CavesLanky1DoorCabin: Location("Caves Lanky 1 Door Cabin", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CavesTiny5DoorCabin: Location("Caves Tiny 5 Door Cabin", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CavesChunky5DoorCabin: Location("Caves Chunky 5 Door Cabin", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.CavesKey: Location("Caves Boss Defeated", Items.CrystalCavesKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    # Creepy Castle locations
    Locations.CastleDonkeyMedal: Location("Castle Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.CastleDiddyMedal: Location("Castle Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    Locations.CastleLankyMedal: Location("Castle Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.CastleTinyMedal: Location("Castle Tiny Medal", Items.BananaMedal, Types.Medal, Kongs.tiny),
    Locations.CastleChunkyMedal: Location("Castle Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.CastleDiddyAboveCastle: Location("Castle Diddy Above Castle", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    ...
    Locations.CastleDonkeyTree: Location("Castle Donkey Tree", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CastleChunkyTree: Location("Castle Chunky Tree", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.CastleDonkeyLibrary: Location("Castle Donkey Library", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CastleDiddyBallroom: Location("Castle Diddy Ballroom", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CastleBananaFairyBallroom: Location("Castle Banana Fairy Ballroom", Items.BananaFairy, Types.Fairy),
    Locations.CastleTinyCarRace: Location("Castle Tiny Car Race", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CastleLankyTower: Location("Castle Lanky Tower", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CastleLankyGreenhouse: Location("Castle Lanky Greenhouse", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CastleBattleArena: Location("Castle Battle Arena", Items.BattleCrown, Types.Crown, Kongs.lanky),
    Locations.CastleTinyTrashCan: Location("Castle Tiny Trash Can", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CastleChunkyShed: Location("Castle Chunky Shed", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.CastleChunkyMuseum: Location("Castle Chunky Museum", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    ...
    Locations.CastleDiddyCrypt: Location("Castle Diddy Crypt", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CastleChunkyCrypt: Location("Castle Chunky Crypt", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.CastleDonkeyMinecarts: Location("Castle Donkey Minecarts", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CastleLankyMausoleum: Location("Castle Lanky Mausoleum", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CastleTinyMausoleum: Location("Castle Tiny Mausoleum", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.CastleTinyOverChasm: Location("Castle Tiny Over Chasm", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    ...
    Locations.CastleDonkeyDungeon: Location("Castle Donkey Dungeon", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.CastleDiddyDungeon: Location("Castle Diddy Dungeon", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.CastleLankyDungeon: Location("Castle Lanky Dungeon", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.CastleKey: Location("Castle Boss Defeated", Items.CreepyCastleKey, Types.Key, Kongs.any),  # Can be assigned to any kong
    ...
    Locations.HelmBattleArena: Location("Helm Battle Arena", Items.BattleCrown, Types.Crown, Kongs.diddy),
    Locations.HelmDonkeyMedal: Location("Helm Donkey Medal", Items.BananaMedal, Types.Medal, Kongs.donkey),
    Locations.HelmChunkyMedal: Location("Helm Chunky Medal", Items.BananaMedal, Types.Medal, Kongs.chunky),
    Locations.HelmTinyMedal: Location("Helm Tiny Medal", Items.BananaMedal, Types.Medal),
    Locations.HelmLankyMedal: Location("Helm Lanky Medal", Items.BananaMedal, Types.Medal, Kongs.lanky),
    Locations.HelmDiddyMedal: Location("Helm Diddy Medal", Items.BananaMedal, Types.Medal, Kongs.diddy),
    ...
    Locations.HelmKey: Location("Helm Key", Items.HideoutHelmKey, Types.Constant, Kongs.any),
    ...
    # Blueprints
    Locations.TurnInDKIslesDonkeyBlueprint: Location("Turn In DK Isles Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInDKIslesDiddyBlueprint: Location("Turn In DK Isles Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInDKIslesLankyBlueprint: Location("Turn In DK Isles Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInDKIslesTinyBlueprint: Location("Turn In DK Isles Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInDKIslesChunkyBlueprint: Location("Turn In DK Isles Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInJungleJapesDonkeyBlueprint: Location("Turn In Jungle Japes Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInJungleJapesDiddyBlueprint: Location("Turn In Jungle Japes Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInJungleJapesLankyBlueprint: Location("Turn In Jungle Japes Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInJungleJapesTinyBlueprint: Location("Turn In Jungle Japes Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInJungleJapesChunkyBlueprint: Location("Turn In Jungle Japes Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInAngryAztecDonkeyBlueprint: Location("Turn In Angry Aztec Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInAngryAztecDiddyBlueprint: Location("Turn In Angry Aztec Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInAngryAztecLankyBlueprint: Location("Turn In Angry Aztec Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInAngryAztecTinyBlueprint: Location("Turn In Angry Aztec Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInAngryAztecChunkyBlueprint: Location("Turn In Angry Aztec Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInFranticFactoryDonkeyBlueprint: Location("Turn In Frantic Factory Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInFranticFactoryDiddyBlueprint: Location("Turn In Frantic Factory Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInFranticFactoryLankyBlueprint: Location("Turn In Frantic Factory Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInFranticFactoryTinyBlueprint: Location("Turn In Frantic Factory Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInFranticFactoryChunkyBlueprint: Location("Turn In Frantic Factory Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInGloomyGalleonDonkeyBlueprint: Location("Turn In Gloomy Galleon Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInGloomyGalleonDiddyBlueprint: Location("Turn In Gloomy Galleon Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInGloomyGalleonLankyBlueprint: Location("Turn In Gloomy Galleon Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInGloomyGalleonTinyBlueprint: Location("Turn In Gloomy Galleon Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInGloomyGalleonChunkyBlueprint: Location("Turn In Gloomy Galleon Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInFungiForestDonkeyBlueprint: Location("Turn In Fungi Forest Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInFungiForestDiddyBlueprint: Location("Turn In Fungi Forest Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInFungiForestLankyBlueprint: Location("Turn In Fungi Forest Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInFungiForestTinyBlueprint: Location("Turn In Fungi Forest Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInFungiForestChunkyBlueprint: Location("Turn In Fungi Forest Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInCrystalCavesDonkeyBlueprint: Location("Turn In Crystal Caves Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInCrystalCavesDiddyBlueprint: Location("Turn In Crystal Caves Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInCrystalCavesLankyBlueprint: Location("Turn In Crystal Caves Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInCrystalCavesTinyBlueprint: Location("Turn In Crystal Caves Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInCrystalCavesChunkyBlueprint: Location("Turn In Crystal Caves Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
    Locations.TurnInCreepyCastleDonkeyBlueprint: Location("Turn In Creepy Castle Donkey Blueprint", Items.GoldenBanana, Types.Banana, Kongs.donkey),
    Locations.TurnInCreepyCastleDiddyBlueprint: Location("Turn In Creepy Castle Diddy Blueprint", Items.GoldenBanana, Types.Banana, Kongs.diddy),
    Locations.TurnInCreepyCastleLankyBlueprint: Location("Turn In Creepy Castle Lanky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.lanky),
    Locations.TurnInCreepyCastleTinyBlueprint: Location("Turn In Creepy Castle Tiny Blueprint", Items.GoldenBanana, Types.Banana, Kongs.tiny),
    Locations.TurnInCreepyCastleChunkyBlueprint: Location("Turn In Creepy Castle Chunky Blueprint", Items.GoldenBanana, Types.Banana, Kongs.chunky),
}
