...
class MapIDCombo:
    ...
    def __init__(self, map=None, id=None, flag=None, obj_type="modeltwo"):
...
LocationList = {
    ...
    Locations.IslesTinyInstrumentPad: Location("Isles Tiny Instrument Pad", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 425)]),
    ...
    Locations.IslesChunkyInstrumentPad: Location("Isles Chunky Instrument Pad", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 424)]),
    ...
    Locations.IslesLankyInstrumentPad: Location("Isles Lanky Instrument Pad", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 398)]),
    Locations.IslesTinyAztecLobby: Location("Isles Tiny Aztec Lobby", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 402)]),
    ...
    Locations.IslesDiddySnidesLobby: Location("Isles Diddy Snides Lobby", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 416)]),
    ...
    Locations.IslesDonkeyInstrumentPad: Location("Isles Donkey Instrument Pad", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 404)]),
    ...
    Locations.IslesDiddySummit: Location("Isles Diddy Summit", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 428)]),
    ...
    Locations.IslesDiddyInstrumentPad: Location("Isles Diddy Instrument Pad", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 410)]),
    ...
    Locations.IslesLankyCastleLobby: Location("Isles Lanky Castle Lobby", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 415)]),
    ...
    Locations.IslesChunkyHelmLobby: Location("Isles Chunky Helm Lobby", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 406)]),
    ...
    Locations.JapesDonkeyFrontofCage: Location("Japes Donkey Front of Cage", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x69, 4)]),
    Locations.JapesDonkeyFreeDiddy: Location("Japes Donkey Free Diddy", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x48, 5)]),
    Locations.JapesDonkeyCagedBanana: Location("Japes Donkey Caged Banana", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x44, 20)]),
    Locations.JapesDonkeyBaboonBlast: Location("Japes Donkey Baboon Blast", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JapesBaboonBlast, 1, 3)]),
    Locations.JapesDiddyCagedBanana: Location("Japes Diddy Caged Banana", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x4D, 18)]),
    Locations.JapesDiddyMountain: Location("Japes Diddy Mountain", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x52, 23)]),
    Locations.JapesLankyCagedBanana: Location("Japes Lanky Caged Banana", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x4F, 19)]),
    Locations.JapesTinyCagedBanana: Location("Japes Tiny Caged Banana", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x4C, 21)]),
    Locations.JapesChunkyBoulder: Location("Japes Chunky Boulder", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 25)]),
    Locations.JapesChunkyCagedBanana: Location("Japes Chunky Caged Banana", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x50, 22)]),
    Locations.JapesBattleArena: Location("Japes Battle Arena", Items.BattleCrown, Types.Crown, [MapIDCombo(Maps.JapesCrown, -1, 609)]),
    Locations.JapesDiddyTunnel: Location("Japes Diddy Tunnel", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x1E, 31)]),
    Locations.JapesLankyGrapeGate: Location("Japes Lanky Grape Gate", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 1)]),
    Locations.JapesTinyFeatherGateBarrel: Location("Japes Tiny Feather Gate Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 2)]),
    ...
    Locations.JapesTinyStump: Location("Japes Tiny Stump", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JungleJapes, 0x68, 8)]),
    Locations.JapesChunkyGiantBonusBarrel: Location("Japes Chunky Giant Bonus Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 28)]),
    Locations.JapesTinyBeehive: Location("Japes Tiny Beehive", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JapesTinyHive, 0x3F, 9)]),
    Locations.JapesLankySlope: Location("Japes Lanky Slope", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 11)]),
    ...
    Locations.JapesLankyFairyCave: Location("Japes Lanky Fairy Cave", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JapesLankyCave, 0x4, 10)]),
    Locations.JapesBananaFairyLankyCave: Location("Japes Banana Fairy Lanky Cave", Items.BananaFairy, Types.Fairy),
    Locations.JapesDiddyMinecarts: Location("Japes Diddy Minecarts", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 24)]),
    Locations.JapesChunkyUnderground: Location("Japes Chunky Underground", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.JapesUnderGround, 0x3, 12)]),
    ...
    Locations.AztecDonkeyFreeLlama: Location("Aztec Donkey Free Llama", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AngryAztec, 0x26, 51)]),
    Locations.AztecChunkyVases: Location("Aztec Chunky Vases", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AngryAztec, 0x23, 49)]),
    ...
    Locations.AztecTinyKlaptrapRoom: Location("Aztec Tiny Klaptrap Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecTinyTemple, 0x7E, 65)]),
    Locations.AztecChunkyKlaptrapRoom: Location("Aztec Chunky Klaptrap Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecTinyTemple, 0x9, 64)]),
    Locations.TinyKong: Location("Tiny Kong", Items.Tiny, Types.Kong),
    Locations.AztecDiddyFreeTiny: Location("Aztec Diddy Free Tiny", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecTinyTemple, 0x5B, 67)]),
    Locations.AztecLankyVulture: Location("Aztec Lanky Vulture", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 68)]),
    Locations.AztecBattleArena: Location("Aztec Battle Arena", Items.BattleCrown, Types.Crown, [MapIDCombo(Maps.AztecCrown, -1, 610)]),
    Locations.AztecDonkeyQuicksandCave: Location("Aztec Donkey Quicksand Cave", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 62)]),
    Locations.AztecDiddyRamGongs: Location("Aztec Diddy Ram Gongs", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AngryAztec, 0xA3, 54)]),
    Locations.AztecDiddyVultureRace: Location("Aztec Diddy Vulture Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AngryAztec, 0xEB, 63)]),
    Locations.AztecChunkyCagedBarrel: Location("Aztec Chunky Caged Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 52)]),
    ...
    Locations.AztecDonkey5DoorTemple: Location("Aztec Donkey 5 Door Temple", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecDonkey5DTemple, 0x6, 57)]),
    Locations.AztecDiddy5DoorTemple: Location("Aztec Diddy 5 Door Temple", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecDiddy5DTemple, 0x6, 56)]),
    Locations.AztecLanky5DoorTemple: Location("Aztec Lanky 5 Door Temple", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 60)]),
    Locations.AztecTiny5DoorTemple: Location("Aztec Tiny 5 Door Temple", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecTiny5DTemple, 0x6, 58)]),
    Locations.AztecBananaFairyTinyTemple: Location("Aztec Banana Fairy Tiny Temple", Items.BananaFairy, Types.Fairy),
    Locations.AztecChunky5DoorTemple: Location("Aztec Chunky 5 Door Temple", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 59)]),
    ...
    Locations.AztecTinyBeetleRace: Location("Aztec Tiny Beetle Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecTinyRace, 0x48, 75)]),
    Locations.LankyKong: Location("Lanky Kong", Items.Lanky, Types.Kong),
    Locations.AztecDonkeyFreeLanky: Location("Aztec Donkey Free Lanky", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecLlamaTemple, 0x6C, 77)]),
    Locations.AztecLankyLlamaTempleBarrel: Location("Aztec Lanky Llama Temple Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 73)]),
    Locations.AztecLankyMatchingGame: Location("Aztec Lanky Matching Game", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecLlamaTemple, 0x2B, 72)]),
    Locations.AztecBananaFairyLlamaTemple: Location("Aztec Banana Fairy Llama Temple", Items.BananaFairy, Types.Fairy),
    Locations.AztecTinyLlamaTemple: Location("Aztec Tiny Llama Temple", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.AztecLlamaTemple, 0xAA, 71)]),
    ...
    Locations.FactoryDonkeyNumberGame: Location("Factory Donkey Number Game", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x7E, 122)]),
    Locations.FactoryDiddyBlockTower: Location("Factory Diddy Block Tower", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 135)]),
    Locations.FactoryLankyTestingRoomBarrel: Location("Factory Lanky Testing Room Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 137)]),
    Locations.FactoryTinyDartboard: Location("Factory Tiny Dartboard", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x82, 124)]),
    ...
    Locations.FactoryDiddyRandD: Location("Factory Diddy R&D", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x60, 126)]),
    Locations.FactoryLankyRandD: Location("Factory Lanky R&D", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x3E, 125)]),
    Locations.FactoryChunkyRandD: Location("Factory Chunky R&D", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x7C, 127)]),
    ...
    Locations.FactoryTinyCarRace: Location("Factory Tiny Car Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FactoryTinyRace, 0x62, 139)]),
    Locations.FactoryDiddyChunkyRoomBarrel: Location("Factory Diddy Chunky Room Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 134)]),
    ...
    Locations.FactoryDonkeyDKArcade: Location("Factory Donkey DK Arcade", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x108, 130), MapIDCombo(Maps.FactoryBaboonBlast, 0, 130)]),
    Locations.FactoryLankyFreeChunky: Location("Factory Lanky Free Chunky", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x78, 118)]),
    Locations.FactoryTinybyArcade: Location("Factory Tiny by Arcade", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x23, 123)]),
    Locations.FactoryChunkyDarkRoom: Location("Factory Chunky Dark Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x63, 121)]),
    Locations.FactoryChunkybyArcade: Location("Factory Chunky by Arcade", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 136)]),
    ...
    Locations.FactoryDonkeyCrusherRoom: Location("Factory Donkey Crusher Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FactoryCrusher, 0x7, 128)]),
    Locations.FactoryDiddyProductionRoom: Location("Factory Diddy Production Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x2C, 113)]),
    Locations.FactoryLankyProductionRoom: Location("Factory Lanky Production Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x2A, 115)]),
    Locations.FactoryTinyProductionRoom: Location("Factory Tiny Production Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 116)]),
    Locations.FactoryChunkyProductionRoom: Location("Factory Chunky Production Room", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FranticFactory, 0x29, 114)]),
    ...
    Locations.GalleonChunkyChest: Location("Galleon Chunky Chest", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GloomyGalleon, 0xE, 182)]),
    ...
    Locations.GalleonChunkyCannonGame: Location("Galleon Chunky Cannon Game", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GloomyGalleon, 0x32, 154)]),
    ...
    Locations.GalleonDiddyShipSwitch: Location("Galleon Diddy Ship Switch", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GloomyGalleon, 0x2D, 204)]),
    Locations.GalleonLankyEnguardeChest: Location("Galleon Lanky Enguarde Chest", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GloomyGalleon, 0x6B, 192)]),
    ...
    Locations.GalleonDonkeyLighthouse: Location("Galleon Donkey Lighthouse", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GalleonLighthouse, 0x2F, 157)]),
    Locations.GalleonTinyPearls: Location("Galleon Tiny Pearls", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GalleonMermaidRoom, 0xE, 191)]),
    Locations.GalleonChunkySeasick: Location("Galleon Chunky Seasick", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GalleonSickBay, 0x6, 166)]),
    Locations.GalleonDonkeyFreetheSeal: Location("Galleon Donkey Free the Seal", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GloomyGalleon, 0x2E, 193)]),
    ...
    Locations.GalleonDonkeySealRace: Location("Galleon Donkey Seal Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GalleonSealRace, 0x3B, 165)]),
    Locations.GalleonDiddyGoldTower: Location("Galleon Diddy Gold Tower", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 163)]),
    Locations.GalleonLankyGoldTower: Location("Galleon Lanky Gold Tower", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 164)]),
    ...
    Locations.GalleonTinySubmarine: Location("Galleon Tiny Submarine", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 202)]),
    Locations.GalleonDiddyMechafish: Location("Galleon Diddy Mechafish", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.GalleonMechafish, 0xF, 167)]),
    Locations.GalleonLanky2DoorShip: Location("Galleon Lanky 2 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.Galleon2DShip, 0x0, 183)]),
    Locations.GalleonTiny2DoorShip: Location("Galleon Tiny 2 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 184)]),
    Locations.GalleonDonkey5DoorShip: Location("Galleon Donkey 5 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 200)]),
    Locations.GalleonDiddy5DoorShip: Location("Galleon Diddy 5 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 198)]),
    Locations.GalleonLanky5DoorShip: Location("Galleon Lanky 5 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.Galleon5DShipDiddyLankyChunky, 0xE, 199)]),
    Locations.GalleonTiny5DoorShip: Location("Galleon Tiny 5 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.Galleon5DShipDKTiny, 0x21, 201)]),
    Locations.GalleonBananaFairy5DoorShip: Location("Galleon Banana Fairy 5 Door Ship", Items.BananaFairy, Types.Fairy),
    Locations.GalleonChunky5DoorShip: Location("Galleon Chunky 5 Door Ship", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 197)]),
    ...
    Locations.ForestChunkyMinecarts: Location("Forest Chunky Minecarts", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 215)]),
    Locations.ForestDiddyTopofMushroom: Location("Forest Diddy Top of Mushroom", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 211)]),
    Locations.ForestTinyMushroomBarrel: Location("Forest Tiny Mushroom Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 227)]),
    ...
    Locations.ForestDonkeyMushroomCannons: Location("Forest Donkey Mushroom Cannons", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestGiantMushroom, 0x3, 228)]),
    ...
    Locations.ForestChunkyFacePuzzle: Location("Forest Chunky Face Puzzle", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestChunkyFaceRoom, 0x2, 225)]),
    Locations.ForestLankyZingers: Location("Forest Lanky Zingers", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestLankyZingersRoom, 0x0, 226)]),
    Locations.ForestLankyColoredMushrooms: Location("Forest Lanky Colored Mushrooms", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 224)]),
    Locations.ForestDiddyOwlRace: Location("Forest Diddy Owl Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 250)]),
    ...
    Locations.ForestTinyAnthill: Location("Forest Tiny Anthill", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestAnthill, 0x0, 205)]),
    Locations.ForestDonkeyMill: Location("Forest Donkey Mill", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FungiForest, 0x2B, 219), MapIDCombo(Maps.ForestMillFront, 0xA, 219)]),
    Locations.ForestDiddyCagedBanana: Location("Forest Diddy Caged Banana", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FungiForest, 0x28, 214)]),
    Locations.ForestTinySpiderBoss: Location("Forest Tiny Spider Boss", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestSpider, 0x1, 247)]),
    Locations.ForestChunkyKegs: Location("Forest Chunky Kegs", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestMillFront, 0xD, 221)]),
    Locations.ForestDiddyRafters: Location("Forest Diddy Rafters", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestRafters, 0x3, 216)]),
    Locations.ForestBananaFairyRafters: Location("Forest Banana Fairy Rafters", Items.BananaFairy, Types.Fairy),
    Locations.ForestLankyAttic: Location("Forest Lanky Attic", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.ForestMillAttic, 0x2, 217)]),
    ...
    Locations.ForestDonkeyBarn: Location("Forest Donkey Barn", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 235)]),
    Locations.ForestBananaFairyThornvines: Location("Forest Banana Fairy Thornvines", Items.BananaFairy, Types.Fairy),
    Locations.ForestTinyBeanstalk: Location("Forest Tiny Beanstalk", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FungiForest, 0x50, 209)]),
    Locations.ForestChunkyApple: Location("Forest Chunky Apple", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.FungiForest, 0x3E, 253)]),
    ...
    Locations.CavesDonkeyBaboonBlast: Location("Caves Donkey Baboon Blast", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CrystalCaves, 0x32, 298)]),
    Locations.CavesDiddyJetpackBarrel: Location("Caves Diddy Jetpack Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 294)]),
    Locations.CavesTinyCaveBarrel: Location("Caves Tiny Cave Barrel", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 295)]),
    Locations.CavesTinyMonkeyportIgloo: Location("Caves Tiny Monkeyport Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CrystalCaves, 0x29, 297)]),
    Locations.CavesChunkyGorillaGone: Location("Caves Chunky Gorilla Gone", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CrystalCaves, 0x3E, 268)]),
    ...
    Locations.CavesLankyBeetleRace: Location("Caves Lanky Beetle Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesLankyRace, 0x1, 259)]),
    Locations.CavesLankyCastle: Location("Caves Lanky Castle", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesFrozenCastle, 0x10, 271)]),
    Locations.CavesChunkyTransparentIgloo: Location("Caves Chunky Transparent Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CrystalCaves, 0x28, 270)]),
    ...
    Locations.CavesDonkey5DoorIgloo: Location("Caves Donkey 5 Door Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesDonkeyIgloo, 0x1, 275)]),
    Locations.CavesDiddy5DoorIgloo: Location("Caves Diddy 5 Door Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesDiddyIgloo, 0x1, 274)]),
    Locations.CavesLanky5DoorIgloo: Location("Caves Lanky 5 Door Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesLankyIgloo, 0x3, 281)]),
    Locations.CavesTiny5DoorIgloo: Location("Caves Tiny 5 Door Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesTinyIgloo, 0x2, 279)]),
    Locations.CavesBananaFairyIgloo: Location("Caves Banana Fairy Igloo", Items.BananaFairy, Types.Fairy),
    Locations.CavesChunky5DoorIgloo: Location("Caves Chunky 5 Door Igloo", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesChunkyIgloo, 0x0, 278)]),
    Locations.CavesDonkeyRotatingCabin: Location("Caves Donkey Rotating Cabin", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesRotatingCabin, 0x1, 276)]),
    Locations.CavesBattleArena: Location("Caves Battle Arena", Items.BattleCrown, Types.Crown, [MapIDCombo(Maps.CavesCrown, -1, 616)]),
    Locations.CavesDonkey5DoorCabin: Location("Caves Donkey 5 Door Cabin", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesDonkeyCabin, 0x8, 261)]),
    Locations.CavesDiddy5DoorCabinLower: Location("Caves Diddy 5 Door Cabin Lower", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesDiddyLowerCabin, 0x1, 262)]),
    Locations.CavesDiddy5DoorCabinUpper: Location("Caves Diddy 5 Door Cabin Upper", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesDiddyUpperCabin, 0x4, 293)]),
    Locations.CavesBananaFairyCabin: Location("Caves Banana Fairy Cabin", Items.BananaFairy, Types.Fairy),
    Locations.CavesLanky1DoorCabin: Location("Caves Lanky 1 Door Cabin", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesLankyCabin, 0x1, 264)]),
    Locations.CavesTiny5DoorCabin: Location("Caves Tiny 5 Door Cabin", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CavesTinyCabin, 0x0, 260)]),
    Locations.CavesChunky5DoorCabin: Location("Caves Chunky 5 Door Cabin", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 263)]),
    ...
    Locations.CastleDiddyAboveCastle: Location("Castle Diddy Above Castle", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 350)]),
    ...
    Locations.CastleDonkeyTree: Location("Castle Donkey Tree", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleTree, 0x8, 320)]),
    Locations.CastleChunkyTree: Location("Castle Chunky Tree", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 319)]),
    ...
    Locations.CastleDonkeyLibrary: Location("Castle Donkey Library", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleLibrary, 0x3, 313)]),
    Locations.CastleDiddyBallroom: Location("Castle Diddy Ballroom", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 305)]),
    Locations.CastleBananaFairyBallroom: Location("Castle Banana Fairy Ballroom", Items.BananaFairy, Types.Fairy),
    Locations.CastleTinyCarRace: Location("Castle Tiny Car Race", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleTinyRace, 0x1, 325)]),
    Locations.CastleLankyTower: Location("Castle Lanky Tower", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 306)]),
    Locations.CastleLankyGreenhouse: Location("Castle Lanky Greenhouse", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleGreenhouse, 0x1, 323)]),
    Locations.CastleBattleArena: Location("Castle Battle Arena", Items.BattleCrown, Types.Crown, [MapIDCombo(Maps.CastleCrown, -1, 617)]),
    Locations.CastleTinyTrashCan: Location("Castle Tiny Trash Can", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleTrashCan, 0x4, 351)]),
    Locations.CastleChunkyShed: Location("Castle Chunky Shed", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleShed, 0x6, 322)]),
    Locations.CastleChunkyMuseum: Location("Castle Chunky Museum", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleMuseum, 0x7, 314)]),
    ...
    Locations.CastleDiddyCrypt: Location("Castle Diddy Crypt", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleCrypt, 0x8, 310)]),
    Locations.CastleChunkyCrypt: Location("Castle Chunky Crypt", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 311)]),
    Locations.CastleDonkeyMinecarts: Location("Castle Donkey Minecarts", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 318)]),
    Locations.CastleLankyMausoleum: Location("Castle Lanky Mausoleum", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleMausoleum, 0x3, 308)]),
    Locations.CastleTinyMausoleum: Location("Castle Tiny Mausoleum", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleMausoleum, 0xD, 309)]),
    Locations.CastleTinyOverChasm: Location("Castle Tiny Over Chasm", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 315)]),
    ...
    Locations.CastleDonkeyDungeon: Location("Castle Donkey Dungeon", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleDungeon, 0xF, 326)]),
    Locations.CastleDiddyDungeon: Location("Castle Diddy Dungeon", Items.GoldenBanana, Types.Banana, [MapIDCombo(Maps.CastleDungeon, 0xD, 353)]),
    Locations.CastleLankyDungeon: Location("Castle Lanky Dungeon", Items.GoldenBanana, Types.Banana, [MapIDCombo(0, -1, 316)]),
