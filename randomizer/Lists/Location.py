...
LocationListOriginal = {
    ...
    # Balloons
    Locations.Balloon000: Location(Levels.JungleJapes, "Japes Balloon: Inside Mountain Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JapesMountain, -1, BALLOON_FLAG_START + 0)]),
	Locations.Balloon001: Location(Levels.JungleJapes, "Japes Balloon: In Cave", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 1)]),
	Locations.Balloon002: Location(Levels.JungleJapes, "Japes Balloon: By Snide", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 2)]),
	Locations.Balloon003: Location(Levels.JungleJapes, "Japes Balloon: In Cave (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 3)]),
	Locations.Balloon004: Location(Levels.JungleJapes, "Japes Balloon: By Lanky Hut", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 4)]),
	Locations.Balloon005: Location(Levels.JungleJapes, "Japes Balloon: By W5", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 5)]),
	Locations.Balloon006: Location(Levels.JungleJapes, "Japes Balloon: By Underground", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 6)]),
	Locations.Balloon007: Location(Levels.JungleJapes, "Japes Balloon: By Cranky", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 7)]),
	Locations.Balloon008: Location(Levels.JungleJapes, "Japes Balloon: By Tiny Hut", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 8)]),
	Locations.Balloon009: Location(Levels.JungleJapes, "Japes Balloon: In Fairy Room", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 9)]),
	Locations.Balloon010: Location(Levels.JungleJapes, "Japes Balloon: In Cave (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 10)]),
	Locations.Balloon011: Location(Levels.JungleJapes, "Japes Balloon: In Cave (3)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 11)]),
	Locations.Balloon012: Location(Levels.JungleJapes, "Japes Balloon: Storm Tunnel Side Room", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JungleJapes, -1, BALLOON_FLAG_START + 12)]),
	Locations.Balloon013: Location(Levels.JungleJapes, "Japes Balloon: In Shellhive", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JapesTinyHive, -1, BALLOON_FLAG_START + 13)]),
	Locations.Balloon014: Location(Levels.JungleJapes, "Japes Balloon: In Painting Room", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.JapesLankyCave, -1, BALLOON_FLAG_START + 14)]),
	Locations.Balloon015: Location(Levels.AngryAztec, "Aztec Balloon: Tiny Temple Kong Room (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, BALLOON_FLAG_START + 15)]),
	Locations.Balloon016: Location(Levels.AngryAztec, "Aztec Balloon: Tiny Temple Kong Room (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, BALLOON_FLAG_START + 16)]),
	Locations.Balloon017: Location(Levels.AngryAztec, "Aztec Balloon: Tiny Temple Vulture Room", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecTinyTemple, -1, BALLOON_FLAG_START + 17)]),
	Locations.Balloon018: Location(Levels.AngryAztec, "Aztec Balloon: Lava Llama Temple", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, BALLOON_FLAG_START + 18)]),
	Locations.Balloon019: Location(Levels.AngryAztec, "Aztec Balloon: Llama Temple Kong Room (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, BALLOON_FLAG_START + 19)]),
	Locations.Balloon020: Location(Levels.AngryAztec, "Aztec Balloon: Llama Temple Kong Room (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecLlamaTemple, -1, BALLOON_FLAG_START + 20)]),
	Locations.Balloon021: Location(Levels.AngryAztec, "Aztec Balloon: Diddy 5DT", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecDiddy5DTemple, -1, BALLOON_FLAG_START + 21)]),
	Locations.Balloon022: Location(Levels.AngryAztec, "Aztec Balloon: Lanky 5DT", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecLanky5DTemple, -1, BALLOON_FLAG_START + 22)]),
	Locations.Balloon023: Location(Levels.AngryAztec, "Aztec Balloon: Chunky 5DT (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, BALLOON_FLAG_START + 23)]),
	Locations.Balloon024: Location(Levels.AngryAztec, "Aztec Balloon: Chunky 5DT (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AztecChunky5DTemple, -1, BALLOON_FLAG_START + 24)]),
	Locations.Balloon025: Location(Levels.FranticFactory, "Factory Balloon: Hatch", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 25)]),
	Locations.Balloon026: Location(Levels.FranticFactory, "Factory Balloon: Balloon above Snide", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 26)]),
	Locations.Balloon027: Location(Levels.FranticFactory, "Factory Balloon: Balloon by F Key", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 27)]),
	Locations.Balloon028: Location(Levels.FranticFactory, "Factory Balloon: Balloon by Snide", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 28)]),
	Locations.Balloon029: Location(Levels.FranticFactory, "Factory Balloon: R&D Room (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 29)]),
	Locations.Balloon030: Location(Levels.FranticFactory, "Factory Balloon: R&D Room (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 30)]),
	Locations.Balloon031: Location(Levels.FranticFactory, "Factory Balloon: R&D Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 31)]),
	Locations.Balloon032: Location(Levels.FranticFactory, "Factory Balloon: Balloon in Cranky and Candy Area", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 32)]),
	Locations.Balloon033: Location(Levels.FranticFactory, "Factory Balloon: Balloon by Numbers Game", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 33)]),
	Locations.Balloon034: Location(Levels.FranticFactory, "Factory Balloon: R&D Room (3)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 34)]),
	Locations.Balloon035: Location(Levels.FranticFactory, "Factory Balloon: Production Room", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 35)]),
	Locations.Balloon036: Location(Levels.FranticFactory, "Factory Balloon: Balloon by Funky", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 36)]),
	Locations.Balloon037: Location(Levels.FranticFactory, "Factory Balloon: Production Room", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 37)]),
	Locations.Balloon038: Location(Levels.FranticFactory, "Factory Balloon: Toy monster", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FranticFactory, -1, BALLOON_FLAG_START + 38)]),
	Locations.Balloon039: Location(Levels.GloomyGalleon, "Galleon Balloon: Cactus Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 39)]),
	Locations.Balloon040: Location(Levels.GloomyGalleon, "Galleon Balloon: Diddy Kasplat Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 40)]),
	Locations.Balloon041: Location(Levels.GloomyGalleon, "Galleon Balloon: Crown Balloon (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 41)]),
	Locations.Balloon042: Location(Levels.GloomyGalleon, "Galleon Balloon: Crown Balloon (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 42)]),
	Locations.Balloon043: Location(Levels.GloomyGalleon, "Galleon Balloon: Cactus Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 43)]),
	Locations.Balloon044: Location(Levels.GloomyGalleon, "Galleon Balloon: Seal Cage Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 44)]),
	Locations.Balloon045: Location(Levels.GloomyGalleon, "Galleon Balloon: Balloon outside lighthouse", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 45)]),
	Locations.Balloon046: Location(Levels.GloomyGalleon, "Galleon Balloon: Chests Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 46)]),
	Locations.Balloon047: Location(Levels.GloomyGalleon, "Galleon Balloon: Gold tower Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 47)]),
	Locations.Balloon048: Location(Levels.GloomyGalleon, "Galleon Balloon: Cannon Game Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 48)]),
	Locations.Balloon049: Location(Levels.GloomyGalleon, "Galleon Balloon: 2DS Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 49)]),
	Locations.Balloon050: Location(Levels.GloomyGalleon, "Galleon Balloon: 5DS Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 50)]),
	Locations.Balloon051: Location(Levels.GloomyGalleon, "Galleon Balloon: Snide's Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 51)]),
	Locations.Balloon052: Location(Levels.GloomyGalleon, "Galleon Balloon: Gold tower Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GloomyGalleon, -1, BALLOON_FLAG_START + 52)]),
	Locations.Balloon053: Location(Levels.FranticFactory, "Factory Balloon: Crusher Room Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FactoryCrusher, -1, BALLOON_FLAG_START + 53)]),
	Locations.Balloon054: Location(Levels.AngryAztec, "Aztec Balloon: Cranky Balloon (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 54)]),
	Locations.Balloon055: Location(Levels.AngryAztec, "Aztec Balloon: W2 Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 55)]),
	Locations.Balloon056: Location(Levels.AngryAztec, "Aztec Balloon: Llama Temple Rear Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 56)]),
	Locations.Balloon057: Location(Levels.AngryAztec, "Aztec Balloon: Cranky Balloon (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 57)]),
	Locations.Balloon058: Location(Levels.AngryAztec, "Aztec Balloon: W5 Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.AngryAztec, -1, BALLOON_FLAG_START + 58)]),
	Locations.Balloon059: Location(Levels.FungiForest, "Forest Balloon: Snide's Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 59)]),
	Locations.Balloon060: Location(Levels.FungiForest, "Forest Balloon: Kasplat Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 60)]),
	Locations.Balloon061: Location(Levels.FungiForest, "Forest Balloon: Balloon Behind Barn", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 61)]),
	Locations.Balloon062: Location(Levels.FungiForest, "Forest Balloon: Kasplat Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 62)]),
	Locations.Balloon063: Location(Levels.FungiForest, "Forest Balloon: Behind DK Barn", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.FungiForest, -1, BALLOON_FLAG_START + 63)]),
	Locations.Balloon064: Location(Levels.GloomyGalleon, "Galleon Balloon: Lighthouse Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.GalleonLighthouse, -1, BALLOON_FLAG_START + 64)]),
	Locations.Balloon065: Location(Levels.FungiForest, "Forest Balloon: Attic Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.ForestWinchRoom, -1, BALLOON_FLAG_START + 65)]),
	Locations.Balloon066: Location(Levels.FungiForest, "Forest Balloon: Balloon in Mill", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.ForestMillFront, -1, BALLOON_FLAG_START + 66)]),
	Locations.Balloon067: Location(Levels.FungiForest, "Forest Balloon: Balloon in Upper Mushroom", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.ForestGiantMushroom, -1, BALLOON_FLAG_START + 67)]),
	Locations.Balloon068: Location(Levels.FungiForest, "Forest Balloon: Balloon in Lower Mushroom", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.ForestGiantMushroom, -1, BALLOON_FLAG_START + 68)]),
	Locations.Balloon069: Location(Levels.FungiForest, "Forest Balloon: Face Game Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.ForestChunkyFaceRoom, -1, BALLOON_FLAG_START + 69)]),
	Locations.Balloon070: Location(Levels.CrystalCaves, "Caves Balloon: W4 Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 70)]),
	Locations.Balloon071: Location(Levels.CrystalCaves, "Caves Balloon: Snide Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 71)]),
	Locations.Balloon072: Location(Levels.CrystalCaves, "Caves Balloon: Candy Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 72)]),
	Locations.Balloon073: Location(Levels.CrystalCaves, "Caves Balloon: Outside Cabin Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 73)]),
	Locations.Balloon074: Location(Levels.CrystalCaves, "Caves Balloon: Entrance Ice Wall Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 74)]),
	Locations.Balloon075: Location(Levels.CrystalCaves, "Caves Balloon: Outside 5DC Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 75)]),
	Locations.Balloon076: Location(Levels.CrystalCaves, "Caves Balloon: W3 Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 76)]),
	Locations.Balloon077: Location(Levels.CrystalCaves, "Caves Balloon: W2 Kasplat Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 77)]),
	Locations.Balloon078: Location(Levels.CrystalCaves, "Caves Balloon: Giant Rock Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CrystalCaves, -1, BALLOON_FLAG_START + 78)]),
	Locations.Balloon079: Location(Levels.CrystalCaves, "Caves Balloon: Tiny 5DI", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesTinyIgloo, -1, BALLOON_FLAG_START + 79)]),
	Locations.Balloon080: Location(Levels.CrystalCaves, "Caves Balloon: Lanky 5DI", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesLankyIgloo, -1, BALLOON_FLAG_START + 80)]),
	Locations.Balloon081: Location(Levels.CrystalCaves, "Caves Balloon: Donkey 5DI", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesDonkeyIgloo, -1, BALLOON_FLAG_START + 81)]),
	Locations.Balloon082: Location(Levels.CreepyCastle, "Castle Balloon: W1 Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, BALLOON_FLAG_START + 82)]),
	Locations.Balloon083: Location(Levels.CreepyCastle, "Castle Balloon: Ballroom Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CreepyCastle, -1, BALLOON_FLAG_START + 83)]),
	Locations.Balloon084: Location(Levels.CrystalCaves, "Caves Balloon: Tiny 5DC Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesTinyCabin, -1, BALLOON_FLAG_START + 84)]),
	Locations.Balloon085: Location(Levels.CrystalCaves, "Caves Balloon: Chunky 5DI Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesChunkyIgloo, -1, BALLOON_FLAG_START + 85)]),
	Locations.Balloon086: Location(Levels.CrystalCaves, "Caves Balloon: Ice Tomato Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesFrozenCastle, -1, BALLOON_FLAG_START + 86)]),
	Locations.Balloon087: Location(Levels.CrystalCaves, "Caves Balloon: Diddy 5DI Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CavesDiddyIgloo, -1, BALLOON_FLAG_START + 87)]),
	Locations.Balloon088: Location(Levels.CreepyCastle, "Castle Balloon: Lanky Tower Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleTower, -1, BALLOON_FLAG_START + 88)]),
	Locations.Balloon089: Location(Levels.CreepyCastle, "Castle Balloon: Lanky Mausoleum Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleMausoleum, -1, BALLOON_FLAG_START + 89)]),
	Locations.Balloon090: Location(Levels.CreepyCastle, "Castle Balloon: Coffin Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, BALLOON_FLAG_START + 90)]),
	Locations.Balloon091: Location(Levels.CreepyCastle, "Castle Balloon: Crypt Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleCrypt, -1, BALLOON_FLAG_START + 91)]),
	Locations.Balloon092: Location(Levels.CreepyCastle, "Castle Balloon: Museum Display Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, BALLOON_FLAG_START + 92)]),
	Locations.Balloon093: Location(Levels.CreepyCastle, "Castle Balloon: Museum Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleMuseum, -1, BALLOON_FLAG_START + 93)]),
	Locations.Balloon094: Location(Levels.CreepyCastle, "Castle Balloon: Chain Room Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 94)]),
	Locations.Balloon095: Location(Levels.CreepyCastle, "Castle Balloon: Lanky Dungeon (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 95)]),
	Locations.Balloon096: Location(Levels.CreepyCastle, "Castle Balloon: Chunky Dungeon (1)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 96)]),
	Locations.Balloon097: Location(Levels.CreepyCastle, "Castle Balloon: Lanky Dungeon (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 97)]),
	Locations.Balloon098: Location(Levels.CreepyCastle, "Castle Balloon: Chunky Dungeon (2)", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleDungeon, -1, BALLOON_FLAG_START + 98)]),
	Locations.Balloon099: Location(Levels.CreepyCastle, "Castle Balloon: DK Tree", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleTree, -1, BALLOON_FLAG_START + 99)]),
	Locations.Balloon100: Location(Levels.CreepyCastle, "Castle Balloon: Chunky Tree", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleTree, -1, BALLOON_FLAG_START + 100)]),
	Locations.Balloon101: Location(Levels.CreepyCastle, "Castle Balloon: Shed Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleShed, -1, BALLOON_FLAG_START + 101)]),
	Locations.Balloon102: Location(Levels.CreepyCastle, "Castle Balloon: Crypt Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, BALLOON_FLAG_START + 102)]),
	Locations.Balloon103: Location(Levels.CreepyCastle, "Castle Balloon: Funky Balloon", Items.Balloon, Types.Balloon, Kongs.any, [MapIDCombo(Maps.CastleLowerCave, -1, BALLOON_FLAG_START + 103)]),
