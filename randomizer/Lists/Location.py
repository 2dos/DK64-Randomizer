...
LocationListOriginal = {
    ...
    Locations.ForestKasplatInsideMushroom: Location(Levels.FungiForest, "Forest Kasplat: Giant Mushroom vine mesh", Items.DiddyBlueprint, Types.Blueprint, Kongs.diddy, [Maps.ForestGiantMushroom]),
