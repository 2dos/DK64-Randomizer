...
LocationList = {
    ...
    Locations.IslesBattleArena2: Location("Isles Battle Arena 2", Items.BattleCrown, Types.Crown, Kongs.any, [MapIDCombo(Maps.LobbyCrown, -1, 614)]),
    ...
    Locations.CavesBattleArena: Location("Caves Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any, [MapIDCombo(Maps.CavesCrown, -1, 616)]),
    ...
    Locations.CastleBattleArena: Location("Castle Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any, [MapIDCombo(Maps.CastleCrown, -1, 617)]),
    ...
    Locations.HelmBattleArena: Location("Helm Battle Arena", Items.BattleCrown, Types.Crown, Kongs.any, [MapIDCombo(Maps.HelmCrown, -1, 618)]),
