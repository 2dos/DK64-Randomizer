...
GlitchLogicItems = [
    ...
    GlitchLogicItem(
        "Tag Barrel Storage",
        "A trick that allows you to store a tag barrel being entered and abuse that storage. Includes telegrabs and Orangstand TBS Noclips.",
    ),
    GlitchLogicItem(
        "Troff n Scoff Skips",
        "Any skip that allows you to bypass the kong and small banana requirement in order to fight a boss.",
    ),
