...
door_locations = {
    Levels.JungleJapes: [
        ...
        DoorData(
            ...
            location=[795, 20, 100, 315.35],
            group=12,
        ),
        DoorData(
            name="Tunnel - right wall",
            map=Maps.JapesUnderGround,
            logicregion=Regions.JapesCatacomb,
            location=[731, 20, 325, 90],
            group=12,
        ),
        DoorData(
    ...
    Levels.AngryAztec: [
        ...
        DoorData(
            ...
            map=Maps.AztecLlamaTemple,
            logicregion=Regions.LlamaTemple,
            location=[2564, 371, 1901, 0],
            group=9,
        ),
        DoorData(
            name="Down the stairs - left",
            map=Maps.AztecLlamaTemple,
            logicregion=Regions.LlamaTemple,
            location=[2566, 371, 2895, 180],
            group=9,
        ),
        DoorData(
            name="Near top stairs - left",
            map=Maps.AztecLlamaTemple,
            logicregion=Regions.LlamaTemple,
            location=[1613, 472, 2608, 135],
            group=9,
        ),
        DoorData(
            name="Near top stairs - right",
            map=Maps.AztecLlamaTemple,
            logicregion=Regions.LlamaTemple,
            location=[1633, 472, 2192, 45],
            group=9,
        ),
        DoorData(
            name="Center torch below entrance",
            map=Maps.AztecLlamaTemple,
            logicregion=Regions.LlamaTemple,
            location=[2689, 469, 2393, 270],
            group=9,
        ),
        DoorData(
            name="Next to mini tunnel",
            map=Maps.AztecLlamaTemple,
            logicregion=Regions.LlamaTemple,
            location=[1720, 433, 3172, 219.02],
            group=9,
        ),
        DoorData(
            name="Behind the guitar pad",
            map=Maps.AztecTinyTemple,
            logicregion=Regions.TempleStart,
    ...
    Levels.GloomyGalleon: [
        ...
        DoorData(
            ...
            map=Maps.GloomyGalleon,
            logicregion=Regions.GloomyGalleonStart,
            location=[1992, 1609, 3045, 3],
            group=2,
        ),
        DoorData(
            name="Next to Cranky's ship",
            map=Maps.GloomyGalleon,
            logicregion=Regions.GloomyGalleonStart,
            location=[3211, 1678, 2717, 270],
            group=2,
        ),
        DoorData(
            name="Against Cranky's ship",
            map=Maps.GloomyGalleon,
            logicregion=Regions.GloomyGalleonStart,
            location=[3248, 1670, 2543, 145],
            group=2,
        ),
        DoorData(
    ...
    Levels.FungiForest: [
        ...
        DoorData(
            ...
            map=Maps.ForestGiantMushroom,
            logicregion=Regions.MushroomUpper,
            location=[785, 1839, 760, 233.78],
            group=5,
        ),
        DoorData(
            name="Night door in the tree",
            map=Maps.FungiForest,
            logicregion=Regions.HollowTreeArea,
    ...
    Levels.CrystalCaves: [
        ...
        DoorData(
            ...
            map=Maps.CrystalCaves,
            logicregion=Regions.CabinArea,
            location=[3177, 136, 1459, 136],
            group=2,
        ),
        DoorData(
            name="Right of entrance",
            map=Maps.CavesDonkeyCabin,
            logicregion=Regions.DonkeyCabin,
            location=[387, 0, 107, 0],
            group=20,
        ),
        DoorData(
            name="Back wall",
        ...
        DoorData(
            ...
            map=Maps.CavesChunkyCabin,
            logicregion=Regions.ChunkyCabin,
            location=[404, 45, 572, 180],
            group=23,
        ),
        DoorData(
            name="Under the swords",
            map=Maps.CavesDonkeyIgloo,
            logicregion=Regions.DonkeyIgloo,
            location=[233, 0, 787, 141.41],
            group=24,
        ),
        DoorData(
            name="Back wall",
        ...
        DoorData(
            ...
            map=Maps.CrystalCaves,
            logicregion=Regions.BoulderCave,
            location=[1523, 287, 2783, 188.26],
            group=4,
        ),
        DoorData(
            name="Behind gone ice wall",
            map=Maps.CrystalCaves,
            logicregion=Regions.CrystalCavesMain,
    ...
    Levels.CreepyCastle: [
        ...
        DoorData(
            name="Right of Wind Tower Entrance",
