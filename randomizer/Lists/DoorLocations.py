...
door_locations = {
    ...
    Levels.CrystalCaves: [
        ...
        #DoorData(name="5Door Igloo - DK's right", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[585, 48, 1396, 5], scale=0.95), # Too easy to accidentally activate
        #DoorData(name="5Door Igloo - Diddy's right", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[684.9, 48, 1312, 75], scale=0.95), # Too easy to accidentally activate
        #DoorData(name="5Door Igloo - Tiny's right", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[635, 48, 1190, 148], scale=0.95), # Too easy to accidentally activate
        #DoorData(name="5Door Igloo - Chunky's right", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[504.5, 48, 1200, 220.3], scale=0.95), # Too easy to accidentally activate
        #DoorData(name="5Door Igloo - Lanky's right", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[473.1, 48, 1327, 292.7], scale=0.95), # Too easy to accidentally activate
