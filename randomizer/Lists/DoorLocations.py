...
door_locations = {
    ...
    Levels.CrystalCaves: [
        ...
        DoorData(name="5Door Igloo - DK's right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[585, 48, 1396, 5], scale=0.95),
        DoorData(name="5Door Igloo - Diddy's right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[684.9, 48, 1312, 75], scale=0.95),
        DoorData(name="5Door Igloo - Tiny's right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[635, 48, 1190, 148], scale=0.95),
        DoorData(name="5Door Igloo - Chunky's right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[504.5, 48, 1200, 220.3], scale=0.95),
        DoorData(name="5Door Igloo - Lanky's right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[473.1, 48, 1327, 292.7], scale=0.95),
        ...
        DoorData(name="Under Handstand Slope", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[1263.3, 93, 1291, 73.5], enabled=True),
        DoorData(name="Mini Monkey Ledge", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[3112.3, 257, 1142, 262], rx=5, scale=0.4, enabled=True),
        DoorData(name="Across from Snide", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[1818.5, 82, 1450, 218.5], rx=-14, rz=21, enabled=True),
        DoorData(name="Slope to Cranky with Mini Monkey Hole", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[1047, 190, 2426, 175], rz=5.5, enabled=True),
        DoorData(name="Level Entrance - right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[1827, -29, 342, 225], enabled=True),
        DoorData(name="Level Entrance - left", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[1828, -29, 91, 315.5], enabled=True),
        DoorData(name="Ice Castle - left", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[2190.5, 343, 986.5, 314.2], scale=0.67, enabled=True),
        DoorData(name="Ice Castle - right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[2221, 343, 957, 134.2], scale=0.67, enabled=True),
        DoorData(name="Igloo Area - left of entrance", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[637, 0, 1605, 174.75], rx=-4, enabled=True),
        DoorData(name="Igloo Area - Behind Tag Barrel Island", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[157, 0, 1575, 122], enabled=True),
        DoorData(name="Igloo Area - Behind Warp 1", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[282.5, 0, 892, 58], enabled=True),
        DoorData(name="Igloo Area - right of entrance", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[956, 0, 1222, 270.5], enabled=True),
        DoorData(name="Under Funky's Store", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[2868, 0, 1246, 113], enabled=True),
        DoorData(name="Next to Waterfall that's Next to Funky", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[3093, 0, 1262, 268], enabled=True),
        DoorData(name="In Water Under Funky - left", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[3055, 0, 658, 1.28], enabled=True),
        DoorData(name="In Water Under Funky - center", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[3221, 0, 820, 292.5], enabled=True),
        DoorData(name="In Water Under Funky - right", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[3218, 0, 933, 256.3], enabled=True),
    ],
    Levels.CreepyCastle: [
