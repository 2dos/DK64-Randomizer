...
door_locations = {
    ...
    Levels.GloomyGalleon: [
        ...
        DoorData(name="Tiny's 5D ship", map=Maps.Galleon5DShipDKTiny, location=[735, 0, 1336, 270], rx=0, rz=0),
        DoorData(name="Lanky's 5D ship", map=Maps.Galleon5DShipDiddyLankyChunky, location=[1099, 0, 1051, 270], rx=0, rz=0),
        DoorData(name="Behind Chunky punch gate in Cranky Area", map=Maps.GloomyGalleon, location=[3275, 1670, 2353.65, 13.65], rx=0, rz=0),
        DoorData(name="Lighthouse Interior", map=Maps.GalleonLighthouse, location=[508, 200, 409, 135.2], rx=0, rz=0),
        DoorData(name="Low water alcove in lighthouse area", map=Maps.GloomyGalleon, location=[540.3, 1564, 4094, 110], rx=0, rz=0),
        DoorData(name="Behind boxes in Cranky Area", map=Maps.GloomyGalleon, location=[2891.5, 1688, 3493, 124], rx=0, rz=0),
        DoorData(name="Lanky's 2D ship", map=Maps.Galleon2DShip, location=[1616, 0, 939, 179.5], rx=0, rz=0),
        DoorData(name="Mech Fish Gate - far left", map=Maps.GloomyGalleon, location=[2651, 140.5, 503, 92], rx=0, rz=0),
        DoorData(name="Mech Fish Gate - left", map=Maps.GloomyGalleon, location=[2792, 175, 299.3, 15.9], rx=0, rz=7.3),
        DoorData(name="Mech Fish Gate - middle", map=Maps.GloomyGalleon, location=[3225, 205, 303, 329], rx=0, rz=-4.7),
        DoorData(name="Mech Fish Gate - right", map=Maps.GloomyGalleon, location=[3406, 166, 531, 260], rx=290, rz=-290),
        DoorData(name="Mech Fish Gate - far right", map=Maps.GloomyGalleon, location=[3310, 147, 828, 216.5], rx=16, rz=-16),
        DoorData(name="Cannonball Area Exit", map=Maps.GloomyGalleon, location=[1524.1, 1461, 2898, 278], rx=0, rz=0),
        DoorData(name="2Dship's secret 3rd door", map=Maps.GloomyGalleon, location=[1109, 1189.9, 1978, 95], rx=0, rz=-47, enabled=True),
        DoorData(name="In Mermaid's Palace", map=Maps.GalleonMermaidRoom, location=[274, 0, 481, 150], rx=0, rz=0),
        DoorData(name="Near Mermaid's Palace - right", map=Maps.GloomyGalleon, location=[1445, 141, 4859, 180], rx=0, rz=0),
        DoorData(name="Near Mermaid's Palace - left", map=Maps.GloomyGalleon, location=[1400, 112.8, 4215, 346.5], rx=0, rz=3),
        DoorData(name="Near Mermaid's Palace - Tag Barrel Alcove", map=Maps.GloomyGalleon, location=[890, 327, 3878, 21], rx=-2, rz=1),
