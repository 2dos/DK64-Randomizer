...
door_locations = {
    ...
    Levels.CrystalCaves: [
        ...
        DoorData(name="5Door Igloo - DK's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[481, 0, 1444, 328], enabled=True),
        DoorData(name="5Door Igloo - Diddy's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[698.5, 0, 1424.5, 40.5], enabled=True),
        DoorData(name="5Door Igloo - Tiny's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[747, 0, 1212.5, 111.8], enabled=True),
        DoorData(name="5Door Igloo - Chunky's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[561, 0, 1101, 184], enabled=True),
        DoorData(name="5Door Igloo - Lanky's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.CrystalCavesMain, location=[396, 0, 1244, 256], enabled=True),
