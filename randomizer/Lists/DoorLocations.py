...
door_locations = {
    ...
    Levels.GloomyGalleon: [
        ...
        DoorData(name="Tiny's 5D ship", map=Maps.Galleon5DShipDKTiny, logicregion=Regions.SaxophoneShip, location=[735, 0, 1336, 270], kong_lst=[Kongs.tiny], rx=0, rz=0),
        DoorData(name="Lanky's 5D ship", map=Maps.Galleon5DShipDiddyLankyChunky, logicregion=Regions.TromboneShip, location=[1099, 0, 1051, 270], kong_lst=[Kongs.lanky], rx=0, rz=0),
        DoorData(name="Behind Chunky punch gate in Cranky Area", map=Maps.GloomyGalleon, location=[3275, 1670, 2353.65, 13.65], kong_lst=[Kongs.chunky], logic=lambda l: l.punch, rx=0, rz=0),
        DoorData(name="Lighthouse Interior", map=Maps.GalleonLighthouse, logicregion=Regions.Lighthouse, location=[508, 200, 409, 135.2], kong_lst=[Kongs.donkey], rx=0, rz=0),
        DoorData(name="Low water alcove in lighthouse area", map=Maps.GloomyGalleon, logicregion=Regions.LighthouseArea, location=[540.3, 1564, 4094, 110], rx=0, rz=0),
        DoorData(name="Behind boxes in Cranky Area", map=Maps.GloomyGalleon, logicregion=Regions.GloomyGalleonStart, location=[2891.5, 1688, 3493, 124], rx=0, rz=0),
        DoorData(name="Lanky's 2D ship", map=Maps.Galleon2DShip, logicregion=Regions.LankyShip, location=[1616, 0, 939, 179.5], kong_lst=[Kongs.lanky], rx=0, rz=0),
        DoorData(name="Mech Fish Gate - far left", map=Maps.GloomyGalleon, logicregion=Regions.Shipyard, location=[2651, 140.5, 503, 92], rx=0, rz=0),
        DoorData(name="Mech Fish Gate - left", map=Maps.GloomyGalleon, logicregion=Regions.Shipyard, location=[2792, 175, 299.3, 15.9], rx=0, rz=7.3),
        DoorData(name="Mech Fish Gate - middle", map=Maps.GloomyGalleon, logicregion=Regions.Shipyard, location=[3225, 205, 303, 329], rx=0, rz=-4.7),
        ...
        DoorData(name="Cannonball Area Exit", map=Maps.GloomyGalleon, logicregion=Regions.GalleonBeyondPineappleGate, location=[1524.1, 1461, 2898, 278], rx=0, rz=0),
        DoorData(name="2Dship's secret 3rd door", map=Maps.GloomyGalleon, logicregion=Regions.Shipyard, location=[1109, 1189.9, 1978, 95], rx=0, rz=-47, enabled=True),
        DoorData(name="In Mermaid's Palace", map=Maps.GalleonMermaidRoom, logicregion=Regions.MermaidRoom, location=[274, 0, 481, 150], kong_lst=[Kongs.tiny], rx=0, rz=0),
        DoorData(name="Near Mermaid's Palace - right", map=Maps.GloomyGalleon, logicregion=Regions.LighthouseArea, location=[1445, 141, 4859, 180], rx=0, rz=0),
        DoorData(name="Near Mermaid's Palace - left", map=Maps.GloomyGalleon, logicregion=Regions.LighthouseArea, location=[1400, 112.8, 4215, 346.5], rx=0, rz=3),
