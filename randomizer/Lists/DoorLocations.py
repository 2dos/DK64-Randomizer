...
door_locations = {
    ...
    Levels.FranticFactory: [
        ...
        DoorData(name="Frantic Factory: Tiny's Race Entry Area", map=Maps.FranticFactory, logicregion=Regions.FactoryTinyRaceLobby, location=[3540.25, 1264.0, 1413.0, 141.0], group=4, moveless=False, logic=lambda l: True, door_type="wrinkly"),
