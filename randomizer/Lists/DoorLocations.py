...
door_locations = {
    ...
    Levels.AngryAztec: [
        ...
        DoorData(name="Aztec Lobby: Behind Feather Door", map=Maps.AngryAztecLobby, logicregion=Regions.AngryAztecLobby, location=[1070.018, 0, 738.609, 190], placed="wrinkly", logic=lambda l: l.feather),  # Custom Chunky Door
    ...
    Levels.GloomyGalleon: [
        ...
        DoorData(name="Galleon: Behind Enguarde Door", map=Maps.GloomyGalleon, logicregion=Regions.LighthouseUnderwater, location=[645.832, 1460, 4960.476, 133], placed="tns", logic=lambda l: Events.LighthouseEnguarde in l.Events),  # T&S Door behind Enguarde Door
        ...
        DoorData(name="Behind Chunky punch gate in Cranky Area", map=Maps.GloomyGalleon, logicregion=Regions.GloomyGalleonStart, location=[3275, 1670, 2353.65, 13.65], kong_lst=[Kongs.chunky], logic=lambda l: l.punch),
    ...
    Levels.FungiForest: [
        ...
        DoorData(name="Fungi: Beanstalk Area", map=Maps.FungiForest, logicregion=Regions.WormArea, location=[3665.871, 186.833, 945.745, 252], placed="tns", logic=lambda l: Events.Night in l.Events),  # T&S Portal in Beanstalk Area
        ...
        DoorData(name="Fungi: Top of Giant Mushroom", map=Maps.FungiForest, logicregion=Regions.MushroomUpperExterior, location=[1171.791, 1250, 1236.572, 52], placed="tns"),  # T&S Portal at Top of GMush
    ...
    Levels.CrystalCaves: [
        ...
        DoorData(name="Outside Diddy's Upper Cabin", map=Maps.CrystalCaves, logicregion=Regions.CabinArea, location=[3666.7, 343, 1762, 273.8]),
        DoorData(name="Under the Waterfall (Cabin Area)", map=Maps.CrystalCaves, logicregion=Regions.CabinArea, location=[2230, 0, 2178, 100]),
        DoorData(name="Across from the 5Door Cabin", map=Maps.CrystalCaves, logicregion=Regions.CabinArea, location=[2970, 128, 1499, 68.5], rx=9, rz=11),
        # DoorData(name="5Door Igloo - DK's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[481, 0, 1444, 328]), # Too easy to accidentally activate
        # DoorData(name="5Door Igloo - Diddy's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[698.5, 0, 1424.5, 40.5]), # Too easy to accidentally activate
        # DoorData(name="5Door Igloo - Tiny's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[747, 0, 1212.5, 111.8]), # Too easy to accidentally activate
        # DoorData(name="5Door Igloo - Chunky's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[561, 0, 1101, 184]), # Too easy to accidentally activate
        # DoorData(name="5Door Igloo - Lanky's instrument pad", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[396, 0, 1244, 256]), # Too easy to accidentally activate
        ...
        DoorData(name="Igloo Area - left of entrance", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[637, 0, 1605, 174.75], rx=-4),
        DoorData(name="Igloo Area - Behind Tag Barrel Island", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[157, 0, 1575, 122]),
        DoorData(name="Igloo Area - Behind Warp 1", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[282.5, 0, 892, 58]),
        DoorData(name="Igloo Area - right of entrance", map=Maps.CrystalCaves, logicregion=Regions.IglooArea, location=[956, 0, 1222, 270.5]),
