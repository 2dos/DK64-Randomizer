...
def ShuffleItems(spoiler):
    ...
    for location_enum in spoiler.LocationList:
        ...
        if (
            ...
            and (not item_location.inaccessible or item_location.type in (Types.Cranky, Types.Funky, Types.Candy, Types.Snide, Types.FungiTime))  # Shopkeepers' locations are either inaccessible or vanilla
