...
SettingsStringTypeMap = {
    SettingsStringEnum.activate_all_bananaports: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.bananaport_rando: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.coin_door_item: SettingsStringDataType.int8,
    SettingsStringEnum.coin_door_item_count: SettingsStringDataType.int16,
    SettingsStringEnum.crown_door_item: SettingsStringDataType.int8,
    ...
    SettingsStringEnum.free_trade_setting: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.helm_setting: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.kasplat_rando_setting: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.krusha_ui: SettingsStringDataType.int4,
    SettingsStringEnum.level_randomization: SettingsStringDataType.int4,
    SettingsStringEnum.logic_type: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.microhints_enabled: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.move_rando: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.random_prices: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.shockwave_status: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.training_barrels: SettingsStringDataType.int4,
    ...
    SettingsStringEnum.win_condition: SettingsStringDataType.int4,
    SettingsStringEnum.wrinkly_available: SettingsStringDataType.bool,
    SettingsStringEnum.wrinkly_hints: SettingsStringDataType.int4,
...
SettingsStringListTypeMap = {
    SettingsStringEnum.enemies_selected: SettingsStringDataType.int8,
    SettingsStringEnum.glitches_selected: SettingsStringDataType.int8,
