...
class Locations(IntEnum):
    ...
    IslesLankyKasplat = auto()
    IslesLankyCastleLobby = auto()
    IslesDiddyKasplat = auto()
    IslesChunkyHelmLobby = auto()
    IslesDonkeyKasplat = auto()
    BananaHoard = auto()
    ...
    JapesLankyMadMazeMaul = auto()
    JapesTinySplishSplashSalvage = auto()
    JapesDonkeyKasplat = auto()
    JapesTinyKasplat = auto()
    JapesTinyStump = auto()
    JapesChunkyMinecartMayhem = auto()
    JapesTinyBeehive = auto()
    JapesLankySpeedySwingSortie = auto()
    JapesDiddyKasplat = auto()
    JapesLankyKasplat = auto()
    ...
    AztecDonkeyStealthySnoop = auto()
    AztecDiddyRamGongs = auto()
    AztecDiddyVultureRace = auto()
    AztecChunkyBusyBarrelBarrage = auto()
    AztecTinyKasplat = auto()
    ...
    FactoryLankyKasplat = auto()
    FactoryBattleArena = auto()
    FactoryTinyCarRace = auto()
    FactoryDiddyBeaverBother = auto()
    ...
    FactoryChunkyStashSnatch = auto()
    FactoryDiddyKasplat = auto()
    FactoryTinyKasplat = auto()
    ...
    ForestTinyKasplat = auto()
    ForestDonkeyMushroomCannons = auto()
    ForestDiddyKasplat = auto()
    ForestChunkyKasplat = auto()
    ...
    ForestDonkeyKasplat = auto()
    ForestDonkeyMinecartMayhem = auto()
