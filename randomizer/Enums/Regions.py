...
class Regions(IntEnum):
    ...
    MushroomLowerMid = auto()
    MushroomMiddle = auto()
    MushroomUpperMid = auto()
    MushroomUpper = auto()
    ...
    ForestTopOfMill = auto()
    ForestVeryTopOfMill = auto()
    MushroomUpperMidExterior = auto()
