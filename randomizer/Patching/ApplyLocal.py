...
async def patching_response(data, from_patch_gen=False, lanky_from_history=False, gen_history=False):
    ...
    #     return
        ...
        if (js.document.getElementById("download_patch_file").checked or js.document.getElementById("load_patch_file").checked) and js.document.getElementById("generate_seed").value != "Download Seed":
            js.save_text_as_file(data, f"dk64r-patch-{seed_id}.lanky")
