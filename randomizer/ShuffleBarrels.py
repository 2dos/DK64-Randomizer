...
def ShuffleBarrels(settings: Settings, barrelLocations: List[Locations], minigamePool: List[Minigames]) -> None:
    ...
    settings.plandomizer_dict["plando_bonus_barrels"] = {
        # Locations.IslesDiddySnidesLobby: Minigames.BigBugBashHard, test how it handles absence of entry
        str(Locations.IslesTinyAztecLobby.value): Minigames.BigBugBashHard,
        str(Locations.IslesChunkyHelmLobby.value): Minigames.BigBugBashHard,
        str(Locations.IslesDiddySummit.value): Minigames.BigBugBashHard,
        str(Locations.IslesLankyCastleLobby.value): Minigames.BigBugBashHard,
        str(Locations.JapesLankyGrapeGate.value): Minigames.BigBugBashHard,
        str(Locations.JapesChunkyGiantBonusBarrel.value): Minigames.BigBugBashHard,
        str(Locations.JapesLankySlope.value): Minigames.BigBugBashHard,
        str(Locations.JapesTinyFeatherGateBarrel.value): Minigames.BigBugBashHard,
        str(Locations.AztecLanky5DoorTemple.value): Minigames.BigBugBashHard,
        str(Locations.AztecChunkyCagedBarrel.value): Minigames.BigBugBashHard,
        str(Locations.AztecChunky5DoorTemple.value): Minigames.BigBugBashHard,
        str(Locations.AztecDonkeyQuicksandCave.value): Minigames.BigBugBashHard,
        str(Locations.AztecLankyLlamaTempleBarrel.value): Minigames.BigBugBashHard,
        str(Locations.FactoryLankyTestingRoomBarrel.value): Minigames.BigBugBashHard,
        str(Locations.FactoryDiddyChunkyRoomBarrel.value): Minigames.BigBugBashHard,
        str(Locations.FactoryTinyProductionRoom.value): Minigames.BigBugBashHard,
        str(Locations.FactoryDiddyBlockTower.value): Minigames.BigBugBashHard,
        str(Locations.FactoryChunkybyArcade.value): Minigames.BigBugBashHard,
        str(Locations.GalleonChunky5DoorShip.value): Minigames.BigBugBashHard,
        str(Locations.GalleonTinySubmarine.value): Minigames.BigBugBashHard,
        str(Locations.GalleonDonkey5DoorShip.value): Minigames.BigBugBashHard,
        str(Locations.GalleonTiny2DoorShip.value): Minigames.BigBugBashHard,
        str(Locations.GalleonLankyGoldTower.value): Minigames.BigBugBashHard,
        str(Locations.GalleonDiddy5DoorShip.value): Minigames.BigBugBashHard,
        str(Locations.GalleonDiddyGoldTower.value): Minigames.BigBugBashHard,
        str(Locations.ForestDiddyOwlRace.value): Minigames.BigBugBashHard,
        str(Locations.ForestLankyColoredMushrooms.value): Minigames.BigBugBashHard,
        str(Locations.ForestDonkeyBarn.value): Minigames.BigBugBashHard,
        str(Locations.ForestDonkeyBaboonBlast.value): Minigames.BigBugBashHard,
        str(Locations.ForestTinyMushroomBarrel.value): Minigames.BigBugBashHard,
        str(Locations.ForestDiddyTopofMushroom.value): Minigames.BigBugBashHard,
        str(Locations.CavesDonkeyBaboonBlast.value): Minigames.BigBugBashHard,
        str(Locations.CavesTinyCaveBarrel.value): Minigames.BigBugBashHard,
        str(Locations.CavesDiddyJetpackBarrel.value): Minigames.BigBugBashHard,
        str(Locations.CavesChunky5DoorCabin.value): Minigames.BigBugBashHard,
        str(Locations.CastleLankyTower.value): Minigames.BigBugBashHard,
        str(Locations.CastleChunkyTree.value): Minigames.BigBugBashHard,
        str(Locations.CastleDiddyAboveCastle.value): Minigames.BigBugBashHard,
        str(Locations.CastleLankyDungeon.value): Minigames.BigBugBashHard,
        str(Locations.CastleDiddyBallroom.value): Minigames.BigBugBashHard,
        str(Locations.CastleChunkyCrypt.value): Minigames.BigBugBashHard,
        str(Locations.CastleTinyOverChasm.value): Minigames.BigBugBashHard,
        str(Locations.HelmDonkey1.value): Minigames.BigBugBashHard,
        str(Locations.HelmDonkey2.value): Minigames.BigBugBashHard,
        str(Locations.HelmDiddy1.value): Minigames.BigBugBashHard,
        str(Locations.HelmDiddy2.value): Minigames.BigBugBashHard,
        str(Locations.HelmLanky1.value): Minigames.BigBugBashHard,
        str(Locations.HelmLanky2.value): Minigames.BigBugBashHard,
        str(Locations.HelmTiny1.value): Minigames.BigBugBashHard,
        str(Locations.HelmTiny2.value): Minigames.BigBugBashHard,
        str(Locations.HelmChunky1.value): Minigames.BigBugBashHard,
        str(Locations.HelmChunky2.value): Minigames.BigBugBashHard,
    }
    # Apply plandomized minigame placement
