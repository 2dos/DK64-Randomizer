...
LogicRegions = {
    Regions.CreepyCastleMedals: Region("Creepy Castle Medals", HintRegion.CastleCBs, Levels.CreepyCastle, False, None, [
        ...
        LocationLogic(Locations.CastleDonkeyHalfMedal, lambda l: l.ColoredBananas[Levels.CreepyCastle][Kongs.donkey] >= max(1, int(l.settings.medal_cb_req_level[6] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CastleDiddyHalfMedal, lambda l: l.ColoredBananas[Levels.CreepyCastle][Kongs.diddy] >= max(1, int(l.settings.medal_cb_req_level[6] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CastleLankyHalfMedal, lambda l: l.ColoredBananas[Levels.CreepyCastle][Kongs.lanky] >= max(1, int(l.settings.medal_cb_req_level[6] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CastleTinyHalfMedal, lambda l: l.ColoredBananas[Levels.CreepyCastle][Kongs.tiny] >= max(1, int(l.settings.medal_cb_req_level[6] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CastleChunkyHalfMedal, lambda l: l.ColoredBananas[Levels.CreepyCastle][Kongs.chunky] >= max(1, int(l.settings.medal_cb_req_level[6] * (l.settings.half_medal_percentage / 100)))),
    ], [], [], restart=-1),
