...
LogicRegions = {
    Regions.CrystalCavesMedals: Region("Crystal Caves Medals", HintRegion.CavesCBs, Levels.CrystalCaves, False, None, [
        ...
        LocationLogic(Locations.CavesDonkeyHalfMedal, lambda l: l.ColoredBananas[Levels.CrystalCaves][Kongs.donkey] >= max(1, int(l.settings.medal_cb_req_level[5] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CavesDiddyHalfMedal, lambda l: l.ColoredBananas[Levels.CrystalCaves][Kongs.diddy] >= max(1, int(l.settings.medal_cb_req_level[5] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CavesLankyHalfMedal, lambda l: l.ColoredBananas[Levels.CrystalCaves][Kongs.lanky] >= max(1, int(l.settings.medal_cb_req_level[5] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CavesTinyHalfMedal, lambda l: l.ColoredBananas[Levels.CrystalCaves][Kongs.tiny] >= max(1, int(l.settings.medal_cb_req_level[5] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.CavesChunkyHalfMedal, lambda l: l.ColoredBananas[Levels.CrystalCaves][Kongs.chunky] >= max(1, int(l.settings.medal_cb_req_level[5] * (l.settings.half_medal_percentage / 100)))),
    ], [], [], restart=-1),
