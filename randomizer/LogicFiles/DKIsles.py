...
LogicRegions = {
    Regions.GameStart: Region("Game Start", "Game Start", Levels.DKIsles, False, None, [
    ...
    Regions.IslesMainUpper: Region("Isles Main Upper", "Main Isle", Levels.DKIsles, False, None, [
        ...
        TransitionFront(Regions.IslesEar, lambda l: (l.settings.open_lobbies or Events.ForestKeyTurnedIn in l.Events) and (l.isdonkey or l.ischunky or (l.istiny and l.twirl) or ((l.isdiddy or l.islanky) and l.advanced_platforming and l.isKrushaAdjacent(l.kong)) or l.CanMoonkick())),
        TransitionFront(Regions.DKIslesMedals, lambda l: True),
    ]),
    ...
    Regions.IslesEar: Region("Isles Ear", "Main Isle", Levels.DKIsles, False, None, [], [], [
        ...
        TransitionFront(Regions.IslesMain, lambda l: True),
        TransitionFront(Regions.IslesMainUpper, lambda l: (l.istiny and l.twirl) or (l.isdonkey or l.ischunky or ((l.isdiddy or l.islanky) and l.advanced_platforming) and l.isKrushaAdjacent(l.kong))),
        TransitionFront(Regions.DKIslesMedals, lambda l: True),
        TransitionFront(Regions.IslesMainUpper, lambda l: l.isdonkey or l.ischunky or (l.istiny and l.twirl) or ((l.isdiddy or l.islanky) and l.advanced_platforming and l.isKrushaAdjacent(l.kong))),
    ]),
    ...
    Regions.HideoutHelmLobby: Region("Hideout Helm Lobby", "Caves-Helm Lobbies", Levels.DKIsles, True, None, [
        ...
        TransitionFront(Regions.CabinIsle, lambda l: l.CanMoonkick() or (l.advanced_platforming and ((l.isdiddy or l.isdonkey or l.ischunky) and l.isKrushaAdjacent(l.kong)) or (l.istiny and l.twirl))),
        TransitionFront(Regions.DKIslesMedals, lambda l: True),
    ]),
