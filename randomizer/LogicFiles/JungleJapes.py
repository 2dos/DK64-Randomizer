...
LogicRegions = {
    Regions.JungleJapesMain: Region("Jungle Japes Main", Levels.JungleJapes, True, None, [
        ...
        TransitionFront(Regions.JungleJapesLobby, lambda l: True, Exits.JapesToIsles),
        ...
        TransitionFront(Regions.Mine, lambda l: l.peanut and l.isdiddy, Exits.JapesMainToMine),
        TransitionFront(Regions.JapesLankyCave, lambda l: l.peanut and l.diddy and l.handstand and l.islanky, Exits.JapesMainToLankyCave),
        TransitionFront(Regions.JapesCatacomb, lambda l: l.Slam and l.chunkyAccess, Exits.JapesMainToCatacomb),
    ...
    Regions.JapesBeyondFeatherGate: Region("Japes Beyond Feather Gate", Levels.JungleJapes, True, -1, [
        ...
        TransitionFront(Regions.TinyHive, lambda l: l.mini and l.istiny, Exits.JapesMainToTinyHive),
    ]),
    ...
    Regions.TinyHive: Region("Tiny Hive", Levels.JungleJapes, False, -1, [
        ...
        TransitionFront(Regions.JapesBeyondFeatherGate, lambda l: True, Exits.JapesTinyHiveToMain),
    ]),
    ...
    Regions.JapesLankyCave: Region("Japes Lanky Cave", Levels.JungleJapes, False, TransitionFront(Regions.JungleJapesMain, lambda l: l.Slam and l.islanky), [
        ...
        TransitionFront(Regions.JungleJapesMain, lambda l: True, Exits.JapesLankyCaveToMain),
    ]),
    ...
    Regions.Mine: Region("Mine", Levels.JungleJapes, False, -1, [], [
        ...
        TransitionFront(Regions.JungleJapesMain, lambda l: True, Exits.JapesMineToMain),
    ...
    Regions.JapesCatacomb: Region("Japes Catacomb", Levels.JungleJapes, False, None, [
        ...
        TransitionFront(Regions.JungleJapesMain, lambda l: True, Exits.JapesCatacombToMain),
    ]),
