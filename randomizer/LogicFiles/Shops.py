...
LogicRegions = {
    ...
    Regions.FunkyJapes: Region("Funky Japes", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedJapesGun, lambda l: l.LevelEntered(Levels.JungleJapes)),
    ...
    Regions.FunkyAztec: Region("Funky Aztec", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedAztecGun, lambda l: l.LevelEntered(Levels.AngryAztec)),
    ...
    Regions.FunkyGalleon: Region("Funky Galleon", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedGalleonGun, lambda l: l.LevelEntered(Levels.GloomyGalleon)),
    ...
    Regions.CandyAztec: Region("Candy Aztec", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedAztecInstrument, lambda l: l.LevelEntered(Levels.AngryAztec)),
    ...
    Regions.CandyFactory: Region("Candy Factory", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedFactoryInstrument, lambda l: l.LevelEntered(Levels.AngryAztec)),
    ...
    Regions.CrankyJapes: Region("Cranky Japes", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedJapesPotion, lambda l: l.LevelEntered(Levels.JungleJapes)),
    ...
    Regions.CrankyAztec: Region("Cranky Aztec", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedAztecPotion, lambda l: l.LevelEntered(Levels.AngryAztec)),
    ...
    Regions.CrankyFactory: Region("Cranky Factory", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedFactoryPotion, lambda l: l.LevelEntered(Levels.FranticFactory)),
    ...
    Regions.CrankyGalleon: Region("Cranky Galleon", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedGalleonPotion, lambda l: l.LevelEntered(Levels.GloomyGalleon)),
    ...
    Regions.CrankyCaves: Region("Cranky Caves", Levels.Shops, False, None, [
        LocationLogic(Locations.SharedCavesPotion, lambda l: l.LevelEntered(Levels.CrystalCaves)),
