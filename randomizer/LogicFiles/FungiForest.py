...
LogicRegions = {
    Regions.FungiForestStart: Region("Fungi Forest Start", True, [], [
    ...
    Regions.ForestMinecarts: Region("Forest Minecarts", False, [
        Location("Forest Chunky Minecarts", lambda l: l.ischunky),
    ], [], []),

    Regions.GiantMushroomArea: Region("Giant Mushroom Area", True, [
    ...
    Regions.MushroomLower: Region("Mushroom Lower", True, [
    ...
    Regions.MushroomLowerExterior: Region("Mushroom Lower Exterior", True, [
    ...
    Regions.MushroomNightDoor: Region("Mushroom Night Door", False, [], [], [
        Exit(Regions.MushroomUpper, lambda l: True),
        Exit(Regions.MushroomNightExterior, lambda l: Events.Night in l.Events),
    ]),

    Regions.MushroomNightExterior: Region("Mushroom Night Exterior", False, [
    ...
    Regions.MushroomUpperExterior: Region("Mushroom Upper Exterior", True, [
    ...
    Regions.MushroomChunkyRoom: Region("Mushroom Chunky Room", False, [
        Location("Forest Chunky Face Puzzle", lambda l: l.pineapple and l.ischunky),
    ], [], [
        Exit(Regions.MushroomUpperExterior, lambda l: True),
    ]),

    Regions.MushroomLankyZingersRoom: Region("Mushroom Lanky Zingers Room", False, [
        Location("Forest Lanky Zingers", lambda l: l.grape and l.islanky),
    ], [], [
        Exit(Regions.MushroomUpperExterior, lambda l: True),
    ]),

    Regions.MushroomLankyMushroomsRoom: Region("Mushroom Lanky Mushrooms Room", False, [
        Location("Forest Lanky Colored Mushrooms", lambda l: l.Slam and l.islanky),
    ], [], [
        Exit(Regions.MushroomUpperExterior, lambda l: True),
    ]),

    Regions.HollowTreeArea: Region("Hollow Tree Area", True, [
    ...
    Regions.Anthill: Region("Anthill", False, [
    ...
    Regions.MillArea: Region("Mill Area", True, [
    ...
    Regions.MillChunkyArea: Region("Mill Chunky Area", False, [], [
    ...
    Regions.MillTinyArea: Region("Mill Tiny Area", False, [], [], [
    ...
    Regions.MillRafters: Region("Mill Rafters", False, [
    ...
    Regions.WormArea: Region("Worm Area", True, [
    ...
    Regions.ForestBossLobby: Region("Forest Boss Lobby", True, [], [], [
        # 300 bananas
