...
LogicRegions = {
    Regions.FungiForestStart: Region("Fungi Forest Start", Levels.FungiForest, True, None, [
        ...
        TransitionFront(Regions.FungiForestLobby, lambda l: True, Exits.ForestToIsles),
    ...
    Regions.GiantMushroomArea: Region("Giant Mushroom Area", Levels.FungiForest, True, None, [
        ...
        TransitionFront(Regions.FungiForestStart, lambda l: True),
        TransitionFront(Regions.MushroomLower, lambda l: True, Exits.ForestMainToLowerMushroom),
    ...
    Regions.MushroomLower: Region("Mushroom Lower", Levels.FungiForest, True, None, [
        ...
        TransitionFront(Regions.GiantMushroomArea, lambda l: True, Exits.ForestLowerMushroomToMain),
        TransitionFront(Regions.MushroomLowerExterior, lambda l: True, Exits.ForestLowerMushroomToLowerExterior),
    ...
    Regions.MushroomLowerExterior: Region("Mushroom Lower Exterior", Levels.FungiForest, True, -1, [
        ...
        TransitionFront(Regions.GiantMushroomArea, lambda l: True),
        TransitionFront(Regions.MushroomLower, lambda l: True, Exits.ForestLowerExteriorToLowerMushroom),
        TransitionFront(Regions.MushroomUpper, lambda l: True, Exits.ForestLowerExteriorToUpperMushroom),
    ]),
    ...
    Regions.MushroomUpper: Region("Mushroom Upper", Levels.FungiForest, True, -1, [
        ...
        TransitionFront(Regions.MushroomLowerExterior, lambda l: True, Exits.ForestUpperMushroomToLowerExterior),
        TransitionFront(Regions.MushroomUpperExterior, lambda l: True, Exits.ForestUpperMushroomToUpperExterior),
    ...
    Regions.MushroomNightDoor: Region("Mushroom Night Door", Levels.FungiForest, False, None, [], [], [
        ...
        TransitionFront(Regions.MushroomNightExterior, lambda l: Events.Night in l.Events, Exits.ForestNightToExterior),
    ]),
    ...
    Regions.MushroomNightExterior: Region("Mushroom Night Exterior", Levels.FungiForest, False, None, [
        ...
        TransitionFront(Regions.MushroomNightDoor, lambda l: Events.Night in l.Events, Exits.ForestExteriorToNight),
        TransitionFront(Regions.GiantMushroomArea, lambda l: True),
    ]),
    ...
    Regions.MushroomUpperExterior: Region("Mushroom Upper Exterior", Levels.FungiForest, True, -1, [
        ...
        TransitionFront(Regions.MushroomUpper, lambda l: True, Exits.ForestUpperExteriorToUpperMushroom),
        TransitionFront(Regions.MushroomNightExterior, lambda l: True),
        TransitionFront(Regions.GiantMushroomArea, lambda l: True),
        TransitionFront(Regions.MushroomChunkyRoom, lambda l: l.superSlam and l.ischunky, Exits.ForestExteriorToChunky),
        TransitionFront(Regions.MushroomLankyZingersRoom, lambda l: l.superSlam and l.islanky, Exits.ForestExteriorToZingers),
        TransitionFront(Regions.MushroomLankyMushroomsRoom, lambda l: l.superSlam and l.islanky, Exits.ForestExteriorToMushrooms),
    ...
    Regions.MushroomChunkyRoom: Region("Mushroom Chunky Room", Levels.FungiForest, False, -1, [
        ...
        TransitionFront(Regions.MushroomUpperExterior, lambda l: True, Exits.ForestChunkyToExterior),
    ]),
    ...
    Regions.MushroomLankyZingersRoom: Region("Mushroom Lanky Zingers Room", Levels.FungiForest, False, -1, [
        ...
        TransitionFront(Regions.MushroomUpperExterior, lambda l: True, Exits.ForestZingersToExterior),
    ]),
    ...
    Regions.MushroomLankyMushroomsRoom: Region("Mushroom Lanky Mushrooms Room", Levels.FungiForest, False, None, [
        ...
        TransitionFront(Regions.MushroomUpperExterior, lambda l: True, Exits.ForestMushroomsToExterior),
    ]),
    ...
    Regions.HollowTreeArea: Region("Hollow Tree Area", Levels.FungiForest, True, -1, [
        ...
        TransitionFront(Regions.Anthill, lambda l: l.mini and l.saxophone, Exits.ForestTreeToAnthill),
        TransitionFront(Regions.ForestBossLobby, lambda l: True),
    ]),
    ...
    Regions.Anthill: Region("Anthill", Levels.FungiForest, False, -1, [
        ...
        TransitionFront(Regions.HollowTreeArea, lambda l: True, Exits.ForestAnthillToTree),
    ]),
    ...
    Regions.MillArea: Region("Mill Area", Levels.FungiForest, True, None, [
        ...
        TransitionFront(Regions.FungiForestStart, lambda l: True),
        TransitionFront(Regions.MillChunkyArea, lambda l: l.punch and l.ischunky, Exits.ForestMainToChunkyMill),
        TransitionFront(Regions.MillTinyArea, lambda l: Events.MillBoxBroken in l.Events and l.mini and l.istiny, Exits.ForestMainToTinyMill),
        TransitionFront(Regions.GrinderRoom, lambda l: True, Exits.ForestMainToGrinder),
        TransitionFront(Regions.MillRafters, lambda l: Events.Night in l.Events and l.spring and l.isdiddy, Exits.ForestMainToRafters),
        TransitionFront(Regions.WinchRoom, lambda l: Events.Night in l.Events and l.superSlam and l.isdiddy, Exits.ForestMainToWinch),
        TransitionFront(Regions.MillAttic, lambda l: Events.Night in l.Events, Exits.ForestMainToAttic),
    ...
    Regions.MillChunkyArea: Region("Mill Chunky Area", Levels.FungiForest, False, -1, [], [
        ...
        TransitionFront(Regions.MillArea, lambda l: True, Exits.ForestChunkyMillToMain),
        TransitionFront(Regions.MillTinyArea, lambda l: True),
    ]),

    Regions.MillTinyArea: Region("Mill Tiny Area", Levels.FungiForest, False, -1, [], [], [
        TransitionFront(Regions.MillArea, lambda l: l.mini and l.istiny, Exits.ForestTinyMillToMain),
        TransitionFront(Regions.MillChunkyArea, lambda l: True),
        TransitionFront(Regions.SpiderRoom, lambda l: Events.Night in l.Events, Exits.ForestTinyMillToSpider),
        TransitionFront(Regions.GrinderRoom, lambda l: l.mini and l.istiny, Exits.ForestTinyMillToGrinder),
    ]),
    ...
    Regions.SpiderRoom: Region("Spider Room", Levels.FungiForest, False, Regions.MillTinyArea, [
        ...
        TransitionFront(Regions.MillTinyArea, lambda l: True, Exits.ForestSpiderToTinyMill),
    ]),
    ...
    Regions.GrinderRoom: Region("Grinder Room", Levels.FungiForest, True, -1, [
        ...
        TransitionFront(Regions.MillArea, lambda l: True, Exits.ForestGrinderToMain),
        TransitionFront(Regions.MillTinyArea, lambda l: l.mini and l.istiny, Exits.ForestGrinderToTinyMill),
    ]),
    ...
    Regions.MillRafters: Region("Mill Rafters", Levels.FungiForest, False, None, [
        ...
        TransitionFront(Regions.MillArea, lambda l: True, Exits.ForestRaftersToMain),
    ]),
    ...
    Regions.WinchRoom: Region("Winch Room", Levels.FungiForest, False, -1, [], [
        ...
        TransitionFront(Regions.MillArea, lambda l: True, Exits.ForestWinchToMain),
    ]),
    ...
    Regions.MillAttic: Region("Mill Attic", Levels.FungiForest, False, TransitionFront(Regions.FungiForestStart, lambda l: l.superSlam and l.islanky), [
        ...
        TransitionFront(Regions.MillArea, lambda l: True, Exits.ForestAtticToMain),
    ]),
    ...
    Regions.ThornvineArea: Region("Thornvine Area", Levels.FungiForest, True, -1, [
        ...
        TransitionFront(Regions.ThornvineBarn, lambda l: l.superSlam and l.isdonkey, Exits.ForestMainToBarn),
        TransitionFront(Regions.ForestBossLobby, lambda l: True),
    ]),
    ...
    Regions.ThornvineBarn: Region("Thornvine Barn", Levels.FungiForest, False, -1, [
        ...
        TransitionFront(Regions.ThornvineArea, lambda l: True, Exits.ForestBarnToMain),
    ]),
