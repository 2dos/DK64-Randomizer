...
LogicRegions = {
    ...
    Regions.MillArea: Region("Mill Area", Levels.FungiForest, True, [
        ...
        Exit(Regions.WenchRoom, lambda l: Events.Night in l.Events and l.superSlam and l.isdiddy, Exits.ForestMainToWench),
    ...
    Regions.WenchRoom: Region("Wench Room", Levels.FungiForest, False, [], [
        ...
        Exit(Regions.MillArea, lambda l: True, Exits.ForestWenchToMain),
    ]),
