...
LogicRegions = {
    Regions.FungiForestMedals: Region("Fungi Forest Medals", HintRegion.ForestCBs, Levels.FungiForest, False, None, [
        ...
        LocationLogic(Locations.ForestDonkeyHalfMedal, lambda l: l.ColoredBananas[Levels.FungiForest][Kongs.donkey] >= max(1, int(l.settings.medal_cb_req_level[4] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.ForestDiddyHalfMedal, lambda l: l.ColoredBananas[Levels.FungiForest][Kongs.diddy] >= max(1, int(l.settings.medal_cb_req_level[4] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.ForestLankyHalfMedal, lambda l: l.ColoredBananas[Levels.FungiForest][Kongs.lanky] >= max(1, int(l.settings.medal_cb_req_level[4] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.ForestTinyHalfMedal, lambda l: l.ColoredBananas[Levels.FungiForest][Kongs.tiny] >= max(1, int(l.settings.medal_cb_req_level[4] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.ForestChunkyHalfMedal, lambda l: l.ColoredBananas[Levels.FungiForest][Kongs.chunky] >= max(1, int(l.settings.medal_cb_req_level[4] * (l.settings.half_medal_percentage / 100)))),
    ], [], [], restart=-1),
    ...
    Regions.FungiForestStart: Region("Fungi Forest Start", HintRegion.ForestCenterAndBeanstalk, Levels.FungiForest, True, None, [
        ...
        Event(Events.Night, lambda l: (Types.FungiTime in l.settings.shuffled_location_types and l.nightAccess) or (Types.FungiTime not in l.settings.shuffled_location_types and (l.cannons or (l.isdiddy and l.jetpack) or l.climbing) and (l.HasGun(Kongs.any) or l.adv_orange_usage or (l.settings.fungi_time_internal in (FungiTimeSetting.night, FungiTimeSetting.dusk, FungiTimeSetting.progressive) and l.nightAccess)))),
        Event(Events.Day, lambda l: (Types.FungiTime in l.settings.shuffled_location_types and l.dayAccess) or (Types.FungiTime not in l.settings.shuffled_location_types and (l.cannons or (l.isdiddy and l.jetpack) or l.climbing) and (l.HasGun(Kongs.any) or l.adv_orange_usage or (l.settings.fungi_time_internal in (FungiTimeSetting.day, FungiTimeSetting.dusk, FungiTimeSetting.progressive) and l.dayAccess)))),
