...
LogicRegions = {
    ...
    Regions.TempleStart: Region("Temple Start", False, [
    ...
    Regions.TempleUnderwater: Region("Temple Underwater", False, [
    ...
    Regions.AngryAztecMain: Region("Angry Aztec Main", True, [
    ...
    Regions.ChunkyTemple: Region("Chunky Temple", False, [
    ...
    Regions.AztecTinyRace: Region("Aztec Tiny Race", False, [
        Location("Aztec Tiny Beetle Race", lambda l: l.istiny),
    ], [], []),

    Regions.LlamaTemple: Region("Llama Temple", True, [
