...
LogicRegions = {
    Regions.AngryAztecMedals: Region("Angry Aztec Medals", HintRegion.AztecCBs, Levels.AngryAztec, False, None, [
        ...
        LocationLogic(Locations.AztecDonkeyHalfMedal, lambda l: l.ColoredBananas[Levels.AngryAztec][Kongs.donkey] >= max(1, int(l.settings.medal_cb_req_level[1] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.AztecDiddyHalfMedal, lambda l: l.ColoredBananas[Levels.AngryAztec][Kongs.diddy] >= max(1, int(l.settings.medal_cb_req_level[1] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.AztecLankyHalfMedal, lambda l: l.ColoredBananas[Levels.AngryAztec][Kongs.lanky] >= max(1, int(l.settings.medal_cb_req_level[1] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.AztecTinyHalfMedal, lambda l: l.ColoredBananas[Levels.AngryAztec][Kongs.tiny] >= max(1, int(l.settings.medal_cb_req_level[1] * (l.settings.half_medal_percentage / 100)))),
        LocationLogic(Locations.AztecChunkyHalfMedal, lambda l: l.ColoredBananas[Levels.AngryAztec][Kongs.chunky] >= max(1, int(l.settings.medal_cb_req_level[1] * (l.settings.half_medal_percentage / 100)))),
    ], [], [], restart=-1),
    ...
    Regions.AngryAztecMain: Region("Angry Aztec Main", HintRegion.OasisAndTotem, Levels.AngryAztec, True, -1, [
        ...
        TransitionFront(Regions.LlamaTemple, lambda l: l.canOpenLlamaTemple() or l.CanPhase() or (l.generalclips and (l.isdonkey or l.isdiddy or l.istiny or l.ischunky)), Transitions.AztecMainToLlama),
