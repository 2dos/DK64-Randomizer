...
LogicRegions = {
    ...
    Regions.AngryAztecOasis: Region("Angry Aztec Oasis", "Aztec Oasis", Levels.AngryAztec, True, None, [
        ...
        TransitionFront(Regions.AngryAztecConnectorTunnel, lambda l: l.settings.open_levels or (((l.vines or l.jetpack) and l.guitar and l.diddy) or l.phasewalk or l.generalclips)),
