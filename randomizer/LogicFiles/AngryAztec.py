...
LogicRegions = {
    ...
    Regions.AngryAztecOasis: Region("Angry Aztec Oasis", "Aztec Oasis and Totem Area", Levels.AngryAztec, True, -1, [
        ...
        TransitionFront(Regions.AngryAztecConnectorTunnel, lambda l: l.settings.open_levels or Events.AztecGuitarPad in l.Events or l.phasewalk or l.generalclips),
