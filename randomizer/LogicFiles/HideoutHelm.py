...
LogicRegions = {
    ...
    Regions.HideoutHelmMain: Region("Hideout Helm Main", Levels.HideoutHelm, True, -1, [
        ...
        LocationLogic(Locations.HelmDiddy1, lambda l: (l.settings.helm_setting == "skip_all" or l.guitar) and l.isdiddy, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmDiddy2, lambda l: (l.settings.helm_setting == "skip_all" or l.guitar) and l.isdiddy, MinigameType.HelmBarrel),
