...
LogicRegions = {
    ...
    Regions.HideoutHelmEntry: Region("Hideout Helm Entry Redirect", "Hideout Helm", Levels.HideoutHelm, False, None, [
        LocationLogic(Locations.HelmDonkey1, lambda l: not l.settings.helm_donkey or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmDonkey2, lambda l: not l.settings.helm_donkey or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmChunky1, lambda l: not l.settings.helm_chunky or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmChunky2, lambda l: not l.settings.helm_chunky or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmTiny1, lambda l: not l.settings.helm_tiny or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmTiny2, lambda l: not l.settings.helm_tiny or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmLanky1, lambda l: not l.settings.helm_lanky or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmLanky2, lambda l: not l.settings.helm_lanky or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmDiddy1, lambda l: not l.settings.helm_diddy or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
        LocationLogic(Locations.HelmDiddy2, lambda l: not l.settings.helm_diddy or l.settings.helm_setting == HelmSetting.skip_all, MinigameType.HelmBarrel),
    ], [
    ...
    Regions.HideoutHelmOOBChunky: Region("Hideout Helm OOB (Chunky Room Elevation)", "Hideout Helm", Levels.HideoutHelm, False, -1, [], [], [
        ...
        TransitionFront(Regions.HideoutHelmMain, lambda l: True),
        TransitionFront(Regions.HideoutHelmDonkeyRoom, lambda l: True),
        TransitionFront(Regions.HideoutHelmChunkyRoom, lambda l: True),
    ...
    Regions.HideoutHelmOOBLanky: Region("Hideout Helm OOB (Lanky Room Elevation)", "Hideout Helm", Levels.HideoutHelm, False, -1, [], [], [
        ...
        TransitionFront(Regions.HideoutHelmAfterBoM, lambda l: True),
        TransitionFront(Regions.HideoutHelmThroneRoom, lambda l: True),
        TransitionFront(Regions.HideoutHelmKeyRoom, lambda l: True),
    ]),
}
