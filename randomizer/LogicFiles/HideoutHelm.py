...
LogicRegions = {
    Regions.HideoutHelmStart: Region("Hideout Helm Start", "Hideout Helm", Levels.HideoutHelm, True, None, [
        ...
        LocationLogic(Locations.HelmMainEnemy_MiniRoom0, lambda l: l.CanAccessHelmStart() and (l.handstand and l.lanky) and (l.pineapple and l.chunky and l.vines)),
        LocationLogic(Locations.HelmMainEnemy_MiniRoom1, lambda l: l.CanAccessHelmStart() and (l.handstand and l.lanky) and (l.pineapple and l.chunky and l.vines)),
        LocationLogic(Locations.HelmMainEnemy_MiniRoom2, lambda l: l.CanAccessHelmStart() and (l.handstand and l.lanky) and (l.pineapple and l.chunky and l.vines)),
        LocationLogic(Locations.HelmMainEnemy_MiniRoom3, lambda l: l.CanAccessHelmStart() and (l.handstand and l.lanky) and (l.pineapple and l.chunky and l.vines)),
    ], [], [
