...
class Settings:
    ...
    def __init__(self, form_data: dict, random=random):
        ...
        try:
            ...
            raise Ex.SettingsIncompatibleException("Settings string is in an invalid state. Try clearing your browser cache, applying a preset and recreating your changes.")
