...
LogicRegions = {
    ...
    Regions.RandD: [
        ...
        Collectible(Collectibles.banana, Kongs.chunky, lambda l: (l.punch and l.triangle) or l.CanAccessRNDRoom(), None, 10),  # Toy Monster room
        Collectible(Collectibles.balloon, Kongs.chunky, lambda l: ((l.punch and l.triangle) or l.CanAccessRNDRoom()) and l.pineapple, None, 1),  # Toy Monster room
