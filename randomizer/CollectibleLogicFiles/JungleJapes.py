...
LogicRegions = {
    Regions.JungleJapesStart: [
        Collectible(Collectibles.banana, Kongs.donkey, lambda l: (l.can_use_vines and l.climbing) or (l.advanced_platforming and (not l.isKrushaAdjacent(Kongs.donkey))), None, 5),  # Starting area
