...
LogicRegions = {
    ...
    Regions.JapesPaintingRoomHill: [
        Collectible(Collectibles.banana, Kongs.lanky, lambda l: True, None, 2),  # Slope to painting room
    ],
    ...
    Regions.JapesBeyondCoconutGate2: [
        ...
        Collectible(Collectibles.banana, Kongs.tiny, lambda l: True, None, 2),  # Front of Rambi Gate
    ...
    Regions.BeyondRambiGate: [
        ...
        Collectible(Collectibles.banana, Kongs.tiny, lambda l: True, None, 5),
